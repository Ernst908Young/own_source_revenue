			...
			<div class="top-header-right pull-right">
				...
				?>
					<div class="top-header-social">
						<a class="fb" title="Facebook" target="_blank" href="https://www.facebook.com/UttarakhandTourismOfficialPage"><i aria-hidden="true" class="fa fa-facebook"></i></a>
						<a class="tw" title="Twitter" target="_blank" href="https://twitter.com/UTDBofficial"><i aria-hidden="true" class="fa fa-twitter"></i></a>
					</div>

					<?php if(isset($_SESSION['lang']) && $_SESSION['lang']=="hn"){ ?> 
						<div class="top-header-help">
						<p>सहायता केंदॿर (सॿबह 10:00 बजे से शाम 5:00 बजे तक )&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;टौल फॿरी +91-8859955505  &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;ईमेल investtourismuk@gmail.com&nbsp;&nbsp;&nbsp;</p>
					</div>
						<?php }  else { ?>
						<div class="top-header-help">
						<p>Helpdesk: (10:00 AM to 5:00 PM IST)&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Contact Number: +91-8859955505&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Email: investtourismuk@gmail.com&nbsp;&nbsp;&nbsp;</p>
					</div>
					   <?php  } ?>
