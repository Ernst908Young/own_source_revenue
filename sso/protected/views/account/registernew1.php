			...
			<div class="register-right">
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="col-xs-12 col-sm-6">
					  <div class="form-group">					  
						<input type="text" class="register-tbox form-control" id="pin" name="PIN" maxlength="7" aria-describedby="" placeholder="Pin Code" required="required"  onkeypress="return isNumberKey(event)" onblur="checkValidation()" autocomplete="off">
					  </div>
					</div>
					<div class="col-xs-12 col-sm-6">
					  <div class="form-group">					  
