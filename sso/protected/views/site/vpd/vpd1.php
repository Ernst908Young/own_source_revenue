...
<br><br>
<?php $url = Yii::app()->createUrl("/site/vpd1/service_id/".base64_encode($service_id)."/reg_no/".base64_encode($reg_no)); ?>
<form id="vpd1-form" action="<?php echo  $url; ?>" method="post" role="form">
 <input type="hidden" name="YII_CSRF_TOKEN" value="<?php echo Yii::app()->request->csrfToken; ?>"/>
	<div class="row">		
		<div class="col-md-3" style="text-align: right;">Entity Name : </div>
		<div class="col-md-6 form-group">
			<?= $entity_records['company_name'] ?>
		</div>
	</div>
	<div class="row">		
		<div class="col-md-3" style="text-align: right;">Service Category :</div>
		<div class="col-md-6 form-group">
	...
	<div class="row">		
		<div class="col-md-3" style="text-align: right;">Year of Filing :</div>
		<div class="col-md-6 form-group">
	...
	<div class="row">		
		...
		<div class="col-md-6">
			...
			<a href="/sso/site/vpd" class="btn btn-secondary">Back</a>
		</div>
	</div>
</form>
<br><br>
...
<form id="vpd1-form" action="/sso/site/vpdaddtocart" method="post" role="form">
 <input type="hidden" name="YII_CSRF_TOKEN" value="<?php echo Yii::app()->request->csrfToken; ?>"/>
<div class="row">		
	<div class="col-md-3"></div>
	<div class="col-md-6">
...
<br>
<b style="font-size:16px; color:red;">*NOTE: Complete functionality is accessible only after logging in to the portal.</b>
