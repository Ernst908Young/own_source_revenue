<?php $baseURL="https://caipotesturl.com/sso/themes/investuk";?>
...
<link rel="stylesheet" href="<?php echo $baseURL; ?>/css/login-form.css" type="text/css" />
...
<link rel="stylesheet" href="<?php echo $baseURL; ?>/fancybox/jquery.fancybox.css" type="text/css" media="screen" />
<script type="text/javascript" src="<?php echo $baseURL; ?>/fancybox/jquery.fancybox.pack.js"></script>
<!-- Optional, Add fancyBox for media, buttons, thumbs -->
<link rel="stylesheet" href="<?php echo $baseURL; ?>/fancybox/jquery.fancybox-buttons.css" type="text/css" media="screen" />
...
<link rel="stylesheet" href="<?php echo $baseURL; ?>/fancybox/jquery.fancybox-thumbs.css" type="text/css" media="screen" />
...
<form id="register-form" name="register-form" action="" method="post" role="form" data-toggle="validator" class="sky-form">
   ...
   <input type="hidden" name="callback_success_url" value="<?php echo $callback_success_url; ?>" />
    <h2 class="login-hd">Investor Registration Form</h2>
   <fieldset>
      <section> 
         <?php
   ...
   <fieldset>
      ...
      <div class="">
         ...
         <section class="col col-6">
            <div class="form-control-group">
            <label class="control-label">Enter Adhaar</label>
               <label class="input">
            ...
            <label class="select">
               <div class="controls">
                    <?php  if (isset($countries)) {
                         echo "<select id='country' name='country' class='valid'>";
	  ...
	  <footer>
    <div class="register_disabled"><p class="h"><a id="otpverify" class="button" title="Register" href="https://caipotesturl.com/sso/account/register#login_form">Register</a></p></div>
</footer>
