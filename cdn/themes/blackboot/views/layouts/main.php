	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?=$this->createUrl('/site')?>"><?php echo Yii::app()->name ?></a>
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Login', 'url'=>array('/sample'), 'visible'=>!Utility::isLoggedIn()),
							array('label'=>'Logout', 'url'=>array('/site/logout'), 'visible'=>Utility::isLoggedIn())
