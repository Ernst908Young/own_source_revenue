...
/**
 * This is the model class for table "cdn_investor_documents_by_Departments_metainfo".
 *
 * The followings are the available columns in table 'cdn_investor_documents_by_Departments_metainfo':
 ...
 * @property InvestorDocumentsByDepartments $doc
 */
class InvestorDocumentsByDepartmentsMetainfo extends CActiveRecord
{
	/**
	...
	{
		return 'cdn_investor_documents_by_Departments_metainfo';
	}
	...
	public function relations()
	{
		...
		return array(
			'doc' => array(self::BELONGS_TO, 'InvestorDocumentsByDepartments', 'doc_id'),
		);
	}
	 ...
	 * @return InvestorDocumentsByDepartmentsMetainfo the static model class
	 */
