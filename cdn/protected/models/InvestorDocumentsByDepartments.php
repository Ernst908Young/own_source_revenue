...
/**
 * This is the model class for table "cdn_investor_documents_by_Departments".
 *
 * The followings are the available columns in table 'cdn_investor_documents_by_Departments':
 ...
 * @property InvestorDocumentsByDepartmentsMetainfo[] $investorDocumentsByDepartmentsMetainfos
 */
class InvestorDocumentsByDepartments extends CActiveRecord
{
	/**
	...
	{
		return 'cdn_investor_documents_by_Departments';
	}
	...
	public function rules()
	{
		...
		return array(
			array('app_sub_id, doc_name, document, is_document_active', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'investorDocumentsByDepartmentsMetainfos' => array(self::HAS_MANY, 'InvestorDocumentsByDepartmentsMetainfo', 'doc_id'),
		);
	}
	 ...
	 * @return InvestorDocumentsByDepartments the static model class
	 */
