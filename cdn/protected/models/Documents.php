...
/**
 * This is the model class for table "cdn_documents".
 *
 * The followings are the available columns in table 'cdn_documents':
 * @property string $doc_id
 * @property string $parent_doc_id
 ...
 * @property DocumentsMetainfo[] $documentsMetainfos
 */
class Documents extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('parent_doc_id', 'length', 'max'=>11),
			...
			array('doc_id, parent_doc_id, document_name, document, document_version, document_mime_type, is_document_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'documentsMetainfos' => array(self::HAS_MANY, 'DocumentsMetainfo', 'doc_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('parent_doc_id',$this->parent_doc_id,true);
