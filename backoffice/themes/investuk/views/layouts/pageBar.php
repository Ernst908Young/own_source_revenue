...
<div class="mt-element-step">
    <div class="white-bg-block content-blocks" style="height: 133px !important;">
        <div class="col-xs-12 col-sm-3 col-md-2">
            <a class="top-number-bts <?php if ($_GET['type'] == "CAF") { ?> active <?php } ?>" href="#">
                <span>1</span>
                <p>New Establishment</p>
            </a>
        </div>
        <div class="col-xs-12 col-sm-3 col-md-2">
            <a class="top-number-bts <?php if ($_GET['type'] == "EU") { ?> active <?php } ?>" href="#">
                <span>2</span>
                <p>Existing Establishment</p>
            </a>
        </div>
        <div class="col-xs-12 col-sm-3 col-md-2">
...
<?php if (isset($_GET['type']) && $_GET['type'] == 'QUERIES') { ?>
    <div class="applycaf">
        <span class="pull-left">
            <a href="https://caipotesturl.com/query/autologin.php?luser=<?php echo $email;?>&flag=open&type=investor">
...
<?php if (isset($_GET['type']) && $_GET['type'] == 'TICKETS') { ?>
    <div class="applycaf">
        <span class="pull-left">
            <a href="https://caipotesturl.com/ticket/open.php?type=TICKETS&user_id=<?php echo $encodeuserID; ?>>" class="btn btn-success">
