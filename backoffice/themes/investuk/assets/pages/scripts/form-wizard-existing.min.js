               ...
               /* $("#country_list").select2({
                ...
                var a = function() {
                    ...
                    o = function(e, r, t) {
                        ...
                        1 == o ? $("#form_wizard_1").find(".button-previous").hide() : $("#form_wizard_1").find(".button-previous").show(), o >= i-1 ? ($("#form_wizard_1").find(".button-next").hide(), $("#form_wizard_1").find(".button-submit").show(), a()) : ($("#form_wizard_1").find(".button-next").show(), $("#form_wizard_1").find(".button-submit").hide()), App.scrollTo($(".page-title"))
                    };
                $("#form_wizard_1").bootstrapWizard({
                    ...
                    onNext: function(e, a, n) {
						...
						if(n==2){
							if($(".diu_m_gen").css('display')=="none")
							{
								alert("Please fill employement details.");
								return false;					
							}
						}	
