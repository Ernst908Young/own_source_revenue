...
! function(a) {
    ...
    }, "Valid FY like 2016-2017"),a.validator.addMethod("investmentDetail", function(a, b) {
       // Start From Here Due to Lakh Crore here :Rahul Kumar - 15Dec2018
       var plant_value=$('.plant_value').val();        
          if(isNaN(parseFloat(plant_value))){
              plant_value=0.0;
          }          
        if($("#plant0_rs").val()!="Crore"){
                plant_value=plant_value/100; 
               }
        // End Here Due to Lakh Crore here :Rahul Kumar - 15Dec2018
    if(plant_value!=''){
        ...
        if(maxCost>0 && maxCost!=-1){
            if(plant_value>maxCost || plant_value<minCost){
             return false
            }
             return true;
         }
         else if(maxCost==-1){
            if(plant_value<minCost){
             return false
            }
             return true;
         }
