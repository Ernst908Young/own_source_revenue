...
?>
		...
		<?php if(isset($_GET['is']) && $_GET['is'] == 'service'){ 
					$cls="CAF";include('/var/www/html/backoffice/themes/swcsNewTheme/views/layouts/pageBarService.php');
			  }elseif(isset($_GET['is']) && $_GET['is'] == 'SE'){
				    $cls="EU";include('/var/www/html/backoffice/themes/swcsNewTheme/views/layouts/pageBarServiceExisting.php');
            ...
            <div class="page-bar">
                <form name="form" action="" method="GET" > 
                    <table>
                        <tbody>
                            <tr>
                                <td><b>Currently you are viewing data for <?= $financial_year ?> FY, If you want to change then select Financial Year : </b>&nbsp;&nbsp;</td>
                                <td>
                                    <?php
                                    $m = date('m');
                                    $yyy = date('Y');
                                    ...
                                    $pp = '2015';
                                    $urlj = explode('/financial_year', $_SERVER['REQUEST_URI']);
                                    ?>
                                    <select name="financial_year" class="form-control" onchange="window.location = '<?php echo @$urlj[0]; ?>/financial_year/' + this.value"  >
                                        <option value="ALL" <?php if ($financial_year == "ALL") {
                                            echo "selected='selected'";
                                        } ?> >ALL</option>
<?php for ($i = $pp; $i <= $yyy + 1; $i++) {
    $j = $i + 1;
    $k = $i . '-' . $j; ?>
                                            <option value="<?php echo $k; ?>" <?php if ($financial_year == $k) {
        echo "selected='selected'";
    } ?>><?php echo $k; ?></option>
<?php } ?>
                                    </select>
...
<!-- <div style="margin-top:10px;" class="col-md-2 bg-grey  mt-step-col <?php // if($_GET['type']=="LAND"){  ?> done <?php //}  ?>" relurl="/backoffice/frontuser/home/investorWalkthroughLevel2/type/LAND/<?php //echo $typo;  ?>">
    ...
    <div class="mt-step-content font-grey-cascade"title="Land Applications">Land Applications</div>
			...
			<br>
		<div class="applycaf">
                    <span class="pull-left" style=""><a href="https://caipotesturl.com/query/autologin.php?luser=demo.swcs.uk@gmail.com&flag=open&type=investor" class="btn btn-success"><i class=""></i>&nbsp;Click Here To Ask A Question To Our Team </a></span>
                </div><br><br>
		...
		<br>
		<div class="applycaf">
                    <span class="pull-left" style=""><a href="https://caipotesturl.com/ticket/open.php?type=TICKETS&user_id=MTE=" class="btn btn-success"><i class=""></i>&nbsp; Facing Trouble : Click Here To Create Ticket </a></span>
                </div>
<br><br>
		...
		<br>
		<div class="applycaf">
                    <span class="pull-left" style=""><a href="/backoffice/GrievanceNew/grievanceDetail/createGrievance/type/GRIEVANCE" class="btn btn-success"><i class=""></i>&nbsp;Not Happy With Our Services : Click Here To Raise Grievance </a></span>
                </div>
<br><br>
