    ...
    var initWizard = function () {
				...
				{	
				    ...
				    if(nofapp > totalRowCount){
                          ...
                          $(".check_number_three").remove();
					    	...
					    	$("#title_UK-FCL-00234_0").append("<b style='color:red;' class='check_number_three'>Please note, that the minimum no. of managers should be equal of 'No. of appointed managers in the Society as of this date are' field.</b>");
        ...
        wizard.on('change', function(wizard) {
               ...
               //Hide And Show Checckbox
        	    ...
        	    var agentMiddleName = $("#UK-FCL-00133_0").val();
			    var agentLastname = $("#UK-FCL-00324_0").val();
			    var  address1 = $("#UK-FCL-00169_0").val();
			   ...
			   if(agentMiddleName.length==0){
			   	  
			   }


		      $("#UK-FCL-00479_0").prop('readonly',true);
			  $("#UK-FCL-00169_0").prop('readonly',false);
				...
				var valid = true;
				 if($("#UK-FCL-00362_0").val()=='Yes'){
				 	...
				 	if (mnt) {
					 	...
					 	var parentId = $('input[name=middlenamecheckbox00133_0]:checked').parent().parent().attr('id');
					 	// if (parentId == 'div_UK-FCL-00105_0') {
					 	    if (mncb) {
					 	        ...
					 	        if ($("#miderror").length) {
					 	            ...
					 	            $("#div_UK-FCL-00133_0").append("<span style='color:red;' class='errorDetail' id='miderror'>Please enter the required information or select the check box</span>");
...
jQuery(document).ready(function() {
	//$('select[name="UK-FCL-00367_0"] option[value="Preference Quota"]').attr("selected","selected");
	$("#UK-FCL-00367_0").select2("destroy");
