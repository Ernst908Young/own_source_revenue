        ...
        btn.on('click', function(e) {
            ...
            if (validator.form()) {  
				...
				var valid = true;
				  ...
				  total1RowCount =  $("#tbl_2837 td").closest("tr").length;
                    if(total1RowCount>=1){                  
                        $("#error2837").text("");
                    }else{  
                    var scdem = "Please add atleast one details of the Shareholder Details"; 
                        if ($("#error2837").length) {
                            $("#error2837").text(scdem);
                        }else{
                            $("#title_UK-FCL-00132_0").append('<b style="color:red;" id="error2837">'+scdem+'</b>');
                        }                       
                    ...
                    total2RowCount =  $("#tbl_2836 td").closest("tr").length;
                    if(total2RowCount>=1){                  
                        $("#error2836").text("");
                    }else{  
                    var scdem = "Please add atleast one details of the Shareholder Details"; 
                        if ($("#error2836").length) {
                            $("#error2836").text(scdem);
                        }else{
                            $("#title_UK-FCL-00150_0").append('<b style="color:red;" id="error2836">'+scdem+'</b>');
                        }                       
