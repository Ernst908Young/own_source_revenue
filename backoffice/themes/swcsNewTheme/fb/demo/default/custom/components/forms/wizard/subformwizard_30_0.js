   ...
   var initSubmit = function() {
        ...
        btn.on('click', function(e) {
            ...
            if (validator.form()) {
               ...
               /* var totalRowCount = 0;
                totalRowCount = $("#tbl_2988 td").closest("tr").length;
                if (totalRowCount >= 1) {
                    $("#appd").text("");
                } else {
                    var appdm = "Please add Applicant Details atleast one record is required";
                    $("#title_UK-FCL-00248_0").find('b').first().remove();
                    $("#title_UK-FCL-00248_0").append('<b style="color:red;" id="appd">' + appdm + '</b>');
                    var titleTot = jQuery("#title_UK-FCL-00248_0").offset().top;
                ...
                totalRowCount = $("#tbl_2971 td").closest("tr").length;
                if (totalRowCount >= 1) {
                    $("#appd").text("");
                } else {
                    var appdm = "<br>Please add Applicant Details atleast one record is required";
                    $("#title_UK-FCL-00150_0").find('b').first().remove();

                    $("#title_UK-FCL-00150_0").append('<b style="color:red;" id="appd">' + appdm + '</b>');
                    // var titleTot = jQuery("#div_UK-FCL-00099_0").offset().top;
                    // var addHeight = parseInt(titleTot) - 170;
                    jQuery('html,body').animate({
                        scrollTop: addHeight
                    }, 1000);
