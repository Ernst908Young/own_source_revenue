            ...
            if (validator.form()) {
				...
				$('#UK-FCL-00579_0').on('change', function() {
					...
					if(three == 'Affiliation exemption – subsection (3) of section 152'){
						...
						valid = true;
						$(".form-group rbcb-group").append("<span style='color:red;padding-left:16px;' class='errorDetail' id='miderror'>Please enter the required information or select the check box</span>");
              ...
              /*  var form_div_id = wizard.getStep();
                ...
                var totalRowCount = 0;
                totalRowCount = $("#tbl_3011 td").closest("tr").length;
