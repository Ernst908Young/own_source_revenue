    ...
    var initSubmit = function() {
        ...
        btn.on('click', function(e) {
            ...
            if (validator.form()) {
                ...
                var totalRowCount = 0;
                totalRowCount = $("#tbl_3842 td").closest("tr").length;
                if (totalRowCount >= 1) {
                    $("#appd").text("");
                } else {
                    var appdm = "Please add Applicant Details atleast one record is required";
                    $("#title_UK-FCL-00639_0").find('b').first().remove();
                    $("#title_UK-FCL-00639_0").append('<b style="color:red;" id="appd">' + appdm + '</b>');
                    var titleTot = jQuery("#title_UK-FCL-00639_0").offset().top;
...
jQuery(document).ready(function() {
     ...
     $( "#div_UK-FCL-00563_0" ).removeClass( "col-md-6" ).addClass( "col-md-12" );
