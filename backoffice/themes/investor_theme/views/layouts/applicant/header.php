...
<div class="contemt-header" style="height: 110px;">
    <div class="row align-items-center">
        <div class="col-md-8 col-sm-9 col-12">
            <div class="user-name">
                ...
                <a href="javascript:void(0);">
                    <span class="user-name">Own Source Of Revenue
</span>
                </a>
        </div>
        </div>
        <div class="col-md-4 col-sm-3 col-12">
            ...
            <!-- <div class=" header-notification text-end mx-3">
                <a href="javascript:void(0);" class="notitfication"><img src="<?php echo $basePath; ?>/assets/applicant/images/bell.png"><span class="counter total_notification">0</span></a>
            </div> -->
                ...
                <div class="dropbox">
                    <div class="usernamebox">
                        <img src="<?php echo $basePath; ?>/assets/applicant/images/awesome-user-circle.png">
                            ...
                            <span style="font-size: 10px;"><?php echo @$_SESSION['RESPONSE']['email'];?></span>
                    </div>
                    <ul class="mt-3 header-menu">
                        <li>
                            <a href="<?= Yii::app()->createAbsoluteUrl('/profile/default/myaccount')?>">
