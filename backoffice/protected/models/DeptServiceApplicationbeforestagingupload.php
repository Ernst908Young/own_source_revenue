...
class DeptServiceApplication extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('sp_tag, infowiz_service_name, dept_application_number, applicant_name, applicant_email, unit_name, user_agent, payment_mode, payment_amount, payment_datetime, payment_reference_number, licence_no', 'length', 'max'=>255),
            array('infowiz_service_id, dept_user_id, remote_server, dms_time_taken_by_doc_verifier, dms_time_taken_by_investor, application_time_taken_by_investor, application_time_taken_by_department', 'length', 'max'=>20),
