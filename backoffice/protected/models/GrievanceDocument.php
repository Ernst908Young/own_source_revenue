 ...
 */
class GrievanceDocument extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('document_name, create_date', 'required'),
			...
			array('doc_id, document_name, create_date, document_version, document_mime_type, is_document_active, doc_status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GrievanceDocument the static model class
	 */
