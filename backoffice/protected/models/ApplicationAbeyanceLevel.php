...
/**
 * This is the model class for table "bo_application_abeyance_level".
 *
 * The followings are the available columns in table 'bo_application_abeyance_level':
 ...
 */
class ApplicationAbeyanceLevel extends CActiveRecord
{
	/**
	...
	{
		return 'bo_application_abeyance_level';
	}
