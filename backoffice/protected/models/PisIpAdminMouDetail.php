 ...
 */
class PisIpAdminMouDetail extends CActiveRecord
{
    /**
    ...
    {
        return 'du_ip_admin_pis_mou_detail';
    }
    ...
    public function rules()
    {
        ...
        return array(
            array('pis_mou_parent_id, type, sector_detail, proposed_investment_type, proposed_investment, proposed_employment', 'required'),
          ...
          array('proposed_investment_type', 'length', 'max'=>5),
            ...
            array('id, pis_mou_parent_id, type, sector_detail, proposed_investment_type, proposed_investment, proposed_employment,project_detail,proposed_location,proposed_commencement_date, is_active, created, modified', 'safe', 'on'=>'search'),
        );
    }
