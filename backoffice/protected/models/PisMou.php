 ...
 */
class PisMou extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			 array('company_name, master_reference_no, is_active, created, modified', 'required'),
			  array('master_reference_no', 'unique'),
