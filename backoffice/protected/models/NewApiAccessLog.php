...
/**
 * This is the model class for table "bo_new_api_access_log".
 *
 * The followings are the available columns in table 'bo_new_api_access_log':
 ...
 */
class NewApiAccessLog extends CActiveRecord
{
    /**
     ...
     * @return NewApiAccessLog the static model class
     */
