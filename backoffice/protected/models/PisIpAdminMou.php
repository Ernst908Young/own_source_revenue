<?php
class PisIpAdminMou extends CActiveRecord
{
	/**
	...
	{
		return 'du_ip_admin_pis_mou_upload';
	}
	...
	public function rules()
	{
		...
		return array(
			array('company_name, parent_id,representative_name, phone_number, email_id,  project_detail, total_investment , total_employment , is_active, created, modified', 'required'),
			array('dept_user_id,parent_id', 'numerical', 'integerOnly'=>true),
			...
			array('company_name,source_remark,other_sector, pis_number,pis_signed_by,mou_signed_by, source,mou_number,dic,dm, representative_name, department,association,email_id, pis_upload, mou_upload', 'length', 'max'=>255),
			...
			array('id, company_name,parent_id, pis_signed_by,mou_signed_by,pis_number ,agreement_type,mou_number ,other_sector, representative_name, pis_proposed_employment,dept_user_id,mou_proposed_employmentphone_number, email_id, project_detail, sector, pis_proposed_investment_type, pis_proposed_investment_rs, pis_upload, mou_proposed_investment_type, mou_proposed_investment_rs, mou_upload, is_active, created, modified,linkage_ids,source_upload,source_by,source_remark', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'pis_signed_by' => 'Pis Signed By',
			'mou_signed_by' => 'Mou Signed By',
