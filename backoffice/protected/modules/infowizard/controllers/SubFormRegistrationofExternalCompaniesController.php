        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizard/subFormRegistrationofExternalCompanies/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
            }
    ...
    public function actionSaveData() {
        ...
        if (!empty($_POST) && !Yii::app()->request->isAjaxRequest) {
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizard/subFormRegistrationofExternalCompanies/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizard/subFormRegistrationofExternalCompanies/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
        ...
        if($company_detail){
             ...
             if($checkSrnStatus_newname){
                ...
                $checkSrnStatus = Yii::app()->db->createCommand("SELECT * from bo_recomended_name WHERE submission_id= '".$srn_no."' AND role_id IN(84, 83) AND  withdrawal_status = '0' ORDER BY role_id DESC LIMIT 1")->queryRow(); 
                     if($checkSrnStatus){
                         echo CJavaScript::jsonEncode(array('status'=>true,'app_status'=>'valid','name'=>$checkSrnStatus['recomended_value'],'msg'=>'success','address'=>'A-51,Sec-16'));
                    }else{
                          echo CJavaScript::jsonEncode(
