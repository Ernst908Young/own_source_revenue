	...
	public function actionSaveDataPartial() {
        if(!empty($_POST)) 
		{
            ...
            if($model->save()) 
			{
				...
				$reverted_call_back_url = "/backoffice/infowizard/subFormPowerofAttorney/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizard/subFormPowerofAttorney/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
