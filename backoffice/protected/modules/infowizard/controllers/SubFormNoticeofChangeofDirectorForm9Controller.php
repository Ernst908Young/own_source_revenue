        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizard/subFormNoticeofChangeofDirectorForm9/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
            }
    ...
    public function actionSaveData() {
        ...
        if (!empty($_POST) && !Yii::app()->request->isAjaxRequest) {
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizard/subFormNoticeofChangeofDirectorForm9/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizard/subFormNoticeofChangeofDirectorForm9/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
...
// jitendra singh
    ...
    public function actionGetCompanyNameBySrnNo(){
      ...
      // $user_id=@$_SESSION['RESPONSE']['user_id'];
        $user_id = 11;
       if($user_id){
           echo CJavaScript::jsonEncode(array('status'=>true,'app_status'=>'valid','name'=>'Demo Company Name','msg'=>'success','address'=>'A-51,Sec-16'));
       }else{
