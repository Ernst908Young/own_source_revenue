...
<div class='portlet-title'>
    <div class='caption'>
        <i style=" font-size:20px;" class='fa fa-list'></i>LM Approval Certificate Upload</div>
    <div class='tools'>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row" style="margin:10px 0 10px 0;">		 
		...
		<div class=" form-group col-md-8">
			<?php echo $form->textField($model,'iuid',array('class'=>'form-control','autocomplete' => 'off','required'=>'required','value'=>$iuid_val,'readonly'=>true));  ?>
	...
	<div class="row" style="margin:10px 0 10px 0;">		 
		<label class="col-lg-2 col-sm-2 control-label" for="licencee_name">
		Licencee Name<span class="required" aria-required="true">*</span>
		</label>
		<div class=" form-group col-md-8">
			<?php echo $form->textField($model,'licencee_name',array('class'=>'form-control','autocomplete' => 'off'));  ?>
			<?php echo $form->error($model,'licencee_name'); ?>
		</div>
	</div>
	<div class="row" style="margin:10px 0 10px 0;">		 
	...
	<div class="row" style="margin:10px 0 10px 0;">		 
		<label class="col-lg-2 col-sm-2 control-label" for="firm_address">
		Firm Address<span class="required" aria-required="true">*</span>
		</label>
		<div class=" form-group col-md-8">
			<?php echo $form->textField($model,'firm_address',array('class'=>'form-control','autocomplete' => 'off'));  ?>
			<?php echo $form->error($model,'firm_address'); ?>
		</div>
	</div>
	...
	<div class="row" style="margin:10px 0 10px 0;">		 
		<label class="col-lg-2 col-sm-2 control-label" for="licence_valid_from">
		Licence Valid From<span class="required" aria-required="true">*</span>
		</label>
		<div class=" form-group col-md-8">
			<?php echo $form->textField($model,'licence_valid_from',array('class'=>'form-control demo-2','autocomplete' => 'off'));  ?>
			<?php echo $form->error($model,'licence_valid_from'); ?>
		</div>
	</div>
	<div class="row" style="margin:10px 0 10px 0;">		 
		<label class="col-lg-2 col-sm-2 control-label" for="licence_valid_to">
		Licence Valid To<span class="required" aria-required="true">*</span>
		</label>
		<div class=" form-group col-md-8">
			<?php echo $form->textField($model,'licence_valid_to',array('class'=>'form-control demo-2','autocomplete' => 'off'));  ?>
			<?php echo $form->error($model,'licence_valid_to'); ?>
		</div>
	</div>
	<div class="row" style="margin:10px 0 10px 0;">		 
		<label class="col-lg-2 col-sm-2 control-label" for="date_of_licence_issue">
		Date of Licence Issue<span class="required" aria-required="true">*</span>
		</label>
		<div class=" form-group col-md-8">
			<?php echo $form->textField($model,'date_of_licence_issue',array('class'=>'form-control demo-2','autocomplete' => 'off'));  ?>
			<?php echo $form->error($model,'date_of_licence_issue'); ?>
		</div>
	</div>	
	<div class="row" style="margin:10px 0 10px 0;">		 
		<label class="col-lg-2 col-sm-2 control-label" for="approval_certificate">
		Select Licence<span class="required" aria-required="true">*</span>
		</label>
		<div class=" form-group col-md-8">
			<?php echo $form->fileField($model, 'approval_certificate');  ?>
			<?php echo $form->error($model,'approval_certificate'); ?>
		</div>
	</div>
