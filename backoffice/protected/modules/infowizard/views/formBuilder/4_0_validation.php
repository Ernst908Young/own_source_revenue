...
$("#label_UK-FCL-00095_0, #label_UK-FCL-00263_0, #label_UK-FCL-00264_0, #label_UK-FCL-00113_0").find('b').after('<span style="color:red;"> * </span>');
	...
	// Director details
$("#label_UK-FCL-00132_0, #label_UK-FCL-00134_0, #label_UK-FCL-00093_0,#label_UK-FCL-00372_0,  #label_UK-FCL-00096_0, #label_UK-FCL-00137_0 ").find('b').after('<span style="color:red;"> * </span>');

$("#UK-FCL-00089_0").prop('readonly',true);
//$("#UK-FCL-00351_0, #UK-FCL-00347_0").prop('readonly',true);
$("#UK-FCL-00351_0, #UK-FCL-00347_0").val("Barbados");
$("<div class='row'><div class='col-lg-12'><strong>Address of Registered Office</strong></div></div><br>").insertAfter("#hr_UK-FCL-00340_0");
...
if(ff00114 =='Yes'){
	...
	if(ff00115=="Others - Please State"){
		$("#div_UK-FCL-00116_0").show();
	}else{
		$("#div_UK-FCL-00116_0").hide();
	}
...
$("#UK-FCL-00131_0").on("change",function(){
	var min = $("#UK-FCL-00119_0").val(); 
	var max = $("#UK-FCL-00120_0").val();
...
if($(this).val()>0){
	...
	$("#UK-FCL-00120_0").blur(function(){
		...
		if(minnu){
		if($(this).val()<=minnu){
			$("#UK-FCL-00120_0-error").text("Maximum number should be greather then Minimum number");
		}else{
			$("#UK-FCL-00120_0-error").text("");
			$("#UK-FCL-00119_0-error").text("");
		}
...
/*$("#UK-FCL-00342_0").prop('readonly',true);  	
  $("#UK-FCL-00343_0").prop('readonly',true);  	
  $("#UK-FCL-00348_0").prop('readonly',true);

  $("#UK-FCL-00349_0").attr('disabled',true);
  $("#UK-FCL-00350_0").attr('disabled',true);*/
	...
	/*$("input[name=UK-FCL-00103_0]").on("change",function(){
		if($(this).val()=='Yes'){
			...
			$("#UK-FCL-00343_0").val("");
			$("#UK-FCL-00348_0").val("");
			$("#UK-FCL-00349_0").val("").trigger("change");
			$("#UK-FCL-00350_0").val("").trigger("change");	

			 $("#UK-FCL-00342_0").prop('readonly',false);  	
			  $("#UK-FCL-00343_0").prop('readonly',false);  	
			  $("#UK-FCL-00348_0").prop('readonly',false);

			  $("#UK-FCL-00349_0").attr('disabled',false);
			  $("#UK-FCL-00350_0").attr('disabled',false);
	...
	$("#UK-FCL-00088_0").on("blur",function(){
		...
		if(srn_no!=""){
				$.ajax({
		            type: "POST",
		            dataType:'json',
		            url: "/backoffice/infowizard/subFormIncorporationOfCompany/getCompanyNameBySrnNo/srn_no/" + srn_no,
		            beforeSend:function(){
...
$("#UK-FCL-00264_0, #UK-FCL-00241_0, #UK-FCL-00119_0, #UK-FCL-00120_0").bind("keypress",function(){
...
function addmorebtncheckincorporation(){
	...
	if(nofapp<=totalRowCount){
		...
		var iem = "Please Add Number of Incorporators as Per Enter 'No. of Incorporators' Field."; 
...
function addmorebtnchecksharecapitaldetail(){
	...
	if(nofapp<=totalRowCount){
		...
		var scdem = "Please Add Number of Shares Capital Details as Per Enter 'No. of classes of shares' Field."; 
						if ($("#scd").length) {
							$("#scd").text(scdem);
		    			}else{
