...
$(document).ready(function () {
	...
	$('.add-more-btn').on('click', function () {		
		...
		if(service_id=='4.0' || service_id=='7.0' || service_id=='8.0' ||service_id=='6.0' ||service_id=='5.0' || service_id=='9.0' || service_id=='10.0' || service_id=='12.0' || service_id=='14.0' || service_id=='17.0'|| service_id=='13.0'){			
