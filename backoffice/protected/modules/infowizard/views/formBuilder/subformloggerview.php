				...
				<div class="col-md-12" style="text-align:left;">
					<table style="width:80%" border="1" cellpadding="10" cellspacing="10" class="table table-striped table-bordered">
						...
						{	
							...
							$societyNameVerifeir2  = @$dataArr['UK-FCL-00047_0'].' '.@$fieldValues['UK-FCL-00475_0'];
							$societyNameVerifeir3  = @$dataArr['UK-FCL-00048_0'].' '.@$fieldValues['UK-FCL-00475_0'];
						?>						
							<tr>
								<td>1</td>
								<td><?php echo @$societyNameVerifeir1;?></td>								
								<td><a href="javascript:void(0);" class="checkProposedName" data-val="<?php echo $societyNameVerifeir1; ?>" rel="real_status_UK-FCL-00046_0" id="real_status_UK-FCL-00046_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $societyNameVerifeir2; ?>" rel="real_status_UK-FCL-00047_0" id="real_status_UK-FCL-00047_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName"  data-val="<?php echo $societyNameVerifeir3; ?>" rel="real_status_UK-FCL-00048_0" id="real_status_UK-FCL-00048_0">Click Here</a></td>
						...
						{ 
							$comapnyLegalEnding = "";
							$comapnyLegalEnding = InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
							$comapanyNameVerifierNewCompany1 = @$dataArr['UK-FCL-00015_0'].' '.$comapnyLegalEnding;
							$comapanyNameVerifierNewCompany2 = @$dataArr['UK-FCL-00016_0'].' '.$comapnyLegalEnding;
							$comapanyNameVerifierNewCompany3 = @$dataArr['UK-FCL-00017_0'].' '.$comapnyLegalEnding;
							
						?>
							<tr>
								<td>1</td>
								<td><?php echo @$comapanyNameVerifierNewCompany1;?></td>								
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $comapanyNameVerifierNewCompany1;?>" rel="real_status_UK-FCL-00015_0" id="real_status_UK-FCL-00015_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $comapanyNameVerifierNewCompany2;?>" rel="real_status_UK-FCL-00016_0"  id="real_status_UK-FCL-00016_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $comapanyNameVerifierNewCompany3;?>" rel="real_status_UK-FCL-00017_0"  id="real_status_UK-FCL-00017_0">Click Here</a></td>
						...
						}else if(isset($dataArr['UK-FCL-00044_0']) && $dataArr['UK-FCL-00044_0']==2 && $dataArr['UK-FCL-00012_0']=='Name change of existing company')
						{
							$comapnyLegalEnding = "";
							$comapnyLegalEnding = InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
							$comapanyNameVerifierExistCompany1 = @$dataArr['UK-FCL-00015_0'].' '.$comapnyLegalEnding;
							$comapanyNameVerifierExistCompany2 = @$dataArr['UK-FCL-00016_0'].' '.$comapnyLegalEnding;
							$comapanyNameVerifierExistCompany3 = @$dataArr['UK-FCL-00017_0'].' '.$comapnyLegalEnding;
							//$i=1;
						...
						?>							
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo @$comapanyNameVerifierExistCompany1;?>" rel="real_status_UK-FCL-00015_0" id="real_status_UK-FCL-00015_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $comapanyNameVerifierExistCompany2; ?>" rel="real_status_UK-FCL-00016_0"  id="real_status_UK-FCL-00016_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $comapanyNameVerifierExistCompany3; ?>" rel="real_status_UK-FCL-00017_0"  id="real_status_UK-FCL-00017_0">Click Here</a></td>
				...
				<div class="col-md-12" style="text-align:left;">
					<table style="width:80%" border="1" cellpadding="10" cellspacing="10" class="table table-striped table-bordered">
						...
						{	
							...
							$societyNameApproverSide2 = @$dataArr['UK-FCL-00047_0'].' '.@$fieldValues['UK-FCL-00475_0'];
							$societyNameApproverSide3 = @$dataArr['UK-FCL-00048_0'].' '.@$fieldValues['UK-FCL-00475_0'];
						?>						
							<tr>
								<td>1</td>
								<td><?php echo @$societyNameApproverSide1;?></td>								
								<td><a href="javascript:void(0);" class="checkProposedName" data-val="<?php echo $societyNameApproverSide1; ?>" rel="real_status_UK-FCL-00046_0" id="real_status_UK-FCL-00046_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $societyNameApproverSide2; ?>" rel="real_status_UK-FCL-00047_0" id="real_status_UK-FCL-00047_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName"  data-val="<?php echo $societyNameApproverSide3; ?>" rel="real_status_UK-FCL-00048_0" id="real_status_UK-FCL-00048_0">Click Here</a></td>
						...
						{  
							$companyLegalEnd = "";
							$companyLegalEnd = InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
							$companyNameApproverSideNewCompany1 = @$dataArr['UK-FCL-00015_0'].' '.$companyLegalEnd;
							$companyNameApproverSideNewCompany2 = @$dataArr['UK-FCL-00016_0'].' '.$companyLegalEnd;
							$companyNameApproverSideNewCompany3 = @$dataArr['UK-FCL-00017_0'].' '.$companyLegalEnd;
								
						?>
							<tr>
								<td>1</td>
								<td><?php echo @$companyNameApproverSideNewCompany1;?></td>								
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $companyNameApproverSideNewCompany1; ?>" rel="real_status_UK-FCL-00015_0" id="real_status_UK-FCL-00015_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $companyNameApproverSideNewCompany2; ?>" rel="real_status_UK-FCL-00016_0"  id="real_status_UK-FCL-00016_0">Click Here</a></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $companyNameApproverSideNewCompany3; ?>" rel="real_status_UK-FCL-00017_0"  id="real_status_UK-FCL-00017_0">Click Here</a></td>
						...
						}else if(isset($dataArr['UK-FCL-00044_0']) && $dataArr['UK-FCL-00044_0']==2 && $dataArr['UK-FCL-00012_0']=='Name change of existing company')
						{
							$companyLegalEnd = "";
							$companyLegalEnd = InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
							$companyNameApproverSideExistCompany1 = @$dataArr['UK-FCL-00015_0'].' '.$companyLegalEnd;
							$companyNameApproverSideExistCompany2 = @$dataArr['UK-FCL-00016_0'].' '.$companyLegalEnd;
							$companyNameApproverSideExistCompany3 = @$dataArr['UK-FCL-00017_0'].' '.$companyLegalEnd;
						...
						?>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $companyNameApproverSideExistCompany1; ?>" rel="real_status_UK-FCL-00015_0" id="real_status_UK-FCL-00015_0">Click Here</a></td>
								<td><?php if($recomendedByVerifier['recomended_name']=="UK-FCL-00015_0"){ echo "<span style='color:green'>Yes</span>";}else{echo "<span style='color:red'>No</span>";}  ?></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $companyNameApproverSideExistCompany2; ?>" rel="real_status_UK-FCL-00016_0"  id="real_status_UK-FCL-00016_0">Click Here</a></td>
								<td><?php if($recomendedByVerifier['recomended_name']=="UK-FCL-00016_0"){ echo "<span style='color:green'>Yes</span>";}else{echo "<span style='color:red'>No</span>";}  ?></td>
							...
							<tr>
								...
								<td><a href="javascript:void(0);"  class="checkProposedName" data-val="<?php echo $companyNameApproverSideExistCompany3; ?>" rel="real_status_UK-FCL-00017_0"  id="real_status_UK-FCL-00017_0">Click Here</a></td>
								<td><?php if($recomendedByVerifier['recomended_name']=="UK-FCL-00017_0"){ echo "<span style='color:green'>Yes</span>";}else{echo "<span style='color:red'>No</span>";}  ?></td>
        ...
        <div class="row deptuseonly" style="padding: 12px;">			
            ...
            foreach ($processingformData as $key => $fd) {
                ...
                if ($inputType == "button") {
                    ...
                    }else if($showFlag==1 && $docStatusFlag['pending'] && $status=='H'){
					?>		
						<input type="button"  value="<?php echo $formName; ?>" class="<?php echo $cls; ?> status_butt" rel="<?php echo $status;?>">	
					<?php	
					} else {
			...
			$.ajax({
				...
				success: function(result) {
					...
					if(result=='0'){
						msg = "";
						console.log($("#"+fieldID));
						$("#"+fieldID).after("<br><span class='reserevdname'>Available</span>");
					}	
				}									
			});				
		})      
