			...
			$.each(data, function (key, item) {
				...
				if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ')) {
					...
					var checkfield = true;
							...
							if(formchk_id=='UK-FCL-00301_0' || formchk_id=='UK-FCL-00324_0' || formchk_id=='UK-FCL-00320_0' || formchk_id=='UK-FCL-00273_0' || formchk_id=='UK-FCL-00274_0' || formchk_id=='UK-FCL-00275_0' || checkfield == false){
