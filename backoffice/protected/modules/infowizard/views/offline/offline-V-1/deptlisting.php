			...
			if(empty($allOfflineApplication)){
				...
				///////////////////////////////////////////////////////////////////////////////
                   ...
                   <?php if($data['offline_application_status']=="P") { ?> <span class='badge badge-info'>Pending</span><?php } ?>
							 ...
							 <a href="/backoffice/infowizard/offline/deptpanel/appID/<?php echo $data['offline_application_id']; ?>/serviceID/<?php echo $data['service_id']; ?>/subserviceID/<?php echo $data['sub_service_id']; ?>">View Application</a>
							 </td>
