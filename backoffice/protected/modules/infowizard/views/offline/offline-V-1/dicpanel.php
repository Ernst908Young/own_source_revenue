...
<div class="site-min-height">
    ...
    <section class='panel'><div style='color:#797979;font-size:1.8em' class='panel-heading'> <small>Service Name :
...
<div id='heading' align="left">Comments : </div>
					...
					<div class="col-md-12">
					 ...
					 <td class="action1">Action :</td>

					 <td class="action1"><select id="status" name="status" class="form-control acilppr" >

					 <option value="" >Select Action</option>

					<option value="F" >Forward to Department</option>
  ...
  <!--  <input type="submit" class="btn btn-default revert" value="Revert Back To Investor">-->
	<input type="submit" value="Forword To Department" class="btn btn-primary allhide" >
	</div> 
