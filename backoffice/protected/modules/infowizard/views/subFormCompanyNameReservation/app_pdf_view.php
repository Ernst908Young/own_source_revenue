...
?>
	<table cellspacing="0" width="100%" cellpadding="2" cellpadding="5px" class="gridtable">	
		<tbody>
			...
			<tr>
				...
				<td width="95%">
					<table width="100%" border="0" >
						<tr>
							<td>
							Number of Individuals: <?php echo @$fieldValues['UK-FCL-00063_0'];?>
							</td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							...
							<table width="100%" border="1" cellpadding="5px" style="border-width:0.5px;">
								...
								<tr>
										<th colspan="2" style="background-color:#d8d8d8;text-align:center"><b>Details of Individuals <?php echo $t++;?></b></th>
								</tr>
								<tr>
								...
								<tr>
									<td><b>Individual Address State / Parishes:</b></td>
			...
			<tr>
				...
				<td width="95%">
					<table width="100%" border="0" >
						<tr>
							<td>
							No. of Corporate Partners: <?php echo @$fieldValues['UK-FCL-00246_0'];?>
							</td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							...
							<?php 
								...
								?>	
									<tr>
										<th colspan="2" style="background-color:#d8d8d8;text-align:center"><b>Details Corporate Partners <?php echo $m;?></b></th>
									</tr>
									<tr>
			...
			<tr>
				<td width="50%">Signed..................</td>
				<td width="50%" style="text-align:right;">Signed..................</td>
			</tr>
		</tbody>
	</table>
...
?>
	...
	<tbody>
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00012_0'];?></td>
							</tr>
						</table>
						</td>
					</tr>	
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo InfowizardQuestionMasterExt::getBusinessEntityType(@$fieldValues['UK-FCL-00013_0']);?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<?php  if(@$fieldValues['UK-FCL-00012_0']=='Name reservation for new Company'){ ?>
		<tr>
			<td width="5%">4.</td>
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo InfowizardQuestionMasterExt::getNameReservationNewCompany(@$fieldValues['UK-FCL-00031_0']); ?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Proposed name or name in order of prefrences :
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							...
							<tr>
								<td><b>(b)</b> <?php echo @$fieldValues['UK-FCL-00016_0'];?>&nbsp;<?php if(isset($fieldValues['UK-FCL-00014_0']) && !empty($fieldValues['UK-FCL-00014_0'])){
								echo InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
								}?></td>
							</tr>
							<tr>
								<td><b>(c)</b> <?php echo @$fieldValues['UK-FCL-00017_0'];?>&nbsp;<?php if(isset($fieldValues['UK-FCL-00014_0']) && !empty($fieldValues['UK-FCL-00014_0'])){
								echo InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
								}?></td>
							</tr>
						</table>
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Business Activity Code of types of business company carries on or proposes to carry on:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Types of business company carries on or proposes to carry on:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							...
							<td>
							<?php 
								echo @$fieldValues['UK-FCL-00244_0'];								
							?></td>
							</tr>
						</table>
						</td>
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo InfowizardQuestionMasterExt::getNameReservationExistingCompany(@$fieldValues['UK-FCL-00032_0']); ?></td>
							</tr>
						</table>
						</td>
					</tr>	
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><b>(a)</b> <?php echo @$fieldValues['UK-FCL-00015_0'];?>&nbsp;<?php if(isset($fieldValues['UK-FCL-00014_0']) && !empty($fieldValues['UK-FCL-00014_0'])){
								echo InfowizardQuestionMasterExt::getLegalEndingName(@$fieldValues['UK-FCL-00014_0']);
								}
								?></td>
							</tr>	
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Existing Company Registration No:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00019_0']; ?></td>
							</tr>
						</table>
						</td>
					</tr>	
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00020_0']; ?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						No. of Amalgamating Companies: <?php echo @$fieldValues['UK-FCL-00021_0']; ?>
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="1" cellpadding="5px">
							...
							<?php foreach(@$fieldValues['UK-FCL-00022_0'] as $ke=>$ve){ ?>					
							<tr>
		...
		<?php if($fieldValues['UK-FCL-00027_0']==2 || $fieldValues['UK-FCL-00027_0']==3){ ?>
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Details of Derivation of Name(s):
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00325_0'];?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<?php }?>
		<tr>
			<td width="5%"><?php echo $n=$k+1;?>.</td>
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Is the Company Seeking Exemption for Alternative Legal Ending:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00028_0']; ?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<?php if(isset($fieldValues['UK-FCL-00028_0']) && $fieldValues['UK-FCL-00028_0']=='Yes'){?>
		<tr>
			<td width="5%"><?php echo $n+1;?>.</td>
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo InfowizardQuestionMasterExt::getReasonExemption(@$fieldValues['UK-FCL-00029_0']); ?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<tr>
			<td width="50%">
			Name Reserved Until (Specify Date)<br>
			<ol>
				<li></li>
				<li></li>
				<li></li>
			...
			<td width="50%">
			For Director<br><br>
			See attached letter if name not reserved<br><br><br><br><br>
			Request Received By:
			</td>
		</tr>
	</tbody>
...
<table cellspacing="0" width="100%" cellpadding="2" cellpadding="5px" class="gridtable">	
	<tbody>
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><b>(a)</b> <?php echo @$fieldValues['UK-FCL-00046_0'];?>&nbsp;<?php echo @$fieldValues['UK-FCL-00475_0'];?></td>
							</tr>	
							<tr>
								<td><b>(b)</b> <?php echo @$fieldValues['UK-FCL-00047_0'];?>&nbsp;<?php echo @$fieldValues['UK-FCL-00475_0'];?></td>
							</tr>
							<tr>
								<td><b>(c)</b> <?php echo @$fieldValues['UK-FCL-00048_0'];?>&nbsp;<?php echo @$fieldValues['UK-FCL-00475_0'];?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Main Business Activity description which Society carries on or proposes to carry on:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td>
									<?php 
									$i=1;
									foreach(@$fieldValues['UK-FCL-00049_0'] as $k1=>$v1)
									{
										$businessActCode=InfowizardQuestionMasterExt::getBusinessIndustryName($v1);
										$busActCodeArr=explode("-",$businessActCode);
										echo "($i) ".$busActCodeArr[1]."<br>";
									 $i++;
									} 
									?>
		...
		<?php if($fieldValues['UK-FCL-00051_0']==2 || $fieldValues['UK-FCL-00051_0']==3){ ?>
		<tr>
			<td width="5%">5.1</td>
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00326_0'];?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<?php 
		if($fieldValues['UK-FCL-00053_0']=='2'){
		?>
		<tr>
			<td width="5%">8.</td>
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						If for a change of name, state present registration number of Society:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td><?php echo @$fieldValues['UK-FCL-00055_0'];?></td>
							</tr>
						</table>
						</td>
					</tr>	
		...
		<tr>
			...
			<td width="50%">
			For Director<br><br>
			See attached letter if name not reserved<br><br><br><br>
			Request Received By:
			</td>
		</tr>
	</tbody>		
