...
<table style="padding-top: 10px; font-size: 12;" width="100%">
    <tr>
      ...
      <td width="95%"><strong>Name of Company :</strong> <span  style="margin-top:10px;"><?php echo $fieldValues['UK-FCL-00090_0']; ?></span>
      </td>
    </tr>
     <tr>
      <td width="5%">  
...
<table style="padding-top: 10px; font-size: 12; border: 1px solid black; border-collapse: collapse; padding: 5px;">
  ...
  <tr>
    ...
    <td class="latabv"><?php echo $fieldValues['UK-FCL-00135_0'][$key];?></td>
    <td class="latabv"><?php echo $fieldValues['UK-FCL-00110_0'];?></td>
  </tr>
<?php } ?>
...
<table style="padding-top: 10px; font-size: 12;" width="100%">
    ...
    <td width="5%"> 
      ...
      <td width="95%"> 
      <table width="100%" style="padding-top: 10px; font-size: 12; border: 1px solid black; border-collapse: collapse; padding: 5px;">
        <tr>
            <th class="latabv" width="9%">Date :</th>
            <th width="20%"> <?php  echo date('d/m/y'); ?></th>
            <th class="latabv" width="18%">Signature :</th>
            <th width="25%"></th>
            <th class="latabv" width="8%">Title :</th>
            <th width="20%"></th>
        </tr>
        </table> 
    </td>
