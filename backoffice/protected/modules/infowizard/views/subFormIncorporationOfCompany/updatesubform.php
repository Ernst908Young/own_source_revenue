...
//print_r($underscoresid); die();
$this->renderPartial('/formBuilder/'.$serviceIDArr[0].'_'.$serviceIDArr[1].'_validation');
//include_once($basePath."/modules/infowizard/views/formBuilder/".$underscoresid."_validation.php");
											...
											<div class="form-group col-md-12" id="div_<?php echo $tablefieldname;?>">
												...
												<div class="col-md-12">
													...
													foreach($options as $option) {
														...
														?>
														<div class="col-md-6">
															<input <?php echo $rcreq ?> name="<?php echo $tablefieldname;if ($inputType == "checkbox") { echo "[]";}?>" type="<?php echo $inputType; ?>" value="<?php echo $option['options']; ?>" name="<?php echo $fd['id'] ?>" class="chk_<?php echo $tablefieldname." ".$val_cls; ?>" labelname="<?php echo $ln; ?>" <?php echo @$checkdradio; if($inputType== "checkbox") { if(isset($fieldValues[$tablefieldname]) && in_array($option['options'],$fieldValues[$tablefieldname])){ echo "checked";} } ?> >&nbsp;<?php echo $option['options']; ?>
														</div> 
												<?php 
													} 
													?>
...
$(document).ready(function () {
	...
	$("#UK-FCL-00804_0").datepicker({
		changeMonth: true,
		changeYear: true,		
		startDate: date
	});
	
	$("#UK-FCL-00805_0").datepicker({
		changeMonth: true,
		changeYear: true,		
		startDate: date
	});
	
	$("#UK-FCL-00266_3").datepicker({
		changeMonth: true,
		changeYear: true
	});	
	
	$("#UK-FCL-01318_0").datepicker({
		changeMonth: true,
		changeYear: true
	});		
