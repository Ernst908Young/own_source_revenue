...
<div class="row" style="margin:10px 0 10px 0;">
   <div class="col-md-6">  
        <label for="inputEmail1">Select Department:
        </label>
        
            <select name="issuerby_id"  id="deptlist" onchange="window.location = '/panchayatiraj/backoffice/infowizard/subForm/subFormListing/id/' + this.value + '/' + document.getElementById('addPaging').value + ''">
    ...
    <div class="col-md-6">
        <label for="inputEmail1">Add More Pages:
        </label>
        <div class="col-md-12">	
            <select id="addPaging"  onchange="window.location = '/panchayatiraj/backoffice/infowizard/subForm/subFormListing/id/' + document.getElementById('deptlist').value + '/' + this.value">
							...
							?>
                                    <tr>
                                        ...
                                        <?php echo $data_arr['core_service_name']; ?>
                                            <br>
                                            <a  href="javascript:void(0);" style="color:blue;" class="addForm" data-bs-toggle="modal" data-bs-target="#myModal2" frm_service_id="<?php echo $sID = $service_id . "." . $sub_service_id; ?>" frm_form_type_id="<?php echo $key; ?>" frm_form_name="<?php if (!empty($serviceFormData)) {  echo $serviceFormData->form_name; } ?>"> 
                                        ...
                                        <?php $rt = InfowizardQuestionMasterExt::getFormPageId($service_id . "." . $sub_service_id, $key, $i) ? InfowizardQuestionMasterExt::getFormName($service_id . "." . $sub_service_id, $key, $i) : $i; ?>
                                                <a  href="javascript:void(0);" style="color:blue;" class="addPage" data-bs-toggle="modal" data-bs-target="#myModal" data-id="pg<?php echo $service_id . "_" . $sub_service_id . "_" . $i . "_" . $key; ?>" data-sr_id="<?php echo $service_id . "." . $sub_service_id; ?>" data-page_name="<?php echo $rt; ?>" data-frm_id="<?php echo $key; ?>" data-page_prefrence="<?php echo $i; ?>">
                                            <?php echo $rt; ?> 
                                                                        </a>  
                                            ...
                                            if (!empty($formpageID)) {
                                              ...
                                              <a href="javascript:void(0);" style="color:red;"  pageid="<?php echo (INT) $formpageID; ?>" class="addCat" data-bs-toggle="modal" data-bs-target="#myModal3" id="cat<?php echo $service_id . "_" . $sub_service_id . "_" . $i . "_" . $key; ?>" data-rows="10" data-page_cat_map="<?php echo $i; ?>" data-id="cat<?php echo $service_id . "_" . $sub_service_id . "_" . $i . "_" . $key; ?>" data-sr_id="<?php echo $service_id . "." . $sub_service_id; ?>" data-frm_id="<?php echo $key; ?>"  data-page_prefrence="<?php echo $i; ?>" href="javascript:void(0);" tabindex="0" 
										...
										if (empty($serviceFormData)) {
                                          ...
                                          echo "-";
                                           ...
                                           $formID = $serviceFormData->form_type_id; ?>
                                            <a href="/panchayatiraj/backoffice/infowizard/formBuilder/createform/service_id/<?php echo $service_id . "." . $sub_service_id; ?>/pageID/1/formCodeID/<?php echo $formID; ?>/formID/<?php echo $applicationFormId; ?>" style="color:blue;" target="_blank">Capture Form-Fields 
                                            </a>
											<?php
											if($formID==1){
											?>	
