...
<table class='table table-striped table-bordered' id='sample_2'>
	<thead>
		<tr>
			...
			<th class="a_cent_left">Application Details</th>
			<th class="a_cent_left">Service Name</th>
	...
	<?php if(isset($res) && !empty($res)) { 
		...
		?>
				...
				<td class="a_cent_left"><?php echo $val['core_service_name']?></td>
				...
				?>
				<td class="a_cent"><a href="<?php echo Yii::app()->createAbsoluteUrl("/infowizard/".$action['form_action_controller']."/departmentFormView/service_id/".$val['serviceID']."/pageID/1/subID/".$val['submission_id']."/formCodeID/$formtype_id");?>" class="btn btn-success">View</a>
				<!--<br/><br/>
				<a href="<?php //echo Yii::app()->createAbsoluteUrl("/infowizard/".$action['form_action_controller']."/applicationTimeline/subID/".base64_encode($val['submission_id'])."");?>" class="btn btn-success">Timeline</a>-->
				</td>		
	</tr>	<?php 	}
		}
	?>
