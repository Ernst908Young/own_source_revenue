...
{ 
$this->renderPartial('/formBuilder/updatesubform/tab_name',['aap'=>$aap]);
}
?>
<div class="reservation-form p-0"> 
<!--begin: Form Wizard Form-->
<div class="m-wizard__form" style="padding: 17px 33px 0px;">
<p style="color:red; font-size: 12px;">Fields marked with * are mandatory fields, however, in case any of these fields in not applicable in your case, then please mention "Not Applicable" or "NA"</p>
...
<div class="next-btn">   
	...
	<a href="javascript:void(0);" class="custome-btn" data-wizard-action="prev" style="background-color:#E5E5E5;">
		<span>
