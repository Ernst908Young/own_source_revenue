...
class Utility9_0{
	...
	public static function generatePdfApp($content,$contentform3,$contentform6,$name){ 
		...
		$pdf->AddPage();
		$pdf->Cell(0, 10, $pdf->writeHTML($contentform3), 0, 1, 'L');

		$pdf->AddPage();
		$pdf->Cell(0, 10, $pdf->writeHTML($contentform6), 0, 1, 'L');
