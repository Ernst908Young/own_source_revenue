	...
	class Utility25_0c
	{
		...
		//	$pdf->AliasNbPages();
			...
			if($type=='revoke'){
				...
				$pdf->Image($image_file2, 16, 21.3, 3.5, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
			}
		...
		/* public static function generateNewCafPdfApp($content,$name,$submission_id,$dept_id){
		...
		$pdf->Cell(13, 0, "Scan to verify",  '', 1, 'L');
				 ...
				 $image_file2 = $_SERVER['DOCUMENT_ROOT'].Yii::app()->theme->baseUrl.'/img/trs.png';
		...
		if(isset($_GET['is_vpd'])){
						...
						$vpdcontent='<table style="padding:10px;">
					            <tr>
					              <th bgcolor="yellow">This document is downloaded under View Public Document (VPD) service of CAIPO. In case you wish for getting certified true copy of the same, please apply for the same on CAIPO separately.
					              </th>
					            </tr>			            
					          </table>'; 
					    $pdf->SetXY(1, 24);
