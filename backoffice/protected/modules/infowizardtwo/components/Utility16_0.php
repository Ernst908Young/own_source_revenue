...
class Utility16_0{
	...
	public static function generatePdfApp($content,$content1,$name, $app_log,$fieldValues2){ 
		...
		$pdf->Image($image_file2, 17.9, 4.6, 2, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
		$pdf->SetY(3);
		}else{
		...
		$pdf->AddPage();
		$pdf->writeHTML($content1, true, 0, 0, 0);
