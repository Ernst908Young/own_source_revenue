...
<tr>
  ...
  <td width="20%"> </td>
            ...
            <tr>
            <th >Charity Number: '.$this->reg_no.'</th></tr>
          </table>'; 
	        }
...
class Utility7_0{
	...
	public static function generatePdfApp($content,$name,$app_log,$fieldValues2){ 
		...
		$reg_no = 'NA';
		if($fieldValues2){
			if(isset($fieldValues2['UK-FCL-00307_0'])){
				if($fieldValues2['UK-FCL-00307_0']!=''){
					$reg_no = $fieldValues2['UK-FCL-00307_0'];
				}				
			}
		}
		...
		$pdf->Image($image_file2, 17.5, 5.4, 2, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
		$pdf->SetY(3);
		}else{
