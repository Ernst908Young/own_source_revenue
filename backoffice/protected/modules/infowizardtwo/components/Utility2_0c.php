<?php
	...
	class MYPDF extends TCPDF {
	   ...
	   public function Header() { 	        
			...
			$this->Image($image_file2, 9.5, 2, 3, '2.8', '', '4', 'T', false, 150, '6', false, false, 0, false, false, false); 
	...
	{		
		...
		//	$pdf->AliasNbPages();
			...
			$pdf->SetXY(11, 22);
			$pdf->SetFont("Cambria", "U", 12);
			$pdf->Cell(13, 0, $approver_profile['signatories_name'],  '', 1, 'C');
			$pdf->SetX(11);
			$pdf->SetFont("Cambria", "B", 12);
			$pdf->Cell(13, 0, $approver_profile['designation'],  '', 1, 'C');
