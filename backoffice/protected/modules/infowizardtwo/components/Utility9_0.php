	    ...
	    public function Header() {
	     ...
	     /*   $image_file = $_SERVER['DOCUMENT_ROOT'].Yii::app()->theme->baseUrl.'/img/'.$logo_url;
	      ...
	      //  $this->Cell(0, -5, '', 0, '', 'T', 0, 'C');
			...
			if($this->page == 2){
				$this->Cell(0, 0, 'Form 3', 0, 1, 'R', 0, '', 0);
			}
...
class Utility9_0{
	...
	public static function generatePdfApp($content,$contentform3,$contentform6,$name,$app_log){ 
		...
		$pdf->Image($image_file2, 17.6, 4.5, 2, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
		$pdf->SetY(3);
		}else{
