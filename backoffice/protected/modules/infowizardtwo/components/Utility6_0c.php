<?php
	...
	class Utility6_0c
	{
		...
		public static function generateNewCafPdfApp($content,$name,$submission_id,$dept_id,$content_letter,$approver_profile){
		...
		$pdf->Cell(13, 0, "Scan to verify",  '', 1, 'L');
		 ...
		 $sign_image = $_SERVER['DOCUMENT_ROOT'].Yii::app()->theme->baseUrl.'/img/'.$approver_profile['signature'];
		...
		$pdf->writeHTML($content_letter, true, 0, 0, 0);
		 ...
		 $image_file3 = $_SERVER['DOCUMENT_ROOT'].Yii::app()->theme->baseUrl.'/img/mbwb.png';
			...
			$pdf->Image($image_file, 1.5, 1.2, 3.6, 3, '', '4', 'T', false, 150, '', false, false, 0, false, false, false);

			$pdf->Image($image_file3, 25, 1.2, 3, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
				$pdf->SetXY(1,1);
