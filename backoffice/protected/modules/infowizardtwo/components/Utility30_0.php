...
//Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M')
			...
			if($this->page == 1){
				$this->Cell(0, 0, 'Form 31', 0, 1, 'R', 0, '', 0);
			}
	    ...
	    // Page footer
	     public function Footer() {
	    	...
	    	if($this->is_approved==1){
	    		$this->SetY(-3.7);    // Position at 30 mm from bottom
...
class Utility30_0{
	...
	public static function generatePdfApp($content,$name,$app_log,$fieldValues2){ 
		...
		$pdf->Image($image_file2, 17.5, 4.6, 2, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
		$pdf->SetY(3);
		}else{
