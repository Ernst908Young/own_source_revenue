...
//Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M')
			...
			if($this->page == 1){
				$this->Cell(0, 0, 'Form 15', 0, 1, 'R', 0, '', 0);
			}
...
class Utility37_0{
	...
	public static function generatePdfApp($content,$contentform4=null,$contentform9=null,$name,$app_log,$signatory_details,$fieldValues2){ 
		...
		if($fieldValues2){
			if($fieldValues2['UK-FCL-00703_0'] == "Yes"){
				if(isset($fieldValues2['UK-FCL-00711_0'])){
					if($fieldValues2['UK-FCL-00711_0']!=''){
						$reg_no = $fieldValues2['UK-FCL-00711_0'];
					}				
				}
			}
			elseif($fieldValues2['UK-FCL-00703_0'] == "No"){
				if(isset($fieldValues2['UK-FCL-00704_0'])){
					if($fieldValues2['UK-FCL-00704_0']!=''){
						$reg_no = $fieldValues2['UK-FCL-00704_0'];
					}				
				}
			}
		}
