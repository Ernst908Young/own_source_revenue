<?php
	...
	class MYPDF extends TCPDF {
	   ...
	   public function Header() { 	        
			$img_file = $_SERVER['DOCUMENT_ROOT'].Yii::app()->theme->baseUrl.'/img/AshokStambh.png';
	...
	class Utility47_0c
	{
		...
		public static function generateNewCafPdfApp($content,$name,$submission_id,$dept_id,$approver_profile){
			...
			$pdf->SetAuthor("E-Judiciary");
			$pdf->SetTitle($name."E-Judiciary");
			$pdf->SetSubject($name);
			$pdf->SetKeywords("E-Judiciary");
		...
		$pdf->Image($image_file2, 13.5, 15, 3, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
