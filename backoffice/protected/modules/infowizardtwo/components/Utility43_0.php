...
//Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M')
			...
			// if($this->page == 1){
			// 	$this->Cell(0, 0, 'A64:024', 0, 1, 'R', 0, '', 0);
			// }
  ...
  <td width="20%"> </td>
			...
			if(isset($_GET['is_vpd'])){
				...
				$data.='<hr /><table class="tbl">
			            ...
			            <tr>
			            <th >Registration Number: '.$this->reg_no.'</th></tr>
			          </table>'; 
			}
...
class Utility43_0{
	...
	public static function generatePdfApp($content,$name,$app_log,$fieldValues2){ 
		...
		$reg_no = 'NA';
		if($fieldValues2){
			if(isset($fieldValues2['UK-FCL-00415_0'])){
				if($fieldValues2['UK-FCL-00415_0']!=''){
					$reg_no = $fieldValues2['UK-FCL-00415_0'];
				}				
			}
		}
