...
//Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M')
			...
			if($this->page == 1){
				$this->Cell(0, 0, 'Form 35', 0, 1, 'R', 0, '', 0);
			}
...
class Utility29_0{
	...
	public static function generatePdfApp($content,$name,$app_log,$fieldValues2){ 
		...
		$reg_no = 'NA';
		if($fieldValues2){
			if(isset($fieldValues2['UK-FCL-00631_0'])){
				if($fieldValues2['UK-FCL-00631_0']!=''){
					$reg_no = $fieldValues2['UK-FCL-00631_0'];
				}				
			}
		}
		...
		$data='<table  style="border: 1px blue solid ; border-collapse: collapse; padding: 1px;">
			    <tr>
		...
		$pdf->Image($image_file2, 17.5, 4.3, 2, '', '', '', 'T', false, 150, '', false, false, 0, false, false, false);
		$pdf->SetY(3);
		}else{
