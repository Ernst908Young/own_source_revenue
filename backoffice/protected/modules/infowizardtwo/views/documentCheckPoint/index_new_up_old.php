 ...
 ?>
    ...
    <div class="row" style="margin:10px 0 10px 0;">
	       ...
	       <label class="col-sm-1 control-label" for="application_name" > 
			...
			<label class="col-sm-1 col-sm-1 control-label" for="application_name" >Is Active</label>
	...
	<div class="row form-group buttons" align="center">
	 ...
	 <input type="button" name="create" value="Create" onclick="saveMe();" class="btn btn-primary submit_btn">
...
<div class='portlet-title'>
 ...
 <div class="portlet-body">
<form name="ajaxFrm" id="ajaxFrm">
          <p style="float:right;">
		  <input type="text" name="" placeholder="" class="form-control" style="width:150px;" />
		  </p>
              ...
              if(empty($apps)){
                ...
                foreach ($apps as $key => $apps) {
                    ...
                    <tr>
						...
						<td align="center"><input type="checkbox" class="ids" name="dcp_arr[]" value="<?php echo $id; ?>" <?php if(in_array($id, $main_arr)){ ?> checked <?php } ?> <?php echo $strTxt; ?> /></td>
