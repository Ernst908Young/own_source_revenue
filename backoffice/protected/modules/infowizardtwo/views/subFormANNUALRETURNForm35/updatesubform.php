...
<?php 
// echo "<pre>";print_r($fieldValues);die;
...
$(document).ready(function () {
	...
	window.onload = function () {
	     ...
	     $('#UK-FCL-00556_0 option[value="<?=$fieldValues['UK-FCL-00556_0']?>"]').attr('selected','selected');
	     $("#UK-FCL-00556_0").select2('destroy');
	 };
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data, function (key, item) {
					...
					if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ') && (formchk_id!='UK-FCL-00309_0' || formchk_id!='UK-FCL-00309_0') && (formchk_id!='UK-FCL-00310_0' || formchk_id!='UK-FCL-00310_0') && (formchk_id!='UK-FCL-00094_0' || formchk_id!='UK-FCL-00094_0') && (formchk_id!='UK-FCL-00105_0' || formchk_id!='UK-FCL-00105_0')) {
						//alert(formchk_id);
					...
					else if (formchk_id == 'UK-FCL-00105_0' && checkfield==false && cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ')){
						//alert("dsjdk");
						...
						//alert(formchk_id);
						$("#div_"+formchk_id).find(".errorDetail").first().remove();
						$("#div_"+formchk_id).append("<span style='color:red;' class='errorDetail'>Please enter the required information or select the check box</span>");
						//alert("Please fill the required field:  " + $.trim(labelData));
						err = err + 1;
						return false;
					}
