...
<?php 
	...
	<div class="portlet box green">
		<div class="portlet-title">
			...
			?>
			<a href="/backoffice/infowizard/<?php echo $action['form_action_controller'];?>/downloadNewApp/service_id/<?php echo $_GET['service_id'];?>/pageID/1/subID/<?php echo $submittion_id;?>/formCodeID/1" target="blank" class="btn btn-primary" style="height: 33px;">Print Application</a>
			</div>
		</div>
		...
		if(!empty($get_logg))
		{
			...
			action="<?php echo Yii::app()->createAbsoluteUrl("/infowizard/subFormCompanyNameReservation/processData"); ?>">
