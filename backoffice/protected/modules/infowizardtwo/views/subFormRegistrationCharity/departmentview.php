...
<?php 
	...
	<div class="portlet box green">
		...
		if(!empty($get_logg))
		{
			...
			action="<?php echo Yii::app()->createAbsoluteUrl("/infowizardtwo/subFormRegistrationCharity/processData"); ?>">
    ...
    $(document).ready(function () {
		...
		$('.btn_view').on('click',function(){
			...
			$.ajax({
				...
				url: "<?php echo Yii::app()->request->baseUrl; ?>/infowizardtwo/formFieldMasterRegistrationCharity/getFormHtml",
