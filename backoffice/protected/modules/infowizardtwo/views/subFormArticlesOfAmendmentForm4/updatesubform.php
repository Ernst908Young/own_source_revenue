...
$(document).ready(function () {
	...
	var check = $('input[name=UK-FCL-00362_0]:checked').val();
	if(check == 'Yes'){
		var middle = $("#UK-FCL-00105_0").val();
		if(middle == ''){
			$("#UK-FCL-00105_0").attr("readonly", true);
			$("#middlenamecheckbox00105_0").attr("checked", true);
		}
	}
	
		var ff501 = $("#UK-FCL-00501_0").val();
		var step_data = $("#UK-FCL-00501_0").val();
	...
	function five_show(){
	    $(".agentdetail").show();
	    $("#div_UK-FCL-00362_0,#div_UK-FCL-00132_0,#div_UK-FCL-00105_0,#div_UK-FCL-00106_0,#div_UK-FCL-00104_0,#div_UK-FCL-00309_0,#div_UK-FCL-00354_0,#div_UK-FCL-00396_0,#div_UK-FCL-00242_0,#div_UK-FCL-00295_0").show();
	  	$('#UK-FCL-00396_0').attr("disabled", true); 
	...
	function five_hide(){
		...
		$("#div_UK-FCL-00362_0,#div_UK-FCL-00132_0,#div_UK-FCL-00105_0,#div_UK-FCL-00106_0,#div_UK-FCL-00104_0,#div_UK-FCL-00309_0,#div_UK-FCL-00354_0,#div_UK-FCL-00396_0,#div_UK-FCL-00242_0,#div_UK-FCL-00295_0").hide();
			...
			success: function (data) {
				...
				$.each(data, function (key, item) {
					...
					if ($(selector).is("input")) {
						...
						if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ') && (formchk_id!='UK-FCL-00266_0' || formchk_id!='UK-FCL-00266_0')) {
						//alert(formchk_id);
						var labelData = $("#label_" + formchk_id).text();
						labelData=labelData.replace('('+formchk_id+')',"");
						//alert(formchk_id);
						$("#div_"+formchk_id).find(".errorDetail").first().remove();
						$("#div_"+formchk_id).append("<span style='color:red;' class='errorDetail'>Please fill the required field</span>"); 
						//alert("Please fill the required field:  " + $.trim(labelData));
						err = err + 1;
						return false;
					}

					else if ((formchk_id == 'UK-FCL-00266_0' || formchk_id =='UK-FCL-00266_0') && ($('input[name="UK-FCL-00370_0"]:checked').val()=='Yes') && cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ')){
						var labelData = $("#label_" + formchk_id).text();
						labelData=labelData.replace('('+formchk_id+')',"");
						//alert(formchk_id);
						$("#div_"+formchk_id).find(".errorDetail").first().remove();
