...
<table  style="padding-top: 10px;"> 
   <tr>
      <td style="text-align:center;">     
         ...
         <span style="font-size: 12;">(Sections 33 & 203)</span>   <br><br>
         <span style="font-size: 14;"><strong>ARTICLES OF AMENDMENT (Form 4)</strong></span>   <br>
      </td>
   </tr>
</table>
<br><br><br>
<table  style="padding-top: 10px; font-size: 12;" width="100%"> 
   <tr>
      ...
      <td width="95%"><strong>Name of Society:</strong> <br><br><?php echo $fieldValues['UK-FCL-00197_0']; ?>
      </td>
   </tr>
   <tr>
      <td width="5%">  
      ...
      <td width="95%"><strong>Society Number:</strong> <br><br><?php echo $fieldValues['UK-FCL-00290_0']; ?>
      </td>
   </tr>
   <tr>
    <td width="5%">  
      ...
      <td width="95%"><strong>The articles of the above named Society are amended as follows:</strong>
         <br><br><?php 
         $typeodchange = [];
                 if(isset($fieldValues['UK-FCL-00501_0'])){
                   if(is_array($fieldValues['UK-FCL-00501_0'])){
                     if(!empty($fieldValues['UK-FCL-00501_0'])){
                       $typeodchange = $fieldValues['UK-FCL-00501_0'];
      ...
      <tr>
         ...
         <td width="95%"><strong>It is hereby certified that the amendment(s) to Articles was/were approved by special resolution in accordance with section 7 of the Companies Act, and copy of special resolution is attached to this form: </strong><br><br><?php  if(isset($fieldValues['UK-FCL-00666_0'])){ echo $fieldValues['UK-FCL-00666_0'];}?>        
         </td>
       </tr>
