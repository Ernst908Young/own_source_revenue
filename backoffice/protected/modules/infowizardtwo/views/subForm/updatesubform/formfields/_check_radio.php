	...
	<div id="input_<?php echo $tablefieldname;?>">
		...
		foreach($options as $option) {
			...
			?>
				...
				<input <?php echo $rcreq ?> name="<?php echo $tablefieldname;if ($inputType == "checkbox") { echo "[]";}?>" type="<?php echo $inputType; ?>" value="<?php echo $option['options']; ?>" name="<?php echo $fd['id'] ?>" class="chk_<?php echo $tablefieldname." ".$val_cls; ?>" style="<?php echo $classEditOrNot_radio_checkbox ?>" labelname="<?php echo $ln; ?>" 
					<?php 
