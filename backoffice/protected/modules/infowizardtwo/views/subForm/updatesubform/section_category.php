...
$oldcategorysection = NULL;
		...
		/*if($fieldValues['UK-FCL-00493_0']=='Yes'){
     			echo $fieldValues['UK-FCL-00493_0'];    
...
$this->renderPartial('updatesubform/formfields/_text_number_password_email_url',['fd'=>$fd,'inputType'=>$inputType,'maxLength'=>$maxLength,'minLength'=>$minLength,'val_cls'=>$val_cls,'id'=>$id,'button_id'=>$button_id,'addMoreLineCheck'=>$addMoreLineCheck,'classEditOrNot'=>$classEditOrNot,'fieldValues'=>$fieldValues,'match_fields_for_change_array'=>$match_fields_for_change_array]); 

}				
       
if ($inputType == "select" || $inputType == "multipleselect"){
				
$this->renderPartial('updatesubform/formfields/_select_multiselect',['fd'=>$fd,'inputType'=>$inputType,'maxLength'=>$maxLength,'minLength'=>$minLength,'val_cls'=>$val_cls,'id'=>$id,'button_id'=>$button_id,'addMoreLineCheck'=>$addMoreLineCheck,'classEditOrNot'=>$classEditOrNot,'fieldValues'=>$fieldValues,'match_fields_for_change_array'=>$match_fields_for_change_array]); 				
} 

if ($inputType == "checkbox" || $inputType == "radio") {
	$this->renderPartial('updatesubform/formfields/_check_radio',['fd'=>$fd,'inputType'=>$inputType,'maxLength'=>$maxLength,'minLength'=>$minLength,'val_cls'=>$val_cls,'id'=>$id,'button_id'=>$button_id,'addMoreLineCheck'=>$addMoreLineCheck,'classEditOrNot_radio_checkbox'=>$classEditOrNot_radio_checkbox,'fieldValues'=>$fieldValues,'match_fields_for_change_array'=>$match_fields_for_change_array]);				
} 

if ($inputType == "textarea") {
	$this->renderPartial('updatesubform/formfields/_textarea',['fd'=>$fd,'inputType'=>$inputType,'maxLength'=>$maxLength,'minLength'=>$minLength,'val_cls'=>$val_cls,'id'=>$id,'button_id'=>$button_id,'addMoreLineCheck'=>$addMoreLineCheck,'classEditOrNot'=>$classEditOrNot,'fieldValues'=>$fieldValues,'match_fields_for_change_array'=>$match_fields_for_change_array]);					
} 

if ($inputType == "calender") {
	$this->renderPartial('updatesubform/formfields/_calender',['fd'=>$fd,'inputType'=>$inputType,'maxLength'=>$maxLength,'minLength'=>$minLength,'val_cls'=>$val_cls,'id'=>$id,'button_id'=>$button_id,'addMoreLineCheck'=>$addMoreLineCheck,'classEditOrNot'=>$classEditOrNot,'fieldValues'=>$fieldValues,'match_fields_for_change_array'=>$match_fields_for_change_array]);				
} 
