   ...
   if(isset($fieldValue['UK-FCL-00095_0'])){
      foreach ($fieldValue['UK-FCL-00095_0'] as $key => $flieldVal) {
         ...
         echo '<tr class="add_more_4167">
				<td><input type="text" name="UK-FCL-00263_0[]" value="'.(empty(@$fieldValue['UK-FCL-00263_0'][$key]) ? "  " : @$fieldValue['UK-FCL-00263_0'][$key]).'" class="form-control" title="'.@$fieldValue['UK-FCL-00263_0'][$key].'" readonly></td>
				<td><input type="text" name="UK-FCL-00264_0[]" value="'.@$fieldValue['UK-FCL-00264_0'][$key].'" class="form-control" title="'.@$fieldValue['UK-FCL-00264_0'][$key].'" '. (empty($fieldValue['UK-FCL-00264_0'][$key]) ? ' required ' : ' readonly="" ' ).'></td>
               ...
               <td><input type="text" name="UK-FCL-00095_0[]" value="'.@$fieldValue['UK-FCL-00095_0'][$key].'" class="form-control" title="'.@$fieldValue['UK-FCL-00095_0'][$key].'" '. (empty($fieldValue['UK-FCL-00095_0'][$key]) ? ' required ' : ' readonly="" ' ).'></td>
