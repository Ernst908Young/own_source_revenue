...
$(document).ready(function () {
	...
	var ff669 = $("#UK-FCL-00669_0").val();
		var step_data = $("#UK-FCL-00669_0").val();
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data, function (key, item) {
					...
					else if ((formchk_id == 'UK-FCL-00266_0' || formchk_id =='UK-FCL-00266_0') && ($('input[name="UK-FCL-00265_0"]:checked').val()=='Yes') && cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ')){
						var labelData = $("#label_" + formchk_id).text();
						labelData=labelData.replace('('+formchk_id+')',"");
						//alert(formchk_id);
						$("#div_"+formchk_id).append("<span style='color:red;padding-left:16px;' class='errorDetail'>Please fill the required field: "+$.trim(labelData)+"</span>");
