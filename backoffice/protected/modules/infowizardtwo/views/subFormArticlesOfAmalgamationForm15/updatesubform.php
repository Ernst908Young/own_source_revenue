...
<!-- <div class="col-lg-6 m--align-right"> -->
	...
	<a href="javascript:void(0);" class="custome-btn next_btn" data-wizard-action="next" rel="<?php echo @$_GET['service_id']?>" >
		<span>
			<span>
				Next
				<!-- Save & Continue -->
...
$(document).ready(function () {
	...
	var transferable =   $("#UK-FCL-00334_0").val();
	if(transferable == "Yes"){
		$("#div_UK-FCL-00709_0").show();
		var check = $('.chk_UK-FCL-00709_0').val();
		if(check == 'Other Restrictions'){
	...
	var company =   $("#UK-FCL-00703_0").val();
	if(company == 'Yes'){
	...
	var type =  $("#UK-FCL-00699_0").val();
	if(type == "Long Form Amalgamation by Agreement"){
		$("#title_UK-FCL-00706_0").show();
				...
				$("#div_UK-FCL-00087_0,#div_UK-FCL-00339_0,#div_UK-FCL-00098_0,#title_UK-FCL-00339_0, #title_UK-FCL-00240_0,#div_UK-FCL-00240_0, #div_UK-FCL-00334_0, #title_UK-FCL-00262_0,#div_UK-FCL-00262_0,#div_UK-FCL-00095_0,#div_UK-FCL-00263_0,#div_UK-FCL-00264_0,#div_UK-FCL-00265_0,#div_UK-FCL-00266_0,#div_UK-FCL-00113_0,#div_UK-FCL-00033_0,#div_UK-FCL-00262_01,#test, #div_UK-FCL-00703_0,#div_UK-FCL-00702_0,#div_UK-FCL-00701_0,#div_UK-FCL-00420_0,#div_UK-FCL-0042011_0,  #div_UK-FCL-00700_0").show();
		
	}else if(type =='Vertical Short Form Amalgamation'){
			...
			}else if(type =='Horizontal Short Form Amalgamation'){
				$("#div_UK-FCL-00087_0,#div_UK-FCL-00339_0,#div_UK-FCL-00098_0,#title_UK-FCL-00339_0, #title_UK-FCL-00240_0,#div_UK-FCL-00240_0, #div_UK-FCL-00334_0, #title_UK-FCL-00262_0,#div_UK-FCL-00262_0,#div_UK-FCL-00095_0,#div_UK-FCL-00263_0,#div_UK-FCL-00264_0,#div_UK-FCL-00265_0,#div_UK-FCL-00266_0,#div_UK-FCL-00113_0,#div_UK-FCL-00033_0,#div_UK-FCL-00262_01,#test, #div_UK-FCL-00703_0,#div_UK-FCL-00702_0,#div_UK-FCL-00701_0,#div_UK-FCL-00420_0,#div_UK-FCL-0042011_0,  #div_UK-FCL-00700_0").show();
				...
				$("#div_UK-FCL-00087_0,#div_UK-FCL-00339_0,#div_UK-FCL-00098_0,#title_UK-FCL-00339_0, #title_UK-FCL-00240_0,#div_UK-FCL-00240_0, #div_UK-FCL-00334_0, #title_UK-FCL-00262_0,#div_UK-FCL-00262_0,#div_UK-FCL-00095_0,#div_UK-FCL-00263_0,#div_UK-FCL-00264_0,#div_UK-FCL-00265_0,#div_UK-FCL-00266_0,#div_UK-FCL-00113_0,#div_UK-FCL-00033_0,#div_UK-FCL-00262_01,#test, #div_UK-FCL-00703_0,#div_UK-FCL-00702_0,#div_UK-FCL-00701_0,#div_UK-FCL-00420_0,#div_UK-FCL-0042011_0,  #div_UK-FCL-00700_0").hide();
	...
	<?php 
	$serviceArr = array('2.0','4.0','7.0','16.0','13.0','15.0','37.0');
