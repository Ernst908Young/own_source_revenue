...
<table style="padding-top: 10px; font-size: 12;" width="100%">
	...
	<tr>
      ...
      <td width="95%"><strong>Mailing Address:</strong><br><br><?php 
		 if(isset( $fieldValues['UK-FCL-00349_0'])){
          // $parish1 = Yii::app()->db->createCommand("SELECT lr_id,lr_name from bo_landregion where lr_id=".$fieldValues['UK-FCL-00349_0'])->queryRow(); 
        }else{
          $parish1 = [];
        }
	...
	if(@$fieldValues['UK-FCL-00493_0']){
      ...
      echo @$fieldValues['UK-FCL-00342_0'].' '.@$fieldValues['UK-FCL-00343_0'].' '.@$fieldValues['UK-FCL-00348_0'].' '.strtoupper(@$parish1['lr_name']).' '.strtoupper(@$country1['lr_name']).' '.$mpc;
