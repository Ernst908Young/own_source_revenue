...
$(document).ready(function () {
	...
	let reg_no       = $("#UK-FCL-00650_0").val();	
	getAutoPopulateData(reg_no,entoty_type);
...
function deleterow(id,table_id){
	...
	function getAutoPopulateData(reg_no,type_of_entity){	
		$("#UK-FCL-00654_0").attr('disabled', true); 
	
		 //$("#UK-FCL-00654_0").attr("readonly");	
            $.ajax({
				type: "POST",
				dataType: 'json',
				...
				success: function(result) {
					if(result.status == true) {	
						...
						//$("#UK-FCL-00654_0").attr('readonly', true);  	
						$("#UK-FCL-00654_0").attr("readonly");		   
