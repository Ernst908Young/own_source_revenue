...
<table style="padding-top: 10px; font-size: 12;" width="100%">
    <tr>
      ...
      <td width="95%"><strong>SRN Number:</strong> <span  style="margin-top:10px;"><?php echo $fieldValues['UK-FCL-00331_0']; ?></span>
      </td>
    </tr> 
...
<tr>
 ...
 <?php foreach($sig_detail as $val){ ?>
  <tr>
    <td class="latabv"><?= $val['first_name'].' '.$val['middle_name'].' '.$val['last_name'] ?></td>
    <td class="latabv"><?= $val['designation'] ?></td>
    <td class="latabv">Electronically signed</td>
    <td class="latabv"><?= date('d M,Y',strtotime($val['date_of_signing'])) ?></td>
  </tr>
<?php } ?>
