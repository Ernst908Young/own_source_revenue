		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data, function (key, item) {
					...
					if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ') && (formchk_id!='UK-FCL-00309_0' || formchk_id!='UK-FCL-00309_0') && (formchk_id!='UK-FCL-00310_0' || formchk_id!='UK-FCL-00310_0') && (formchk_id!='UK-FCL-00094_0' || formchk_id!='UK-FCL-00094_0')) {
					...
					else if ((formchk_id == 'UK-FCL-00481_0' || formchk_id =='UK-FCL-00481_0') && ($('input[name="UK-FCL-00480_0"]:checked').val()=='Yes') && cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ')){
						var labelData = $("#label_" + formchk_id).text();
						labelData=labelData.replace('('+formchk_id+')',"");
						//alert(formchk_id);
						$("#div_"+formchk_id).find(".errorDetail").first().remove();
