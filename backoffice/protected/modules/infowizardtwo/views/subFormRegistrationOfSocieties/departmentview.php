...
<?php 
	...
	<div class="portlet box green">
		...
		if(!empty($get_logg))
		{
			...
			{                           
                    ...
                    ?>				
						<tr>
							...
							<!-- <td class="a_cent"><1?php  
								if(array_key_exists($vall['action_status'], $statusArray)){
									echo $statusArray[$vall['action_status']] ;
								}
							?></td> -->
			...
			action="<?php echo Yii::app()->createAbsoluteUrl("/infowizardtwo/subFormRegistrationOfSocieties/processData"); ?>">
    ...
    $(document).ready(function () {
		...
		$('.btn_view').on('click',function(){
			...
			$.ajax({
				...
				url: "<?php echo Yii::app()->request->baseUrl; ?>/infowizardtwo/formFieldMasterRegistrationOfSocieties/getFormHtml",
