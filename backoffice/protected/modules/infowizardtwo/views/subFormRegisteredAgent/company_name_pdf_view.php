...
<table style="padding-top: 10px;" width="100%">
    <tr>
	<td width="100%">
		<strong> Know all men by these presents that</strong> <?php  echo @$fieldValues['UK-FCL-00197_0'].' | '. @$fieldValues['UK-FCL-00413_0']; ?><br>
	</td>
...
<td width="50%"></td><td width="50%">
    ...
    <tr>
      <td>Hereby appoints:<br>
	
	<?php  echo @$fieldValues['UK-FCL-00132_0'].' '.@$fieldValues['UK-FCL-00105_0'].' '.@$fieldValues['UK-FCL-00106_0'].', '.@$fieldValues['UK-FCL-00476_0']; ?>
