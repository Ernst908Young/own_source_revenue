...
<table style="padding-top: 10px;">
    ...
    <td style="text-align:center;">     
        ...
        <span style="font-size: 14;"><strong>APPLICATION FOR INCORPORATION AS A BOARD</strong></span>   <br>
        <span style="font-size: 13;">FORM 2</span>   <br><br>
...
if($fieldValues['UK-FCL-00094_0']){
      ...
      echo @$fieldValues['UK-FCL-00308_0'].' '.@$fieldValues['UK-FCL-00309_0'].' '.@$fieldValues['UK-FCL-00310_0'].' '.@$parish1['lr_name'].' '.@$fieldValues['UK-FCL-00096_0'].' '. @$pc1;?>
