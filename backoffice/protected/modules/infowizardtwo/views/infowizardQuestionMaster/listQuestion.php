...
<div class='portlet-title'>
    <div class='caption'>
        <i style=" font-size:20px;" class='fa fa-list'></i>List of Question</div>
    <div class='tools'> </div>
</div>
          ...
          <table class="table table-striped table-bordered table-hover" id="sample_2" >
            ...
            <?php
              if(empty($apps)){
                ...
                <td>
	<a href="<?php echo Yii::app()->createAbsoluteUrl('infowizard/infowizardQuestionMaster/listView/id/'.$apps['question_id'].'')?>" >View </a> |
    <a href="<?php echo Yii::app()->createAbsoluteUrl('infowizard/infowizardQuestionMaster/update/id/'.$apps['question_id'].'')?>" >Edit </a> 
                </td>
