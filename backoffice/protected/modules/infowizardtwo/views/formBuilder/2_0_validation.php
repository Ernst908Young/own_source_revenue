...
$(document).ready(function(){
	/*	alert(<1?= @$fieldValues['UK-FCL-00060_0'] ?>);*/
	//$("div.back").hide(); 
...
/*$("#").bind("keypress",function(){
	...
	$("#input_UK-FCL-00073_0").append("<div class='col-md-12' style='margin-top:10px;color:orange;'>(You must be 18 years or over to submit this form. You are required to upload a photo of the ID in the documents upload page following submission of this Form.)</div>");
    ...
    $("#input_UK-FCL-00068_0").append("<div class='col-md-12' style='margin-top:10px;'><input type='checkbox' id='checkbox_UK-FCL-00068_0' name='checkbox_UK-FCL-00068_0'> I do not have a Former Christian name</div>");
	
	$('#checkbox_UK-FCL-00068_0').change(function(){
        if($('#checkbox_UK-FCL-00068_0:checked').length){
            $('#UK-FCL-00068_0').attr('readonly',true); //If checked - Read only
        }else{
            $('#UK-FCL-00068_0').attr('readonly',false);//Not Checked - Normal
        }
    });

    $("#input_UK-FCL-00069_0").append("<div class='col-md-12' style='margin-top:10px;'><input type='checkbox' id='checkbox_UK-FCL-00069_0' name='checkbox_UK-FCL-00069_0'> I do not have a Former Surname</div>");
	
	$('#checkbox_UK-FCL-00069_0').change(function(){
        if($('#checkbox_UK-FCL-00069_0:checked').length){
            $('#UK-FCL-00069_0').attr('readonly',true); //If checked - Read only
        }else{
            $('#UK-FCL-00069_0').attr('readonly',false);//Not Checked - Normal
        }
    });
	...
	$("#UK-FCL-00059_0").on('change', function() {     
        ...
        $.ajax({
            ...
            success: function(result) {
               ...
               <?php if (isset($_GET['subID']) || (isset($_GET['app_Sub_id']))) { ?>
                	$("#UK-FCL-00060_0").val("<?php echo @$fieldValues['UK-FCL-00060_0']; ?>");
					$("#UK-FCL-00060_0").select2("val", "<?php echo @$fieldValues['UK-FCL-00060_0']; ?>");
	...
	$("#UK-FCL-00079_0").on('change', function() {
        var countryCode = $(this).val();
	        if(countryCode==829){
	        	$("#UK-FCL-00081_0").val('');
	        	$("#UK-FCL-00081_0").attr('readonly',true);
	        }else{
	        	$("#UK-FCL-00081_0").attr('readonly',false);
	        }
	...
	$("#UK-FCL-00060_0").on("change",function(){
		$("#UK-FCL-00061_0").val("").trigger("change");
		if($(this).val()){
			$.ajax({
				type: "POST",
				dataType:'html',
				...
				success: function(result) {	         		            		
					...
					<?php if (isset($_GET['subID']) || (isset($_GET['app_Sub_id']))) { ?>
                	$("#UK-FCL-00061_0").val("<?php echo @$fieldValues['UK-FCL-00061_0']; ?>");
					$("#UK-FCL-00061_0").select2("val", "<?php echo @$fieldValues['UK-FCL-00061_0']; ?>");
					$("#UK-FCL-00061_0").change();
                	<?php } ?>
				}
			});
		}	
	...
	$("#UK-FCL-00044_0").on('change',function(){
		...
		$("#title_UK-FCL-00332_0").hide();
		$("#hr_UK-FCL-00332_0").hide();
		$("#title_UK-FCL-00247_0").hide();
		$("#hr_UK-FCL-00247_0").hide();
		$("#div_UK-FCL-00246_0").hide();
		$("#div_UK-FCL-00084_0").hide();
		$("#div_UK-FCL-00085_0").hide();
		$("#div_UK-FCL-00332_0").hide();
		...
		if(id==1){
			...
			$("#UK-FCL-00330_0").attr('readonly',true);
			$("#div_UK-FCL-00325_0").hide();
			$("#div_UK-FCL-00326_0").hide();
	...
	$("#UK-FCL-00032_0").on('change',function(){
		...
		$("#UK-FCL-00015_0, #UK-FCL-00016_0, #UK-FCL-00017_0").val("");
	...
	$("#UK-FCL-00015_0,#UK-FCL-00016_0,#UK-FCL-00017_0,#UK-FCL-00046_0,#UK-FCL-00047_0,#UK-FCL-00048_0,#UK-FCL-00056_0").keypress(function(e){
		...
		{
			var id = $(this).attr('id');
			$("#div_"+id).append("<div id="+id+"'-error' class='form-control-feedback-error proposedName' style='color:red; margin-left:1em;'>Only following special characters are allowed in proposed name (),.&:;-</div>");			
			e.preventDefault();		
		}	
	});
	...
	<?php if(isset($_GET['app_Sub_id']) && !empty($_GET['app_Sub_id'])) { ?>
		...
		$("#UK-FCL-00492_0").change();
		$("#UK-FCL-00028_0").change();

		var ff00032_0 = $("#UK-FCL-00032_0").val();
...
// $("#div_UK-FCL-00076_0").append("<span style='color:red;padding-left:16px;' class='errorDetail'></span>");  
  const email = $("#UK-FCL-00076_0").val();  
	  if (validateEmail(email)) { 
	     return true;
	  } else {
	  	$("#input_UK-FCL-00076_0").append("<div class='form-control-feedback-addmore'>Invalid Email Format</div>");
...
function addmorebtncheckindival(){
	var nofapp = $("#UK-FCL-00063_0").val();
	var totalRowCount = 0;          
...
function addmorebtncheckpcd(){
	var nofapp = $("#UK-FCL-00246_0").val();
	var totalRowCount = 0;          
      totalRowCount =  $("#tbl_580 td").closest("tr").length;
	if(nofapp<=totalRowCount){		
...
function addmoreaction(id,service_id,div_id){
	...
	if(div_id==95){
		var respon = addmorebtncheckindival();
		if(respon==false){
			return false;
		}
	}
	if(div_id==580){
		var respon = addmorebtncheckpcd();
		if(respon==false){
			return false;
		}
	}
