...
<div id="div_<?php echo $tablefieldname;?>" class='pcr'>
	...
	<label for="" label="label_<?php echo $tablefieldname;?>" id="label_<?php echo $tablefieldname;?>">
	...
	<div id="input_<?php echo $tablefieldname;?>">
		...
		$checked = '';
			...
			echo " ";
			echo $val_cls; ?>" labelname="<?php echo $ln; ?>" <?= $checked ?> <?php echo $rcreq ?> >&nbsp;
