...
function getcomapnyname(srn_no){
	if(srn_no!=""){
				$.ajax({
		            type: "POST",
		            dataType:'json',
		            url: "/backoffice/infowizardtwo/subFormArticlesOfContinuanceForm13/getCompanyNameBySrnNo/srn_no/" + srn_no +"/subID/<?= isset($_GET['subID']) ? $_GET['subID'] : NULL ?>",
		            beforeSend:function(){
...
$("#UK-FCL-00197_0,#UK-FCL-00548_0").prop('readonly',true);	
   ...
   var ff00114 = $('input[name=UK-FCL-00230_0]:checked').val();
	if(ff00114 =='Yes'){
		...
		if($('.chk_UK-FCL-00231_0 ')[1].checked){
	...
	//2000 Charactor Validation
	  ...
	  var maxchars_3 = 4000;
		$('#UK-FCL-00232_0').keyup(function () {
		    ...
		    $(".char_validation_1").remove();
		    if(remain == 0){
		      $("#UK-FCL-00232_0-error").parent('div').append("<div style='color:red;'  class='form-control-feedback-error char_validation_1'>In case the text exceeds 4000 characters, please attach a schedule in prescribed format to this Form under document listing tab at the end.</div>");
		      return false;
		    }
		});
	...
	// $("#UK-FCL-00133_0").attr('readonly',false);
	  ...
	  var ff519 = $("#UK-FCL-00519_0").val();
	if(ff519){
	  //alert(ff416)
	  //hideonchange();
	  manupulatefields(ff519); 
	}

	$("#UK-FCL-00519_0").on("change",function(){
	  if($(this).val()){
	...
	function manupulatefields(ff519){
	     var myarr = ff519.toString().split(",");	    
	 
	   if (myarr.includes('Others')) {
	      one_show();
	    }else{
	       one_hide();
	    }	 
	...
	function one_show(){
	    $("#div_UK-FCL-00283_0").show();
	}
	function one_hide(){
	    $("#div_UK-FCL-00283_0").hide();
	}

	  $("#div_UK-FCL-00283_0").hide();

	  //$(".chk_UK-FCL-00519_0").prop( "checked", true );



	  var checkboxchecked = $(".chk_UK-FCL-00519_0")[0].checked = true;
	 // var checkboxchecked = $(".chk_UK-FCL-00519_0")[0].disabled = true;
	 ...
	 if($('.chk_UK-FCL-00519_0 ')[1].checked){
	 	$("#div_UK-FCL-00283_0").show();
	 }else{
	 	 $("#div_UK-FCL-00283_0").hide();
	 }
	  ...
	  $(".chk_UK-FCL-00519_0").on("change",function(){
...
$('#UK-FCL-00308_0,#UK-FCL-00309_0,#UK-FCL-00310_0,#UK-FCL-00150_0').keyup(function(){
...
$('#UK-FCL-00104_0,#UK-FCL-00335_0,#UK-FCL-00336_0, #UK-FCL-00401_0, #UK-FCL-00351_0, #UK-FCL-00093_0, #UK-FCL-00309_0, #UK-FCL-00310_0, #UK-FCL-00094_0').keyup(function(){
        $(this).val($(this).val().toUpperCase());
    });
	
	$('#UK-FCL-00397_0,#UK-FCL-00466_0,#UK-FCL-00398_0, #UK-FCL-00468_0, #UK-FCL-00238_0, #UK-FCL-00382_0, #UK-FCL-00383_0,#UK-FCL-00133_0,#UK-FCL-00169_0,#UK-FCL-00353_0,#UK-FCL-00242_0').keyup(function(){
        $(this).val($(this).val().toUpperCase());
    });

	$("<div class='row'><div class='col-lg-12'><strong>Mailing address of the society:</strong></div></div><br>").insertBefore("#div_UK-FCL-00093_0");
  ...
  //$("#UK-FCL-00362_0 option[value='']").attr("disabled","disabled");
...
$("#UK-FCL-00399_0").attr('readonly',true);
  ...
  $("#UK-FCL-00548_0").on("change", function() {
       $("#UK-FCL-00548_0-error").empty();
       $("#div_UK-FCL-00548_0").removeClass("has-error");
  })
   $("#UK-FCL-00513_0").on("change", function() {
       $("#UK-FCL-00513_0-error").empty();
       $("#div_UK-FCL-00513_0").removeClass("has-error");
  })

     $("#UK-FCL-00228_0").on("change", function() {
       $("#UK-FCL-00228_0-error").empty();
       $("#div_UK-FCL-00228_0").removeClass("has-error");
  })
       ...
       $("#UK-FCL-00362_0-error").empty();
       $("#div_UK-FCL-00362_0").removeClass("has-error");
  })
       $("#UK-FCL-00337_0").on("change", function() {
       $("#UK-FCL-00337_0-error").empty();
       $("#div_UK-FCL-00337_0").removeClass("has-error");
  })
  ...
  $("#UK-FCL-00401_0").attr('disabled',false);
  ...
  $("#div_UK-FCL-00455_0").hide();
   ...
   $('#div_UK-FCL-00536_0').css({'text-align':'justify'});
...
// $("<div class='row'><div class='col-lg-12'><strong>The classes and maximum number of Quota that the Society is authorised to issue:</strong></div></div><br>").insertAfter("#hr_UK-FCL-00365_0");
   ...
   $("<div class='row'><div class='col-lg-12' id='details_of_society'><strong>The details of the Society’s agent in Barbados:</strong></div></div><br>").insertAfter("#div_UK-FCL-00362_0");
    ...
    $("<div class='col-md-12' id='form2regisaddtitle' style='margin-top:10px;'><strong>The classes and maximum number of Quota that the Society is authorised to issue:</strong></div>").insertBefore("#div_UK-FCL-00367_0");
   ...
   //document.getElementById("#UK-FCL-00362_0").options[0].disabled = true;
   $("#UK-FCL-00362_0").on("change",function(){
		if($(this).val()=='Yes'){
		   ...
		   // $("#div_UK-FCL-00309_0").css('margin-top','4px');
			...
			$("#div_UK-FCL-00150_0").hide();
		   $("#div_UK-FCL-00133_0").hide();
		   $("#div_UK-FCL-00324_0").hide();
		   $("#div_UK-FCL-00169_0").hide();
		   $("#div_UK-FCL-00353_0").hide();
           $("#div_UK-FCL-00399_0").hide();
           $("#div_UK-FCL-00337_0").hide();
           $("#div_UK-FCL-00242_0").hide();
           $("#div_UK-FCL-00320_0").hide();
           $("#div_UK-FCL-00536_0").hide();

		   $("#divmiddlenamecheckboxManager").hide();
		   //$("#middlenamecheckboxManager").css('display','none');
		   $("#details_of_society").css('display','none');
		   $("#title_UK-FCL-00301_0").css('display','none');
           $("#hr_UK-FCL-00301_0").css('display','none');
   ...
   // agent detail validation 
	...
	// Manager1 detail validation 
	$("#div_UK-FCL-00466_0").append("<div class='col-md-12' style='margin-top:10px;' id='divmiddlenamecheckboxManager1'><input type='checkbox' id='middlenamecheckboxManager1' name='middlenamecheckboxmger1' class='group1'> I do not have a middle name or middle initial</div>");
	$("#UK-FCL-00466_0").blur(function(){
		if($(this).val()){
			$("input[name=middlenamecheckboxmger1]").prop('checked', false);	
		}
	});

	$("input[name=middlenamecheckboxmger1]").change(function(){
		if($(this).val()){
			$("#UK-FCL-00466_0").val("");
		}
	});
	...
	$('#middlenamecheckboxManager1').change(function(){

        if($("#middlenamecheckboxManager1").prop('checked') == true){
   ...
   $("#UK-FCL-00384_0").on('change', function() {
	...
	if(countryCode){
		$.ajax({
			...
			var ff00493_0 = $('input[name=UK-FCL-00537_0]:checked').val();
				if(ff00493_0=='Yes'){
					$("#UK-FCL-00129_0").val($("#UK-FCL-00228_0").val()).trigger("change");
				}
				
			}
		});
	}else{
			$("#UK-FCL-00129_0").html("<option>Please select</option>");
		}
	});
 ...
 //validation for not allowed the number and special charector
  ...
  $("#UK-FCL-00229_0").keypress(function(event){
   ...
   var f0493_0 = $('input[name=UK-FCL-00537_0]:checked').val();
  if(f0493_0=='Yes'){
          $("#UK-FCL-00093_0").val($("#UK-FCL-00104_0").val());
          $("#UK-FCL-00309_0").val($("#UK-FCL-00335_0").val());

          $("#UK-FCL-00096_0").val(829).trigger("change");    
          $("#UK-FCL-00129_0").val($("#UK-FCL-00228_0").val()).trigger("change");

          $("#UK-FCL-00310_0").val($("#UK-FCL-00336_0").val());
          $("#UK-FCL-00094_0").val($("#UK-FCL-00401_0").val());  

          $("#UK-FCL-00093_0, #UK-FCL-00309_0, #UK-FCL-00310_0, #UK-FCL-00094_0").prop('readonly',true);

          $("#UK-FCL-00096_0, #UK-FCL-00129_0").prop('disabled',true);

          $("#div_UK-FCL-00310_0").append("<div id='getcontrystate'><input type='hidden' name='UK-FCL-00096_0' value='829'/><input type='hidden' name='UK-FCL-00129_0' value='"+$("#UK-FCL-00228_0").val()+"'/></div>");

  }

  $("input[name=UK-FCL-00537_0]").on("change",function(){ 
        if($(this).val()=='Yes'){
          $("#UK-FCL-00093_0").val($("#UK-FCL-00104_0").val());
          $("#UK-FCL-00309_0").val($("#UK-FCL-00335_0").val());
          ...
          $("#getcontrystate").html("");
          $("#UK-FCL-00096_0, #UK-FCL-00129_0").val("").trigger("change");
          $("#UK-FCL-00093_0, #UK-FCL-00309_0, #UK-FCL-00310_0, #UK-FCL-00094_0").val("");

          $("#UK-FCL-00093_0, #UK-FCL-00309_0, #UK-FCL-00310_0, #UK-FCL-00094_0").prop('readonly',false);
          $("#UK-FCL-00096_0, #UK-FCL-00129_0").prop('disabled',false);
        }
  });
  ///////////
  ...
  // 	  	$("#UK-FCL-00310_0").val($("#UK-FCL-00336_0").val());
  // 	  	$("#UK-FCL-00094_0").val($("#UK-FCL-00401_0").val());	 
  // 	  	$("#UK-FCL-00129_0").val($("#UK-FCL-00228_0 option:selected").val());	

  // 	  	$("#UK-FCL-00093_0, #UK-FCL-00309_0, #UK-FCL-00310_0, #UK-FCL-00096_0,#UK-FCL-00129_0,#UK-FCL-00094_0").prop('readonly',true);

  // 	  	$("#UK-FCL-00096_0, #UK-FCL-00129_0").prop('disabled',true);

  // 	  	$("#div_UK-FCL-00310_0").append("<div id='getcontrystate'><input type='hidden' name='UK-FCL-00096_0' value='829'/><input type='hidden' name='UK-FCL-00129_0' value='"+$("#UK-FCL-00129_0").val()+"'/></div>");
  // }else{
...
// $("#UK-FCL-00199_0, #UK-FCL-00308_0, #UK-FCL-00107_0, #UK-FCL-00231_0, #UK-FCL-00233_0").keypress(function(e){
// 		var keyCode = e.which;
...
function addmorebtncheckmanagersdetail(){
 ...
 var nofdirecotor = $("#UK-FCL-00234_0").val();
     ...
     var totalRowCount = 0;          
     totalRowCount =  $("#tbl_2541 td").closest("tr").length;
	...
	$("#title_UK-FCL-00234_0").append("<b style='color:red;' class='check_fixed_number'>Sorry if you want to add more Manager  then please update No. of appointed managers.</b>");
		...
		$("#title_UK-FCL-00234_0").append("<b style='color:red;' class='check_number_three'>Please note, that the minimum no. of managers should be three.</b>");
...
function addmorebtnchecksharecapitaldetail(){
	...
	if(nofapp<=totalRowCount){
		...
		var scdem = "Please Add Number of Manager Details as Per Enter No. of 'appointed managers in the Societyas of this date are' Field."; 
						if ($("#scd").length) {
							$("#scd").text(scdem);
		    			}else{
			...
			$.each(data, function (key, item) {
				...
				if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ')) {
					...
					if(mnt){
						...
						var mncb = $('input[name=middlenamecheckboxmger1]:checked').val(); 
						if(mncb){
							var checkfield = true;
						}else{
					...
					var checkfield = true;
							...
							if(formchk_id=='UK-FCL-00397_0' || formchk_id=='UK-FCL-00398_0' || formchk_id=='UK-FCL-00468_0' || formchk_id == 'UK-FCL-00384_0' || formchk_id=='UK-FCL-00372_0'||formchk_id=='UK-FCL-00239_0'||  checkfield == false){
								...
								//alert(formchk_id);
								if(formchk_id=="UK-FCL-00466_0"){
											$("#divmiddlenamecheckboxManager1").append("<div class='form-control-feedback-addmore errorDetail' style='margin-top:10px'>Please enter the required information or select the check box...</div>");
									}else{
										
											$("#input_"+formchk_id).append("<div class='form-control-feedback-addmore errorDetail'>This field is required</div>");
