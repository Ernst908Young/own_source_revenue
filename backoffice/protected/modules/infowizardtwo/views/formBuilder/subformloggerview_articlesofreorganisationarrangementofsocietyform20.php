                ...
                if ($inputType == "text" || $inputType == "number" || $inputType == "password") {
                 ...
                 if ($inputType == "select" || $inputType == "multipleselect") {
                    ...
                    <div class="form-group col-md-6" id="div_<?php echo $tablefieldname; ?>">
                        ...
                        <?php
                        if($tablefieldname=='UK-FCL-00583_0'){
                            $typeodchange = [];
                                  ...
                                  if(is_array($fieldValues['UK-FCL-00583_0'])){
                                    if(!empty($fieldValues['UK-FCL-00583_0'])){
                                      $typeodchange = $fieldValues['UK-FCL-00583_0'];
                                          $comsepstrg = implode(',', $fieldValues[$tablefieldname]);
                                            echo '<input type="hidden" value="'.$comsepstrg.'" id="UK-FCL-00583_0">';
                        ...
                        if (isset($options) && !empty($options)) {
                           ...
                           /* print_r($options); echo "<br><br>"; echo $fd['id']; echo "<br>"; print_r(@$fieldValues[$tablefieldname]);  die();*/
                            ...
                            <div class="col-md-12">
                                ...
                                ?>" 
                                    ...
                                    <?php foreach ($options as $option) { ?>
                                        ...
                                        if ($inputType == "multipleselect") {
                                            if(!empty($fieldValues[$tablefieldname])){
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('select[name="UK-FCL-00349_0"]').append('<option value="<?=InfowizardQuestionMasterExt::getCountryStateNameByID($fieldValues['UK-FCL-00349_0'])?>" selected><?=InfowizardQuestionMasterExt::getCountryStateNameByID($fieldValues['UK-FCL-00349_0'])?></option>');
		
		//form6
		
		var radioForm6 = $('input[name=UK-FCL-00526_0]:checked').val(); 
		if(radioForm6 == 'No'){
			$("#title_UK-FCL-00533_0,#title_UK-FCL-00357_0,#title_UK-FCL-00144_0,#title_UK-FCL-00087_0,#div_UK-FCL-00533_0,#div_UK-FCL-00395_0").hide();
		}else{
		// alert("sd");
			$("#title_UK-FCL-00533_0,#title_UK-FCL-00357_0,#div_UK-FCL-00144_0,#title_UK-FCL-00087_0,#div_UK-FCL-00533_0,#div_UK-FCL-00395_0").show();
		}
		
		
       // alert("ddasfasd");
		var radioForm3 = $('input[name=UK-FCL-00525_0]:checked').val(); 
		if(radioForm3 == 'No'){
			$("#title_UK-FCL-00533_0,#div_UK-FCL-00012_0,#form2regisaddtitle,#div_UK-FCL-00340_0,#div_UK-FCL-00341_0,#div_UK-FCL-00346_0,#div_UK-FCL-00345_0,#div_UK-FCL-00347_0   ,#form2mailaddtitle,#div_UK-FCL-00342_0,#div_UK-FCL-00343_0,#div_UK-FCL-00350_0,#div_UK-FCL-00351_0,#div_UK-FCL-00349_0   ,#form2preaddtitle,#div_UK-FCL-00528_0,#div_UK-FCL-00529_0,#div_UK-FCL-00532_0,#div_UK-FCL-00531_0,#div_UK-FCL-00530_0").hide();
		}else{
			// alert("sd");
			$("#title_UK-FCL-00533_0,#div_UK-FCL-00012_0,#form2regisaddtitle,#div_UK-FCL-00340_0,#div_UK-FCL-00341_0,#div_UK-FCL-00346_0,#div_UK-FCL-00345_0,#div_UK-FCL-00347_0   ,#form2mailaddtitle,#div_UK-FCL-00342_0,#div_UK-FCL-00343_0,#div_UK-FCL-00350_0,#div_UK-FCL-00351_0,#div_UK-FCL-00349_0   ,#form2preaddtitle,#div_UK-FCL-00528_0,#div_UK-FCL-00529_0,#div_UK-FCL-00532_0,#div_UK-FCL-00531_0,#div_UK-FCL-00530_0").show();
		}
	
	
         $('#div_UK-FCL-00357_0,#div_UK-FCL-00372_0').hide();
        ...
        // alert(form4);
            if(form9=='Notice of Change (Appointment of Managers(s))'){
                ...
                $('#title_UK-FCL-00357_0').hide();

                // $(result.cessation_table).appendTo($('#tbl_3190')); 
            }
            if(form9=='Notice of Change (Cessation of Managers(s))'){
                $("#div_UK-FCL-00395_0").show();
                hideappoint();
                showcess(); 
                showpresent();
            ...
            if(form9=='Notice of Change (Appointment and Cessation of Managers(s))'){
                $("#div_UK-FCL-00395_0").show();
                showappoint(); 
                showcess();
                showpresent(); 
        ...
        function showappoint(){
           ...
           function hideappoint(){
            ...
            function showpresent(){
                $("#title_UK-FCL-00172_0").closest("div.form-pasrt").show();
            } 
        ...
        <?php
            $cessation='<h4 class="form-heading">CESSATION DETAILS</h4><table class="table table-striped table-bordered table-hover responsive-table"><thead><tr class="add_more_4577"><th><b class="ukfcl"  title="3843"> </b>First Name</th><th><b class="ukfcl"  title="3843"> </b>Middle Name</th><th><b class="ukfcl"  title="3843"> </b>Surname  </th><th><b class="ukfcl"  title="3843"> </b>Address Line 1  </th><th><b class="ukfcl"  title="3843"> </b>Address Line 2 </th><th><b class="ukfcl"  title="3843"> </b>Country </th><th><b class="ukfcl"  title="3843"> </b>State/Parish </th><th><b class="ukfcl"  title="3843"> </b>City</th><th><b class="ukfcl"  title="3843"> </b>Postal Code </th><th><b class="ukfcl"  title="3843"> </b>Occupation</th></tr></thead><tbody>';              
                    
                    if(isset($fieldValues['UK-FCL-00397_0']) && is_array($fieldValues['UK-FCL-00397_0'])){
                        foreach ($fieldValues['UK-FCL-00397_0'] as $key => $val) {
                            $cessation.='<tr ><td><input type="text" class="form-control" readonly value="'.@$fieldValues['UK-FCL-00397_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00466_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00398_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00468_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00238_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00384_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00372_0'][$key].'"  class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00382_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00383_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00239_0'][$key].'" class="form-control"></td></tr>';
                        }
                    }
                    $cessation.=' </tbody> <table>';

        ?>
            var cessation='<?=$cessation?>';
            $("#title_UK-FCL-00357_0").empty().append(cessation);
         
         //present

         <?php
            $present='<h4 class="form-heading">PRESENT DETAILS</h4><table class="table table-striped table-bordered table-hover responsive-table"><thead><tr class="add_more_4577"><th><b class="ukfcl"  title="3843"> </b>First Name</th><th><b class="ukfcl"  title="3843"> </b>Middle Name</th><th><b class="ukfcl"  title="3843"> </b>Surname  </th><th><b class="ukfcl"  title="3843"> </b>Address Line 1  </th><th><b class="ukfcl"  title="3843"> </b>Address Line 2 </th><th><b class="ukfcl"  title="3843"> </b>Country </th><th><b class="ukfcl"  title="3843"> </b>State/Parish </th><th><b class="ukfcl"  title="3843"> </b>City</th><th><b class="ukfcl"  title="3843"> </b>Postal Code </th><th><b class="ukfcl"  title="3843"> </b>Occupation</th></tr></thead><tbody>';              
                    
                    if(isset($fieldValues['UK-FCL-00397_0']) && is_array($fieldValues['UK-FCL-00397_0'])){
                        foreach ($fieldValues['UK-FCL-00397_0'] as $key => $val) {
                            $present.='<tr ><td><input type="text" class="form-control" readonly value="'.@$fieldValues['UK-FCL-00397_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00466_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00398_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00468_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00238_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00384_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00372_0'][$key].'"  class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00382_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00383_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00239_0'][$key].'" class="form-control"></td></tr>';
                        }
                    }
                     if(isset($fieldValues['UK-FCL-00150_0']) && is_array($fieldValues['UK-FCL-00150_0'])){
                        foreach ($fieldValues['UK-FCL-00150_0'] as $key => $val) {
                            $present.='<tr ><td><input type="text" class="form-control" readonly value="'.@$fieldValues['UK-FCL-00150_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00133_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00134_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00107_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00335_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00320_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00129_0'][$key].'"  class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00354_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00338_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00137_0'][$key].'" class="form-control"></td></tr>';
                        }
                    }
                    $present.=' </tbody> <table>';
        ...
        ?>
            var present='<?=$present?>';
            $("#title_UK-FCL-00144_0").empty().append(present);
    ...
    $("#middlenamecheckbox00105_0").attr("disabled", true);
