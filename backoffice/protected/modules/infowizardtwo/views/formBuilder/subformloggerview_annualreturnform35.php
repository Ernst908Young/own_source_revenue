                ...
                if ($inputType == "text" || $inputType == "number" || $inputType == "password") {
                 ...
                 if ($inputType == "select" || $inputType == "multipleselect") {
                    ...
                    <div class="form-group col-md-6" id="div_<?php echo $tablefieldname; ?>">
                        ...
                        <?php
                        if($tablefieldname=='UK-FCL-00501_0'){
                            $typeodchange = [];
                                    ...
                                    if(!empty($fieldValues['UK-FCL-00501_0'])){
                                      $typeodchange = $fieldValues['UK-FCL-00501_0'];
                                          $comsepstrg = implode(',', $fieldValues[$tablefieldname]);
                                            echo '<input type="hidden" value="'.$comsepstrg.'" id="UK-FCL-00501_0">';
...
<script type="text/javascript">
    $(document).ready(function () {
        console.log('<?=$fieldValues['UK-FCL-00556_0']?>');
        $('#UK-FCL-00556_0').append('<option value="<?=$fieldValues['UK-FCL-00556_0']?>" selected><?=$fieldValues['UK-FCL-00556_0']?></option>');
    ...
    //$( "#UK-FCL-00556_0 option:selected" ).text();
