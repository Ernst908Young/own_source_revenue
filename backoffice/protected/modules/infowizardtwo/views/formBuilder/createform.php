    ...
    <div class="col-md-2">
      <div class="actions">
        <a class="btn btn-primary" href="javascript:void(0);" id="AddMore">
          <i class="fa fa-floppy-o"></i> Save Sub Form Data for Service ID :  <?php echo @$serviceID; ?> 
        </a>
      </div>
...
<br>
  ...
  <div class='row'>
      <div class="col-md-12" style="margin-bottom:10px;">
        <a href="<?php echo Yii::app()->request->baseUrl; ?>/infowizard/formBuilder/subform/service_id/<?php echo $_GET['service_id']; ?>/pageID/<?php echo @$currentPageID; ?>/formCodeID/<?php echo $_GET['formCodeID'];?>" style="color:#fff;" class="pull-right btn btn-success">
      <b>Generate Form 
        <i class="fa fa-magic">
        </i>
      </b> 
...
<div class='portlet-title'>
  <div class='caption'>
    <i style=" font-size:20px;" class='fa fa-database'>
    </i> Added Pages,Category & Inputs
  </div>
        ...
        <div class="site-min-height">
          <div class="form form-horizontal" role="form">
            ...
            <tr>
              ...
              <td>
                <?php if($fd['is_with_caf']=="Y"){echo "Yes";}else{echo "No";} ?>
              </td>
              <td>
  ...
  <script>
    $(function () {
		$(document).on('blur', '.setAddMorePref', function(){
			...
			$.ajax({
				type: "GET",
				url: "/backoffice/infowizard/formBuilder/formFieldPriorityAddmore/pref/"+pref+"/id/"+id,
    ...
    $(document).ready(function(){
      $('.typeahead').typeahead({
        ...
        source: function (query, process) {
          return $.getJSON('/backoffice/infowizard/FormFieldMaster/getMasterList', {
            query: query }
                           , function(data) {
            process(data)
          })
...
$(".pref").on("blur",function(){
	...
	$.ajax({
		type: "GET",
		url: "/backoffice/infowizard/formBuilder/formFieldPriority/pref/"+pref+"/id/"+id,
		success: function (result) {
			$(".pref_"+id).html(pref+": ");
		}
	});
