...
$("#UK-FCL-00480_0").change(function(){
    ...
    $('#UK-FCL-00092_0, #UK-FCL-00504_0, #UK-FCL-00339_0, #UK-FCL-00233_0').keyup(function(){
...
$("#label_UK-FCL-00095_0, #label_UK-FCL-00263_0, #label_UK-FCL-00264_0, #label_UK-FCL-00113_0").find('b').after('<span style="color:red;"> * </span>');
	...
	// Director details
$("#label_UK-FCL-00132_0, #label_UK-FCL-00134_0, #label_UK-FCL-00093_0,#label_UK-FCL-00372_0,  #label_UK-FCL-00096_0, #label_UK-FCL-00137_0, #label_UK-FCL-00481_0").find('b').after('<span style="color:red;"> * </span>');
...
//
	...
	$("input[name=UK-FCL-00123_0]").on("change",function(){		
	    if($(this).val()=='Public Company'){
			...
			$(".chk_UK-FCL-00233_0 ").prop('checked', false);
		...
		if($(this).val()=='No'){
			var citcporp = $('input[name=UK-FCL-00123_0]:checked').val();
				if(citcporp =='Private Company'){
					...
					$("#div_UK-FCL-00233_0").hide();
					$("input[name=UK-FCL-00233_0]").prop('checked', false);
					$("#div_UK-FCL-00126_0").hide();
					$("#UK-FCL-00126_0").val("");
				}			
		}else{
...
//document.getElementById("UK-FCL-00116_0").maxLength = "4000";
   ...
   /* $("#UK-FCL-00339_0").keypress(function(){
		if($(this).val().length>=4000){
			return false;			       	
		}
   }); */
...
// 
	...
	$("#UK-FCL-00262_0").on("change",function(){
		...
		if($(this).val()){
			if($(this).val()=='01'){
				$("#UK-FCL-00095_0").select2('val', "Common shares")
				$("#UK-FCL-00095_0").prop("disabled", true);
				
				$("#UK-FCL-00265_0").select2('val', "No");
				$("#UK-FCL-00265_0").prop("disabled", true);
				
				$("#div_UK-FCL-00266_0").prop("readonly", true);
	...
	$("#UK-FCL-00265_0").on("change",function(){	 
	// alert($(this).val());
		if($(this).val() == "Yes"){
			$("#UK-FCL-00266_0").attr("readonly",false);
		}else{    	
	    	$("#UK-FCL-00266_0").val("");
	       $("#UK-FCL-00266_0").attr("readonly",true);
...
function getcomapnyname(srn_no){
	if(srn_no!=""){
				$.ajax({
		            type: "POST",
		            dataType:'json',
		            url: "/backoffice/infowizardtwo/subFormArticlesOfContinuanceForm17/getCompanyNameBySrnNo/srn_no/" + srn_no +"/subID/<?= isset($_GET['subID']) ? $_GET['subID'] : NULL ?>",
		            beforeSend:function(){
...
function addmorebtncheckdirector(){
	var nofapp = $("#UK-FCL-00131_0").val();
	 var totalRowCount = 0;          
      totalRowCount =  $("#tbl_2603 td").closest("tr").length;
...
function addmorebtnchecksharecapitaldetail(){
	...
	// alert(nofapp);
	var totalRowCount = 0;          
      totalRowCount =  $("#tbl_4075 td").closest("tr").length;
	if(nofapp<=totalRowCount){
