...
// end director detail
   $("#UK-FCL-00096_0").on('change', function() {
	...
	$("#UK-FCL-00403_0").on("blur",function(){
		...
		if(reg_no!=""){
				$.ajax({
		            type: "POST",
		            dataType:'json',
		            url: "/backoffice/infowizardtwo/SubFormPowerofAttorney/getCompanyNameBySrnNo/reg_no/" + reg_no,
		            beforeSend:function(){
		            ...
		            success: function(result) {		            	
		            	if(result.status==true){
		            		if(result.app_status=='valid'){
								...
								$("#UK-FCL-00412_0").prop('readonly',true);
		            		}else{
	...
	$('#UK-FCL-00132_0, #UK-FCL-00105_0, #UK-FCL-00106_0, #UK-FCL-00093_0, #UK-FCL-00309_0, #UK-FCL-00310_0').keyup(function(){
