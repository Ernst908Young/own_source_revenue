<script type="text/javascript">
   $(document).ready(function() {
       ...
       $("#UK-FCL-00582_0").attr('readonly', true);
       $("#UK-FCL-00347_0").prop('readonly',true); 
       $("#UK-FCL-00347_0").val("BARBADOS");
       $("<div class='col-md-12' id='div_UK-FCL-00340_0' style='margin-top:10px;'><strong>Full address of registered office if incorporated under the laws of Barbados:</strong></div>").insertBefore("#div_UK-FCL-00340_0");
   
       $("<div class='col-md-12' id='div_UK-FCL-00570_0' style='margin-top:10px;'><strong>Full address of registered or principal office if incorporated other than under the laws of Barbados:</strong></div>").insertBefore("#div_UK-FCL-00570_0");
       $("<div class='col-md-12' id='div_UK-FCL-00132_0' style='margin-top:10px;'><strong>The directors of the company are:</strong></div>").insertBefore("#div_UK-FCL-00132_0");
      
       $('#UK-FCL-00341_0,#UK-FCL-00344_0,#UK-FCL-00346_0,#UK-FCL-00317_0,#UK-FCL-00093_0,#UK-FCL-00309_0,#UK-FCL-00310_0,#UK-FCL-00094_0,#UK-FCL-00132_0, #UK-FCL-00340_0,#UK-FCL-00105_0, #UK-FCL-00106_0, #UK-FCL-00238_0, #UK-FCL-00310_0, #UK-FCL-00570_0, #UK-FCL-00571_0,#UK-FCL-00572_0, #UK-FCL-00574_0').keyup(function(){
       ...
       $("#UK-FCL-00403_0").on("blur", function() {
           ...
           $.ajax({
               type: "POST",
               dataType: 'json',
               url: "/backoffice/infowizardtwo/subFormApplicationToRestoreNameToTheRegisterForm32/getcompanyNameByregno/reg_no/" + reg_no,
               beforeSend: function() {
               ...
               success: function(result) {
                   if(result.status == true) {
                       ...
                       $("#UK-FCL-00582_0").val(result.cdate);
       ...
       $("#UK-FCL-00582_0").on("change", function() {
            $("#UK-FCL-00582_0-error").empty();
            $("#div_UK-FCL-00582_0").removeClass("has-error");
       })
        ...
        $("#UK-FCL-00575_0").on("change", function() {
            $("#UK-FCL-00575_0-error").empty();
            $("#div_UK-FCL-00575_0").removeClass("has-error");
       })
        $("#UK-FCL-00583_0").on("change", function() {
            $("#UK-FCL-00583_0-error").empty();
            $("#div_UK-FCL-00583_0").removeClass("has-error");
       })
       ...
       $("input[name=middlenamecheckbox]").change(function() {
        ...
        $("#UK-FCL-00575_0").on('change', function() {
           ...
           if(countryCode==829){
                ...
                $("#UK-FCL-00572_0").attr('readonly',false);
            }    
        $("#UK-FCL-00584_0").select2("val","");
           $.ajax({
               type: "POST",
               url: "/backoffice/iloc/property/getStateByCountryID/countryCode/" + countryCode,
               success: function(result) {
                  $("#UK-FCL-00584_0").html(result);
               ...
               success: function (data) {
                   ...
                   $.each(data, function (key, item) {
                       ...
                       if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ' || vall.length==0)) {
                           ...
                           if(div_id=='3057' && (formchk_id=='UK-FCL-00132_0' || checkfield==false || formchk_id=='UK-FCL-00106_0' || formchk_id=='UK-FCL-00093_0' || formchk_id=='UK-FCL-00096_0' || formchk_id=='UK-FCL-00129_0'  || formchk_id=='UK-FCL-00137_0')){                             
