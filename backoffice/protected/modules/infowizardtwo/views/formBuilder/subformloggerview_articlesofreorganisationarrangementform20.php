                ...
                if ($inputType == "text" || $inputType == "number" || $inputType == "password") {
                 ...
                 if ($inputType == "select" || $inputType == "multipleselect") {
                    ...
                    <div class="form-group col-md-6" id="div_<?php echo $tablefieldname; ?>">
                        ...
                        <?php
                        if($tablefieldname=='UK-FCL-00673_0'){
                            $typeodchange = [];
                                    ...
                                    if(!empty($fieldValues['UK-FCL-00673_0'])){
                                      $typeodchange = $fieldValues['UK-FCL-00673_0'];
                                          $comsepstrg = implode(',', $fieldValues[$tablefieldname]);
                                            echo '<input type="hidden" value="'.$comsepstrg.'" id="UK-FCL-00673_0">';
...
<script type="text/javascript">
	...
	//form9 
	var radioForm9 = $('input[name=UK-FCL-00547_0]:checked').val(); 
		if(radioForm9 == 'No'){
		$("#title_UK-FCL-00033_0,#title_UK-FCL-00087_0,#title_UK-FCL-00400_0,#div_UK-FCL-00400_0,#div_UK-FCL-00533_0,#div_UK-FCL-00395_0,#title_UK-FCL-00533_0").hide();
	}else{
		// alert("sd");
		$("#title_UK-FCL-00033_0,#title_UK-FCL-00087_0,#div_UK-FCL-00533_0,#div_UK-FCL-00395_0,#title_UK-FCL-00533_0").show();
	}
	
	var radioForm4 = $('input[name=UK-FCL-00546_0]:checked').val(); 
	// alert(radioForm4);
	if(radioForm4 == 'No'){
		$("#title_UK-FCL-00012_0,#div_UK-FCL-00012_0,#form2regisaddtitle,#div_UK-FCL-00340_0,#div_UK-FCL-00341_0,#div_UK-FCL-00346_0,#div_UK-FCL-00345_0,#div_UK-FCL-00347_0   ,#form2mailaddtitle,#div_UK-FCL-00342_0,#div_UK-FCL-00343_0,#div_UK-FCL-00350_0,#div_UK-FCL-00351_0,#div_UK-FCL-00349_0   ,#form2preaddtitle,#div_UK-FCL-00528_0,#div_UK-FCL-00529_0,#div_UK-FCL-00532_0,#div_UK-FCL-00531_0,#div_UK-FCL-00530_0").hide();
	}else{
		// alert("sd");
   ...
   function showappoint(){
        ...
        $("#title_UK-FCL-00033_0").closest("div.form-part").show();
    } 
   function hideappoint(){
  
    $("#title_UK-FCL-00033_0").closest("div.form-part").hide();
    } 
    function showcess(){
		// alert("cess");
    ...
    ?>
        ...
        $("#title_UK-FCL-00087_0").empty().append(cessation);
...
?>
    var present='<?=$present?>';
    $("#title_UK-FCL-00400_0").empty().append(present);
