        ...
        if (!in_array($fd['id'], $sfArray)) {
            ...
            if (!in_array($fd['id'], $btnArray)) {  //IF IN ARRAY START
                ...
                if ($inputType == "text" || $inputType == "number" || $inputType == "password") {
                    if($tablefieldname=='UK-FCL-00162_0' && isset($fieldValues['UK-FCL-00110_0'])){ ?>
                         <div class="form-group col-md-12">
<table class="table table-striped table-bordered table-hover responsive-table addmore_tbl  tbl_investordetail" id="forest_table" style="">
                            <tbody>
                        <tr>
                            <th>Name of the person </th>
                            <th>Whether the clause applicable or not</th>
                            <th>Details of office held</th>
                         ...
                         <?php for ($i=0; $i < count($fieldValues['UK-FCL-00110_0']) ; $i++) { ?>
                            <tr>
                                <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00110_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00110_0'][$i]?>" readonly=""> 
                              </td>
                               <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00101_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00101_0'][$i]?>" readonly=""> 
                              </td>
                               <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00112_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00112_0'][$i]?>" readonly=""> 
                              </td>
                               <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00113_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00113_0'][$i]?>" readonly=""> 
                              </td>
                               <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00114_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00114_0'][$i]?>" readonly=""> 
                              </td>
                               <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00115_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00115_0'][$i]?>" readonly=""> 
                              </td>
                               <td>
                                  <input class="form-control" type="text" value="<?= $fieldValues['UK-FCL-00116_0'][$i]?>" title="<?= $fieldValues['UK-FCL-00116_0'][$i]?>" readonly=""> 
                              </td>
                          </tr>
                         <?php   } ?>
  ...
  @$tablefieldname = InfowizardQuestionMasterExt::getMasterName('bo_infowizard_formvariable_master', $fd['form_field_id'], 'formchk_id', 'formvar_id');
                    ...
                    if(($tablefieldname=='UK-FCL-00390_0' && isset($fieldValues['UK-FCL-00390_0'])) ||
                    $tablefieldname=='UK-FCL-00463_0' && isset($fieldValues['UK-FCL-00463_0']) ||
                    $tablefieldname=='UK-FCL-00465_0' && isset($fieldValues['UK-FCL-00465_0']) ){}else{
                 ...
                 if ($inputType == "select" || $inputType == "multipleselect") {
                    ...
                    if($tablefieldname=='UK-FCL-00464_0' && isset($fieldValues['UK-FCL-00465_0'])){}else{
                    ?>
                    <div class="form-group col-md-6" id="div_<?php echo $tablefieldname; ?>">
                        <label class="col-md-12 control-label text-left" for="" id="label_<?php echo $tablefieldname; ?>">                      
                            <?php
...
<?php 
            ...
            if($tablefieldname == 'UK-FCL-00401_0'){
                if(isset($fieldValues['UK-FCL-00404_0'])){
                    $p_id = $fieldValues['UK-FCL-00404_0'];         
                 ...
                 if($postalcode){               
                    foreach ($postalcode as $key => $value) {
                        $select = $fieldValues['UK-FCL-00401_0']==$value['id'] ? 'selected' : '';
            ...
            if(@$fieldValues['UK-FCL-00372_0'] !='' && $tablefieldname == 'UK-FCL-00402_0'){
            if(isset($fieldValues['UK-FCL-00372_0'])){
                $p_id = $fieldValues['UK-FCL-00372_0'];         
                 $postalcode = Yii::app()->db->createCommand("SELECT * from bo_postalcode_in_barbados where p_id=$p_id")->queryAll();        
                 if($postalcode){               
                    foreach ($postalcode as $key => $value) {
                        $select = $fieldValues['UK-FCL-00402_0']==$value['id'] ? 'selected' : '';
                     echo "<option value='".$value['id']."' $select>".$value['district'].' - '.$value['code']."</option>";
                    }
                 }else{
                    echo "<option>-</option>";
            ...
            if($tablefieldname == 'UK-FCL-00471_0'){            
                if(isset($fieldValues['UK-FCL-00470_0'])){
                    $p_id = $fieldValues['UK-FCL-00470_0'];         
                 $postalcode = Yii::app()->db->createCommand("SELECT * from bo_landregion where parent_id=$p_id")->queryAll();        
                 if($postalcode){               
                    foreach ($postalcode as $key => $value) {
                        $select = $fieldValues['UK-FCL-00471_0']==$value['lr_id'] ? 'selected' : '';
                     echo "<option value='".$value['lr_id']."' $select>".$value['lr_name']."</option>";
                    }
                 }else{
                    echo "<option>-</option>";
                 }
                                        ...
                                        if (is_array($arrofIn) && !in_array($valued['button_id'], $arrofIn)) {
                                            ...
                                            if (isset($allData23[$fcode]) && !empty($allData23[$fcode])) {
                                                 ...
                                                 if($fd['id']==1859){
                                                    ...
                                                    $count_td = count($allData23[$fcode]);
                                                }
