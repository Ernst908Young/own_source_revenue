<script type="text/javascript">
   $(document).ready(function(){
    $("#UK-FCL-00520_0,#UK-FCL-00607_0,#UK-FCL-00612_0,#UK-FCL-00453_0,#UK-FCL-00295_0,#UK-FCL-00382_0,#UK-FCL-00459_0").attr('readonly',true);

     $("#UK-FCL-00453_0,#UK-FCL-00357_0,#UK-FCL-00295_0").val("BARBADOS");
    ...
    function getcomapnyname(srn_no){
        if(srn_no!=""){
                    $.ajax({
                        type: "POST",
                        dataType:'json',
                        url: "/backoffice/infowizardtwo/subFormArticlesofAmalgamationSocietiesForm6B/getCompanyNameBySrnNo/srn_no/" + srn_no +"/subID/<?= isset($_GET['subID']) ? $_GET['subID'] : NULL ?>",
                        beforeSend:function(){
                        ...
                        success: function(result) {                     
                            if(result.status==true){
                                if(result.app_status=='valid'){
                                    $("#UK-FCL-00612_0").val(result.name);
                                    $("#UK-FCL-00360_0-error").html("");
                                    $("#UK-FCL-00612_0-error").html("");    
                                }else{
                                    $("#UK-FCL-00360_0-error").text(result.msg);            
                                    if ($("#UK-FCL-00612_0-error").length) {
                                        $("#UK-FCL-00612_0-error").text(errormessages.srn_msg001);
                                    }else{
                                        $("#div_UK-FCL-00612_0").find('div').append('<div  style="color:red;" id="UK-FCL-00612_0-error">'+errormessages.srn_msg001+'<br>'+errormessages.srn_msg002+'</div>');
                                    }    
    ...
    $("#UK-FCL-00290_0").on("blur",function(){
        var reg_no = $(this).val(); 
                $.ajax({
                    type: "POST",
                    dataType:'json',
                    url: "/backoffice/infowizardtwo/subFormArticlesofAmalgamationSocietiesForm6B/getsocietyNameByregno/reg_no/" + reg_no,
                    beforeSend:function(){
    ...
    $("#UK-FCL-00606_0").on("blur",function(){
        var reg_no = $(this).val(); 
                $.ajax({
                    type: "POST",
                    dataType:'json',
                    url: "/backoffice/infowizardtwo/subFormArticlesofAmalgamationSocietiesForm6B/getsocietyNameByregno/reg_no/" + reg_no,
                    beforeSend:function(){
                        $("#UK-FCL-00606_0-error").text("Please wait...");                      
                    },
                    success: function(result) {                     
                        if(result.status==true){                            
                                $("#UK-FCL-00606_0-error").remove();                 
                                $("#UK-FCL-00607_0").val(result.cname);     
                                                                        
                        }else{
                            $("#UK-FCL-00606_0-error").remove();                 
                             $("#input_UK-FCL-00606_0").append('<div id="UK-FCL-00606_0-error" class="form-control-feedback">'+result.msg+'</div>');
                            $("#UK-FCL-00606_0-error").text(result.msg);                            
                            $("#UK-FCL-00607_0").val("");                       
                        }
                       console.log(result);
                    }
    ...
    var itartbmco = $('input[name=UK-FCL-00611_0]:checked').val();
    if(itartbmco=='Yes'){
        $("#div_UK-FCL-00360_0").show();
         $("#div_UK-FCL-00612_0").show();
    }else{
        $("#div_UK-FCL-00360_0").hide();
        $("#div_UK-FCL-00612_0").hide();
    }

    $("input[name=UK-FCL-00611_0]").on("change",function(){     
        if($(this).val()=='Yes'){
            $("#div_UK-FCL-00360_0").show();
            $("#div_UK-FCL-00612_0").show();
        }else{
    ...
    $("input[name=UK-FCL-00525_0]").change(function(){
        checksubmitbutton();
    }); 

    $("input[name=UK-FCL-00526_0]").change(function(){
        checksubmitbutton();
    }); 
...
$('#UK-FCL-00340_0, #UK-FCL-00341_0, #UK-FCL-00342_0, #UK-FCL-00343_0, #UK-FCL-00350_0, #UK-FCL-00528_0, #UK-FCL-00529_0').keyup(function(){
  ...
  step2HideShow();
   ...
   function step2HideShow(){
        var val12 = $("#UK-FCL-00012_0").val();
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, item) {
                        ...
                        if (cls == 'val' && (vall == '' || vall == 'undefined' || vall == 'Please Select ' || vall.length==0)) {
                            ...
                            if(div_id=='3495' && (checkfield==false || formchk_id=='UK-FCL-00132_0' || formchk_id=='UK-FCL-00106_0' || formchk_id=='UK-FCL-00093_0' || formchk_id=='UK-FCL-00096_0' || formchk_id=='UK-FCL-00129_0'  || formchk_id=='UK-FCL-00137_0')){                             
                           ...
                           else  if(div_id=='3449' && (checkfield2==false || formchk_id=='UK-FCL-00606_0' || formchk_id=='UK-FCL-00607_0')){
                            ...
                            else  if(div_id=='3505' && (checkfield2==false || formchk_id=='UK-FCL-00150_0' || formchk_id=='UK-FCL-00134_0' || formchk_id=='UK-FCL-00107_0' || formchk_id=='UK-FCL-00320_0'|| formchk_id=='UK-FCL-00372_0')){
                               ...
                               if(formdata=='Yes' && formdataval==""){
                                       $("#input_UK-FCL-00490_0").append("<div class='form-control-feedback-addmore'>This field is required</div>");
                               }

                               else if(formchk_id=="UK-FCL-00316_0"){
                                        $("#div_"+formchk_id).append("<div class='form-control-feedback-addmore'>Please enter the required information or select the check box</div>");
                                }
                           ...
                           else  if(div_id=='3516' && (checkfield3==false || formchk_id=='UK-FCL-00172_0' || formchk_id=='UK-FCL-00423_0' ||  formchk_id=='UK-FCL-00169_0' ||  formchk_id=='UK-FCL-00295_0' ||  formchk_id=='UK-FCL-00400_0' ||  formchk_id=='UK-FCL-00461_0')){
...
<script type="text/javascript">
    $(function () {
        $("#middlenamecheckbox00105_0").click(function () {
            var isChecked = $("#middlenamecheckbox00105_0").is(":checked");
            if (isChecked) {
                $('#err00105_0').html('');
        ...
        $(function () {
        $("#middlenamecheckbox00466_0").click(function () {
            var isChecked = $("#middlenamecheckbox00466_0").is(":checked");
            if (isChecked) {
                $('#err00466_0').html('');
               // $("#err00105_0").removeClass("has-error");
            } else {
    ...
    $(function () {
        $("#middlenamecheckbox00316_0").click(function () {
            var isChecked = $("#middlenamecheckbox00316_0").is(":checked");
            if (isChecked) {
                $('#err00316_0').html('');
               // $("#err00105_0").removeClass("has-error");
            } else {
    ...
    $(function () {
        $("#middlenamecheckbox00133_0").click(function () {
            var isChecked = $("#middlenamecheckbox00133_0").is(":checked");
            if (isChecked) {
                    $('#err00133_0').html('');
               // $("#err00105_0").removeClass("has-error");
            } else {
