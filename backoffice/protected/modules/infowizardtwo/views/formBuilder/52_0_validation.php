        ...
        $("#UK-FCL-00849_0").select2("val","");
            $.ajax({
                ...
                success: function(result) {
                    $("#UK-FCL-00849_0").html(result);
                 //   alert("<!-?php echo @$fieldValues['UK-FCL-00849_0']; ?>");
                    <?php if (isset($_GET['subID']) || (isset($_GET['app_Sub_id']) && !empty($_GET['app_Sub_id']))) { ?>
                        $("#UK-FCL-00849_0").val("<?php echo @$fieldValues['UK-FCL-00849_0']; ?>");
                        $("#UK-FCL-00849_0").select2("val", "<?php echo @$fieldValues['UK-FCL-00849_0']; ?>");
                        $("#UK-FCL-00849_0").change();
                    <?php } ?>
                }
        });
     }else{
...
$("#UK-FCL-00849_0").on("change",function(){
...
$(window).on('load',function()
{
 ...
 function changemonth(act, month, year){
        var name_place_id = $("#UK-FCL-00849_0").val();
        if(name_place_id){
            $.ajax({
                type: "POST",
                dataType: 'json',
