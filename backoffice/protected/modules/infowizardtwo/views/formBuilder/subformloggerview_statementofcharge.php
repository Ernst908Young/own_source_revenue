...
<script type="text/javascript">
    ...
    var lasthideshow  = $('input[name=UK-FCL-00682_0]:checked', '#div_UK-FCL-00682_0').val(); 
    ...
    $('select[name="UK-FCL-00129_0"]').append('<option value="<?=InfowizardQuestionMasterExt::getCountryStateNameByID($fieldValues['UK-FCL-00129_0'])?>" selected><?=InfowizardQuestionMasterExt::getCountryStateNameByID($fieldValues['UK-FCL-00129_0'])?></option>');
