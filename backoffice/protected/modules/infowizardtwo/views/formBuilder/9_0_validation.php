...
$(document).ready(function(){
	...
	$("#UK-FCL-00234_0").blur(function(){
		// alert($(this).val());
		if($(this).val()>=3){
			$("#UK-FCL-00234_0-error").text("");				
		}else{
			$("#UK-FCL-00234_0-error").text("Minimum number to be entered is 03 ");
			$("#UK-FCL-00234_0").val("");
		}
	});
...
$('#UK-FCL-00308_0,#UK-FCL-00309_0,#UK-FCL-00310_0').keyup(function(){
 ...
 $("#UK-FCL-00310_0, #UK-FCL-00463_0").attr('readonly',true);
...
$('#UK-FCL-00104_0,#UK-FCL-00335_0,#UK-FCL-00336_0, #UK-FCL-00401_0, #UK-FCL-00351_0').keyup(function(){
 ...
 if($('.chk_UK-FCL-00233_0 ')[1].checked){
  ...
  $("#UK-FCL-00401_0").prop('readonly',true);

//Below 3 line of code fields is on last form Agent details due to old comment we commment this
  //$("#UK-FCL-00374_0").prop('readonly',true);
  $("#div_UK-FCL-00374_0").hide();
  $("#div_UK-FCL-00364_0").hide();
  ...
  $("#div_UK-FCL-00455_0").hide();
   ...
   // share quota details
    $("#label_UK-FCL-00367_0, #label_UK-FCL-00368_0, #label_UK-FCL-00369_0, #label_UK-FCL-00370_0, #label_UK-FCL-00371_0, #label_UK-FCL-00266_0").find('b').after('<span style="color:red;"> * </span>');

    $("#label_UK-FCL-00397_0, #label_UK-FCL-00398_0, #label_UK-FCL-00468_0, #label_UK-FCL-00384_0, #label_UK-FCL-00372_0, #label_UK-FCL-00239_0").find('b').after('<span style="color:red;"> * </span>');
...
var ff00362_0 = $("#UK-FCL-00362_0").val();
if(ff00362_0=='Yes'){
	$("#div_UK-FCL-00301_0, #div_UK-FCL-00105_0, #div_UK-FCL-00324_0, #div_UK-FCL-00363_0, #div_UK-FCL-00320_0, #div_UK-FCL-00107_0, #div_UK-FCL-00457_0, #div_UK-FCL-00463_0, #div_UK-FCL-00404_0, #div_UK-FCL-00455_0").show();
	...
	$("#div_UK-FCL-00301_0, #div_UK-FCL-00105_0, #div_UK-FCL-00324_0, #div_UK-FCL-00363_0, #div_UK-FCL-00320_0, #div_UK-FCL-00107_0, #div_UK-FCL-00457_0, #div_UK-FCL-00463_0, #div_UK-FCL-00404_0, #div_UK-FCL-00455_0").hide();
...
$("#UK-FCL-00199_0, #UK-FCL-00308_0, #UK-FCL-00107_0, #UK-FCL-00232_0").keypress(function(e){
		var keyCode = e.which;
