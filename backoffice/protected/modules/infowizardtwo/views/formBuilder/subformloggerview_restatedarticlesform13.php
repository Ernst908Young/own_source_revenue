                ...
                if ($inputType == "text" || $inputType == "number" || $inputType == "password") {
                 ...
                 if ($inputType == "select" || $inputType == "multipleselect") {
                    ...
                    <div class="form-group col-md-6" id="div_<?php echo $tablefieldname; ?>">
                        ...
                        <?php
                        if($tablefieldname=='UK-FCL-00669_0'){
                            $typeodchange = [];
                                    ...
                                    if(!empty($fieldValues['UK-FCL-00669_0'])){
                                      $typeodchange = $fieldValues['UK-FCL-00669_0'];
                                          $comsepstrg = implode(',', $fieldValues[$tablefieldname]);
                                            echo '<input type="hidden" value="'.$comsepstrg.'" id="UK-FCL-00669_0">';
...
<script type="text/javascript">
    $(document).ready(function () {
        // alert('ddfasdjkfhasdlj');
		other_pro  = $("input:radio[name=UK-FCL-00124_0]:checked").val();
		if(other_pro == "Yes"){
        ...
        let entoty_type  = $("#UK-FCL-00675_0").val();
       
        if(entoty_type=='Company'){
            <?php
            $shareCapital='<h4 class="form-heading">Share Capital/Quota Details</h4><table class="table table-striped table-bordered table-hover responsive-table"><thead><tr class="add_more_4577"><th><b class="ukfcl"  title="3843"> </b>No. of classes of Quota</th><th><b class="ukfcl"  title="3843"> </b>Type of Quota  </th><th><b class="ukfcl"  title="3843"> </b>Name of class of Quota  </th><th><b class="ukfcl"  title="3843"> </b>Maximum no. of Share/Quota </th><th><b class="ukfcl"  title="3843"> </b>Are these Share/Quota redeemable </th><th><b class="ukfcl"  title="3843"> </b>Price/formula for calculation of price </th><th><b class="ukfcl"  title="3843"> </b>Rights & privileges attached to theShare/ Quota</th><th><b class="ukfcl"  title="3843"> </b>Are the shares/Quotas of the Company/Society Transferable </th><th><b class="ukfcl"  title="3843"> </b>Restriction if any on share/Quota transfers</th></tr></thead><tbody>';              
            
            if(isset($fieldValues['UK-FCL-00095_0']) && is_array($fieldValues['UK-FCL-00095_0'])){
                foreach ($fieldValues['UK-FCL-00095_0'] as $key => $val) {
                    $shareCapital.='<tr ><td><input type="text" class="form-control" readonly value="'.@$fieldValues['UK-FCL-00262_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00095_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00263_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00264_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00265_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00266_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00113_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00334_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00116_0'][$key].'" class="form-control"></td></tr>';
                }
            }
            $shareCapital.=' </tbody> <table>';

        ?>
            var shareCapital='<?=$shareCapital?>';
            $("#title_UK-FCL-00033_0").empty().append(shareCapital);
            ...
            <?php
                ...
                $quotadetail='<h4 class="form-heading">Share Capital/Quota Details</h4><table class="table table-striped table-bordered table-hover responsive-table"><thead><tr class="add_more_4577"><th><b class="ukfcl"  title="3843"> </b>No. of classes of Quota</th><th><b class="ukfcl"  title="3843"> </b>Type of Quota  </th><th><b class="ukfcl"  title="3843"> </b>Name of class of Quota  </th><th><b class="ukfcl"  title="3843"> </b>Maximum no. of Share/Quota </th><th><b class="ukfcl"  title="3843"> </b>Are these Share/Quota redeemable </th><th><b class="ukfcl"  title="3843"> </b>Price/formula for calculation of price </th><th><b class="ukfcl"  title="3843"> </b>Rights & privileges attached to theShare/ Quota</th><th><b class="ukfcl"  title="3843"> </b>Are the shares/Quotas of the Company/Society Transferable </th><th><b class="ukfcl"  title="3843"> </b>Restriction if any on share/Quota transfers</th></tr></thead><tbody>';              
        
                if(isset($fieldValues['UK-FCL-00367_0']) && is_array($fieldValues['UK-FCL-00367_0'])){
                    foreach ($fieldValues['UK-FCL-00367_0'] as $key => $val) {
                        $quotadetail.='<tr ><td><input type="text" class="form-control" readonly value="'.@$fieldValues['UK-FCL-00365_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00367_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00368_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00369_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00370_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00266_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00371_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00230_0'][$key].'" class="form-control"></td><td><input type="text" readonly value="'.@$fieldValues['UK-FCL-00377_0'][$key].'" class="form-control"></td></tr>';
                    }
                 }
                 $quotadetail.=' </tbody> <table>';

            ?>
             var quotadetail='<?=$quotadetail?>';
             // console.log(quotadetail);
             $("#title_UK-FCL-00033_0").empty().append(quotadetail);
        }
	...
	function two_show(){
		...
		var reg = $("#UK-FCL-00362_0").val();
		if(reg == 'No'){
			$("#div_UK-FCL-00132_0,#div_UK-FCL-00105_0,#div_UK-FCL-00106_0,#div_UK-FCL-00104_0,#div_UK-FCL-00309_0,#div_UK-FCL-00336_0,#div_UK-FCL-00372_0,#div_UK-FCL-00242_0,#div_UK-FCL-00320_0, #regis").hide();
		}
	}
	...
	function two_hide(){
	   $("#title_UK-FCL-00199_0,#div_UK-FCL-00199_0,#div_UK-FCL-00200_0,#div_UK-FCL-00093_0,#div_UK-FCL-00238_0,#div_UK-FCL-00310_0,#div_UK-FCL-00129_0,#div_UK-FCL-00094_0,#div_UK-FCL-00096_0,#div_UK-FCL-00362_0  ,#div_UK-FCL-00132_0,#div_UK-FCL-00105_0,#div_UK-FCL-00106_0,#div_UK-FCL-00104_0,#div_UK-FCL-00309_0,#div_UK-FCL-00336_0,#div_UK-FCL-00372_0,#div_UK-FCL-00242_0,#div_UK-FCL-00320_0, #regis").hide();
                 ...
                 // let range  = $(".chk_UK-FCL-00240_0 ").val();
                 // if(range=='Fixed Number'){
