...
<?php 
	...
	<div class="portlet box green">
		...
		if (!empty($get_logg)) 
		{
			...
			action="<?php echo Yii::app()->createAbsoluteUrl("/infowizardtwo/subFormArticlesOfReorganisationForm20/processData"); ?>">
...
<script>
    ...
    $(document).ready(function () {
		 ...
		 // alert($("input[type=radio][name=UK-FCL-00546_0]").val());
		...
		$('.btn_view').on('click',function(){
			...
			$.ajax({
				...
				url: "<?php echo Yii::app()->request->baseUrl; ?>/infowizardtwo/formFieldMasterSubFormArticlesOfReorganisationForm20/getFormHtml",
