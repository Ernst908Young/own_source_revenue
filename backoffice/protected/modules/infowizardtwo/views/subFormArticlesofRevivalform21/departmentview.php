...
<?php 
	...
	<div class="portlet box green">
		...
		if(!empty($get_logg))
		{
			...
			action="<?php echo Yii::app()->createAbsoluteUrl("/infowizardtwo/subFormArticlesofRevivalform21/processData"); ?>">
...
<script>
    ...
    $(document).ready(function () {
		...
		$('.btn_view').on('click',function(){
			...
			$.ajax({
				...
				url: "<?php echo Yii::app()->request->baseUrl; ?>/infowizardtwo/formFieldMasterSubFormArticlesofRevivalform21/getFormHtml",
   ...
   $("#div_UK-FCL-00105_0").find("#middlenamecheckbox00105_0").attr("disabled", true);
  /*$("input[name='']")
   alert("hell"); */
