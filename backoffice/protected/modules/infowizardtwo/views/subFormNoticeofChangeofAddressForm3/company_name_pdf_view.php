...
<table style="padding-top: 10px;">
    <tr>
      <td style="text-align:center;">     
        ...
        <span style="font-size: 12;"><strong>NOTICE OF CHANGE OF ADDRESS OF REGISTERED OFFICE</strong></span>  <br><span style="font-size: 12;"><strong>Form 3</strong></span>  
    </td>
     </tr>
</table>
<br><br><br>
 ...
 <?php if(@$fieldValues['UK-FCL-00012_0']!='Change in registered office address'){ ?>
    <tr>
      <td width="5%"> 
        ...
        <td width="95%" style="text-align:justify;"><strong>Mailing Address.</strong><span  style="margin-top:10px;">
				
			<br><br>
				<?php 
       // if($fieldValues['UK-FCL-00012_0']== 'Change in registered office address'){
					...
					if(@$fieldValues['UK-FCL-00372_0']){
					  $parish1 = Yii::app()->db->createCommand("SELECT lr_id,lr_name from bo_landregion where lr_id=".$fieldValues['UK-FCL-00372_0'])->queryRow(); 
					}else{
					  $parish1 = [];
					}
				
					echo @$fieldValues['UK-FCL-00107_0'].' '.@$fieldValues['UK-FCL-00335_0'].' '.@$parish1['lr_name'].' '.$country.' '.@$fieldValues['UK-FCL-00401_0'];
			//	}
        ?>
    ...
    <tr>
      ...
      <td width="95%"><strong>If change of address, give previous address of Registered Office.</strong><br><br><span  style="margin-top:10px;"><?php echo @$fieldValues['UK-FCL-00104_0'].' '.@$fieldValues['UK-FCL-00238_0'].' '.@$fieldValues['UK-FCL-00405_0'].' '.@$fieldValues['UK-FCL-00384_0'].' '.@$fieldValues['UK-FCL-00383_0']; ?>
		</span>
      </td>
    </tr>
  <?php } ?>
