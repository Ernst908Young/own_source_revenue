...
<?php 
	...
	<div class="portlet box green">
		...
		if(!empty($get_logg))
		{
			...
			action="<?php echo Yii::app()->createAbsoluteUrl("/infowizardtwo/subFormArticlesofRevivalform11/processData"); ?>">
...
<script>
    ...
    $(document).ready(function () {
		...
		$('.btn_view').on('click',function(){
			...
			$.ajax({
				...
				url: "<?php echo Yii::app()->request->baseUrl; ?>/infowizardtwo/formFieldMasterArticlesofRevivalform11/getFormHtml",
   ...
   $("#div_UK-FCL-00466_0").find("#middlenamecheckbox00466_0").attr("disabled", true);
</script>
