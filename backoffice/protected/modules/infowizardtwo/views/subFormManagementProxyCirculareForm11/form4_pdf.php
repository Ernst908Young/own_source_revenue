...
?>
    ...
    <tr>
     ...
     // print_r($fieldValues['UK-FCL-00349_0']);die;
...
if(@$fieldValues['UK-FCL-00493_0']){
  if($fieldValues['UK-FCL-00493_0']=='Yes'){
    $mpc = $pc1;
      ...
      echo @$fieldValues['UK-FCL-00342_0'].' '.@$fieldValues['UK-FCL-00343_0'].' '.@$fieldValues['UK-FCL-00348_0'].' '.$mpc.' '. @$fieldValues['UK-FCL-00349_0'].' '.@$country1['lr_name'] ;        
      ?>        
      </td>
    </tr>
