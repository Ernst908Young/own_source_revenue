...
<script type="text/javascript">
  ...
  {	   
	  ...
	  notapplicable1($('.chk_UK-FCL-00680_0').val());  


	    function notapplicable2(str)
	    {	   
	  	       if(str =="Yes"){
	    ...
	    notapplicable2($('.chk_UK-FCL-00681_0').val()); 
...
$(document).ready(function () {
	...
	function two_hide(){
		...
		$('input[name=UK-FCL-00680_0]').change(function(){	 	
			notapplicable1(this.value);
	 	});


	 	$('input[name=UK-FCL-00681_0]').change(function(){	 	
			notapplicable2(this.value);
	 	});
	 	 ...
	 	 /*  window.location = window.location.href
         	...
         	$('input[name=UK-FCL-00682_0]').change(function(){	 	
        		lasthideshow(this.value);
         	});


		var checkbox = $("#UK-FCL-00105_0").val();
		if(checkbox == ''){
