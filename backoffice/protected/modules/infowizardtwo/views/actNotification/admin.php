...
$('.search-form form').submit(function(){
	$('#bo-information-wizard-act-notification-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Bo Information Wizard Act Notifications</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'bo-information-wizard-act-notification-grid',
