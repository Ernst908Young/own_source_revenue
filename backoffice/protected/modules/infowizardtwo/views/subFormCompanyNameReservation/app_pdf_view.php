...
?>
	<table cellspacing="0" width="100%" cellpadding="2" cellpadding="5px" class="gridtable">	
		<tbody>
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><b>Postal Code:</b>  <?php echo @ InfowizardQuestionMasterExt::getPostalCodeFromId(@$fieldValues['UK-FCL-00061_0']);?></td>
								</tr>
								<tr>
									<td><b>Parish:</b><?php 
								...
								<tr>
									<td><b>Country:</b> <?php 
									if(isset($fieldValues['UK-FCL-00059_0']) && !empty($fieldValues['UK-FCL-00059_0'])){
									echo  InfowizardQuestionMasterExt::getCountryStateNameByID(@$fieldValues['UK-FCL-00059_0']);
									}
									?></td>
								</tr>
							</table>
						...
						<tr>
							...
							<table width="100%" border="1" cellpadding="5px" style="border-width:0.5px;">
								...
								<tr nobr="true">
									...
									<td><?php echo $show_main==true ?  @$fieldValues['UK-FCL-00073_0'][$ke] : "XXXXX"; ?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Mobile Number:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00075_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Email ID:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00076_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
								...
								<tr nobr="true">
									...
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00082_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Address Line 2:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00376_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Address City:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00081_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Address State / Parish:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00080_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Address Pin / Area Code:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00086_0'][$ke] : "XXXXX";?></td>
								</tr>
								<tr nobr="true">
									<td><b>Individual Address : Country:</b></td>
									<td><?php echo $show_main==true ? @$fieldValues['UK-FCL-00079_0'][$ke] : "XXXXX";?></td>
								</tr>
			...
			<?php 
			if(isset($fieldValues['UK-FCL-00246_0']) && !empty($fieldValues['UK-FCL-00246_0']) && isset($fieldValues['UK-FCL-00084_0']) && !empty($fieldValues['UK-FCL-00084_0'])){
			?>
			<tr>
				<td width="5%">6.</td>
				<td width="95%">
		...
		<tr>
			...
			<td width="95%">
				...
				<tr>
					...
					<table width="100%" border="0">
						<tr>
							<td><b>Name:</b> <?php echo @$fieldValues['UK-FCL-00002_0'].' '.@$fieldValues['UK-FCL-00003_0'].' '.@$fieldValues['UK-FCL-00260_0'];?></td>
						</tr>	
						<tr>
							<td><b>Address :</b> 
							 <?php echo @$fieldValues['UK-FCL-00011_0'];?>
							 <?php echo @$fieldValues['UK-FCL-00327_0'];?>
							  <?php echo @$fieldValues['UK-FCL-00010_0'];?>
							 
							  <?php echo InfowizardQuestionMasterExt::getCountryStateNameByID(@$fieldValues['UK-FCL-00008_0']);?> 
							  <?php echo InfowizardQuestionMasterExt::getCountryStateNameByID(@$fieldValues['UK-FCL-00007_0']);?>
							   <?php echo @$fieldValues['UK-FCL-00328_0'];?> 
							</td>
						</tr>
						<tr>
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Main Business Activity description which company carries on or proposes to carry on:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							...
							<?php foreach(@$fieldValues['UK-FCL-00018_0'] as $k1=>$v1){
									if(@$fieldValues['UK-FCL-00018_0'] && $v1=='165'){
							?>
							<tr>
								<td><b>Description:</b> <?php echo @$fieldValues['UK-FCL-00498_0'];?></td>
							</tr>
							<tr><td>&nbsp;</td></tr>
							<?php }}?>
						</table>
		...
		<tr>
			...
			<td width="95%">
				<table width="100%" border="0">
					<tr>
						<td>
						Main Types of business company carries on or proposes to carry on:
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						...
						<table width="100%" border="0">
							<tr>
								<td>
									<?php echo @$fieldValues['UK-FCL-00244_0'];?>
								</td>
							</tr>
						</table>
						</td>
		...
		<tr> 
			...
			<td width="95%">
				<table width="100%" border="0">
					...
					<tr><td>&nbsp;</td></tr>
					<?php if(isset($fieldValues['UK-FCL-00027_0']) && $fieldValues['UK-FCL-00027_0']=='2'){?>
					<tr>
						<td><b>Details of Derivation of Name:</b> <?php echo @$fieldValues['UK-FCL-00325_0'];?></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<?php }?>
				</table>
...
<table cellspacing="0" width="100%" cellpadding="2" cellpadding="5px" class="gridtable">	
		...
		<tr>
			<td width="5%"></td>
			<td width="95%"><table style=" font-size: 10; border-collapse: collapse; ">
      <tr>
         <td style="text-align:center;">
            <span style="font-size: 10;"><strong> SIGNATORY DETAILS</strong></span>           
         </td>
      </tr>
     <br>
       <tr>
