...
<p style="color:red; font-size: 14px;">Fields marked with * are mandatory fields, however, in case any of these fields is not applicable in your case, then please mention "Not Applicable" or "NA"</p>
...
<div class="next-btn">
			...
			<!-- <a href="javascript:void(0);" class="custome-btn back_btn" data-wizard-action="prev" style="display: inline-block!important;">
			<span>
	...
	<?php if($_GET['subID']){
	 ...
	 ?>
		...
		<?php } ?>
			...
			<a href="javascript:void(0);" class="submitForm custome-btn" data-wizard-action="submit" style="display: inline-block!important;" rel="<?php echo @$_GET['service_id']?>">
				<span>
		...
		<!-- 	<a href="javascript:void(0);" class="custome-btn" data-wizard-action="next" style="display: inline-block!important;" rel="<1?php echo @$_GET['service_id']?>" >
				<span>
					<span>
						Next
...
$(document).ready(function () {
	...
	$('.add-more-btn').on('click', function () {		
		...
		if(service_id=='2.0' || service_id=='4.0' || service_id=='7.0' || service_id=='8.0' ||service_id=='6.0' ||service_id=='5.0' || service_id=='9.0' || service_id=='10.0' || service_id=='12.0' || service_id=='14.0' || service_id=='13.0'){			
