<?php
class SubFormArticlesOfContinuanceForm17PartialController extends Controller {
...
// End Code of service provider 
            ...
            $landrigion_id = $model->landrigion_id;
          	$model->name_related_srn = $_POST['UK-FCL-00088_0'];
			/* 	echo "<pre>";
			 print_r($model);die; */
            if($model->save()) 
			{
				...
				$reverted_call_back_url = "/backoffice/infowizard/subFormArticlesOfContinuanceForm17/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizard/subFormArticlesOfContinuanceForm17/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
