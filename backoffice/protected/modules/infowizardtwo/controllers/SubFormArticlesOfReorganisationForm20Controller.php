...
class SubFormArticlesOfReorganisationForm20Controller extends Controller {
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormArticlesOfReorganisationForm20/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
            ...
            if ($_POST['app_status'] == 'A') {
				...
				// print_r($fetchsrnRecords);die;
                $farr = (array) json_decode($fetchsrnRecords['field_value']);
				// print_r($farr);die;
                $name_related_srn = isset($farr['UK-FCL-00403_0']) ? $farr['UK-FCL-00403_0'] : NULL;
                ...
                $c_type = 'ARF20'; //Articles of Re-Organisation/Arrangement (Form 20)
...
if($farr['UK-FCL-00346_0']){
  ...
  $fulladdress =     @$farr['UK-FCL-00340_0'].' '.@$farr['UK-FCL-00341_0'].' '.@$farr['UK-FCL-00344_0'].' '. @$pc1.' '.@$parish1['lr_name'].' '.@$farr['UK-FCL-00347_0'] ; */
        ...
        $companyDetail->company_type = 'ARF20';
        $companyDetail->reg_no = @$farr['UK-FCL-00403_0'];
...
/*Yii::app()->db->createCommand("INSERT INTO bo_company_details (srn_no, name_related_srn, service_id, company_type, reg_no,company_name,user_id,approved_by,address)
                ...
                if ($_POST['service_id'] == '25.0') {
                    ...
                    $download_certificate_call_back_url1 = CURL_URL."/backoffice/infowizardtwo/subFormPdf/SaveNewApprovalCertificate24_0/service_id/" . base64_encode($_POST['service_id']) . "/subID/" . base64_encode($_POST['app_Sub_id']) . "/dept_id/" . base64_encode($dept_id)."/utility/Utility25_0c";
...
// End Code of service provider 
            ...
            {               
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormArticlesOfReorganisationForm20/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
                $print_app_call_back_url ="/backoffice/infowizardtwo/subFormArticlesOfReorganisationForm20/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
...
// jitendra singh
   ...
   public function actionDownloadNewApp() {
     ...
     //  $content = $this->renderPartial('company_name_pdf_view', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
      ...
      // $content = false;
       ...
       $content = $this->renderPartial('company_name_pdf_view', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date'], 'signatoryDetails'=>$signatoryDetails), true);
      // echo "<pre>";print_r($fieldValues2);die;
       $contentform4="";
       if(isset($fieldValues2['UK-FCL-00546_0']) && $fieldValues2['UK-FCL-00546_0']=='Yes')
           $contentform4 = $this->renderPartial('form4_pdf', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
       $contentform9="";
       if(isset($fieldValues2['UK-FCL-00547_0']) && $fieldValues2['UK-FCL-00547_0']=='Yes')
        $contentform9 = $this->renderPartial('form9_pdf', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
       ...
       //echo $content; die;
       Utility25_0::generatePdfApp($content,$contentform4,$contentform9, $name, $app_log,$signatory_details,$fieldValues2);
       exit;
        }else{
   ...
   public function actionGetcompanyNameByregno(){
        ...
        // print_r($reg_no);die;
        $user_id = $_SESSION['RESPONSE']['user_id'];
        $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE company_type IN ('IC','NPC') AND user_id = $user_id  AND reg_no='".$reg_no."'")->queryRow();
        if($c_detail){  
				...
				if($check_already_exist){
                   ...
                   // print_r($fieldValue);die;
                    if($check_already_exist['service_id']=='4.0'){
							$cname = @$fieldValue['UK-FCL-00089_0'];
							$sharecapital_table = $this->renderPartial('autopopulatedirector',["fieldValue"=>@$fieldValue],true);
							$noclasssahre = @$fieldValue['UK-FCL-00262_0'];
							$companytransable = @$fieldValue['UK-FCL-00334_0'];
							$directorno = @$fieldValue['UK-FCL-00240_0'];
							$fixed = @$fieldValue['UK-FCL-00241_0'];
							$minranged = @$fieldValue['UK-FCL-00119_0'];
							$maxranged = @$fieldValue['UK-FCL-00120_0'];
							$restriction_on_business = @$fieldValue['UK-FCL-00339_0'];
							$company_type = @$fieldValue['UK-FCL-00123_0'];
							$otherpro = @$fieldValue['UK-FCL-00126_0'];
							//form9
							$cessation_table = $this->renderPartial('autopopulatecessation',["fieldValue"=>@$fieldValue],true);
                            $present_table = $this->renderPartial('autopopulatepresent',["fieldValue"=>@$fieldValue],true);
                        

							
							//form4 autopopulate
							
							$add1 = @$fieldValue['UK-FCL-00340_0'];
							$add2 = @$fieldValue['UK-FCL-00341_0'];
							$parish = (@$fieldValue['UK-FCL-00345_0']);
							$postal = @$fieldValue['UK-FCL-00346_0'];
                    }else{
                        if($check_already_exist['service_id']=='5.0'){
							
							$cname = @$fieldValue['UK-FCL-00090_0'];
							$sharecapital_table = $this->renderPartial('autopopulatedirector',["fieldValue"=>@$fieldValue],true);
							$noclasssahre = @$fieldValue['UK-FCL-00262_0'];
							$companytransable = @$fieldValue['UK-FCL-00334_0'];
							$directorno = @$fieldValue['UK-FCL-00240_0'];
							$fixed = @$fieldValue['UK-FCL-00100_0'];
							$minranged = @$fieldValue['UK-FCL-00119_0'];
							$maxranged = @$fieldValue['UK-FCL-00120_0'];
							$restriction_on_business = @$fieldValue['UK-FCL-00339_0'];
							$company_type = @$fieldValue['UK-FCL-00306_0'];
							$otherpro = @$fieldValue['UK-FCL-00126_0'];
							$cessation_table = $this->renderPartial('autopopulatecessation',["fieldValue"=>@$fieldValue],true);
                            $present_table = $this->renderPartial('autopopulatepresent',["fieldValue"=>@$fieldValue],true);
							//form4
							$add11 = @$fieldValue['UK-FCL-00352_0'];
							$add21 = @$fieldValue['UK-FCL-00353_0'];
							$parish1 = @$fieldValue['UK-FCL-00355_0'];
							$postal1 = @$fieldValue['UK-FCL-00356_0'];
							//print_r($postal1);die;
                    ...
                    echo CJavaScript::jsonEncode(
                        array('status'=>true,
							...
							'cname' => (!empty($fieldValue['UK-FCL-00090_0']) ? $fieldValue['UK-FCL-00090_0'] : (!empty($fieldValue[	'UK-FCL-00089_0']) ? $fieldValue['UK-FCL-00089_0'] :''  )),
							...
							'directorno'=>@$fieldValue['UK-FCL-00240_0'],
							// 'fixed'=>@$fieldValue['UK-FCL-00100_0'],
							'fixed'=>(!empty($fieldValue['UK-FCL-00100_0']) ? $fieldValue['UK-FCL-00100_0'] : (!empty($fieldValue[	'UK-FCL-00241_0']) ? $fieldValue['UK-FCL-00241_0'] :''  )),
							'minranged'=>@$fieldValue['UK-FCL-00119_0'],
							'maxranged'=>@$fieldValue['UK-FCL-00120_0'],
							'restriction_on_business'=>@$fieldValue['UK-FCL-00339_0'],
							'company_type'=>(!empty($fieldValue['UK-FCL-00306_0']) ? $fieldValue['UK-FCL-00306_0'] : (!empty($fieldValue[	'UK-FCL-00123_0']) ? $fieldValue['UK-FCL-00123_0'] :''  )),
					...
					$fieldValue = (array) json_decode($c_detail['field_value']);
					echo CJavaScript::jsonEncode(
                    array('status'=>true,
						  ...
						  'add1' => @$fieldValue['UK-FCL-00340_0'],
							'add2' => @$fieldValue['UK-FCL-00341_0'],
							'parish' => InfowizardQuestionMasterExt::getCountryStateNameByID(@$fieldValue['UK-FCL-00345_0']),
							'postal' => @$fieldValue['UK-FCL-00346_0'],
							
							'add11' => @$fieldValue['UK-FCL-00340_0'],
							'add21' => @$fieldValue['UK-FCL-00341_0'],
							'parish1' => @$fieldValue['UK-FCL-00345_0'],
							'postal1' => @$fieldValue['UK-FCL-00346_0'],
