...
class SubFormNoticeofChangeofAddressForm4Controller extends Controller {
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofChangeofAddressForm4/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
...
//END CODE  BY:- Aamir Date :- 19-08-2021  
    ...
    public function actionGetCompanyNameByregno(){
        $reg_no = DefaultUtility::dataSenetize($_GET['reg_no']);
         ...
         if($user_id){
                $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE user_id = $user_id AND company_type IN('IC','NPC') AND is_active=1 AND reg_no='".$reg_no."'")->queryRow();
                if($c_detail){
                    $check_already_exist =  Yii::app()->db->createCommand("SELECT * FROM entity_application_latest_data where entity_no='" . $reg_no  . "' AND service_id='".$c_detail['service_id']."'")->queryRow();
                        if($check_already_exist){
                            ...
                            if($check_already_exist['service_id']=='4.0'){
                                if(@$field_value['UK-FCL-00345_0']){
                                    $parish = LandregionExt::getLandRegionNameViaId(@$field_value['UK-FCL-00345_0']);
                                    $add1 = @$field_value['UK-FCL-00340_0'];
                                    $add2 = @$field_value['UK-FCL-00341_0'];
                                    $p_code = @$field_value['UK-FCL-00346_0'];
                                }
                            }else{
                                ...
                                if(@$field_value['UK-FCL-00405_0']){
                                    ...
                                    $add1 = @$field_value['UK-FCL-00093_0'];
                                    $add2 = @$field_value['UK-FCL-00309_0'];
                                    $p_code = @$field_value['UK-FCL-00242_0'];
                                }
                            }else{
                                 $parish ='NA';
                                    $add1 = 'NA';
                            ...
                            echo CJavaScript::jsonEncode(
                             ...
                             echo CJavaScript::jsonEncode(
                                    array('status'=>true,
                                            'cname'=>$c_detail['company_name'],
                                            'address1'=>$c_detail['address_line1'],
                                            'address2'=>$c_detail['address_line2'],
                                            'parish'=>strtoupper($c_detail['state_parish']),
                                            'postal_code'=>$c_detail['postal_code'],
                                            //'country'=>$c_detail['country'],
                                            'msg'=>'success'
                                    )
                                );
                        }
                    ...
                    echo CJavaScript::jsonEncode(array('status'=>false,'msg'=>'Please enter the valid company number issued by CAIPO'));
                }
         }else{
             echo CJavaScript::jsonEncode(array('status'=>false,'msg'=>'Please login again'));
         }
...
//End Entity Code          
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofChangeofAddressForm4/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizardtwo/subFormNoticeofChangeofAddressForm4/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
   ...
   static function alignInSequence($serviceID = null, $formCodeID = null) {
    ...
    public function actionDownloadNewApp() {
      ...
      if (!empty($_GET['service_id']) && ((isset($_SESSION['RESPONSE']['user_id']) && $_SESSION['RESPONSE']['user_id']==$fieldValues['user_id']) || isset($_SESSION['role_id']) || isset($_POST['is_api_user']))) {
        ...
        //echo $content; die;
        Utility14_0::generatePdfApp($content, $name, $app_log,$fieldValues2);
          exit;
        }else{
