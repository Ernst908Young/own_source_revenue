...
class SubFormNoticeofSecretaryController extends Controller {
    ...
    public function actionGetCompanyNameByregno(){
        $reg_no = DefaultUtility::dataSenetize($_GET['reg_no']);
         ...
         if($user_id){
            $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE user_id = $user_id AND company_type = 'IC' AND is_active=1 AND reg_no='".$reg_no."'")->queryRow();
            if($c_detail){         
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofSecretary/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
...
//End Entity Code                 
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofSecretary/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizardtwo/subFormNoticeofSecretary/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
   ...
   static function alignInSequence($serviceID = null, $formCodeID = null) {
    ...
    public function actionDownloadNewApp() {
      ...
      if (!empty($_GET['service_id']) && ((isset($_SESSION['RESPONSE']['user_id']) && $_SESSION['RESPONSE']['user_id']==$fieldValues['user_id']) || isset($_SESSION['role_id']) || isset($_POST['is_api_user']))) {
        ...
        //echo $content; die;
        Utility18_0::generatePdfApp($content, $name, $app_log,$fieldValues2);
         exit;
        }else{
