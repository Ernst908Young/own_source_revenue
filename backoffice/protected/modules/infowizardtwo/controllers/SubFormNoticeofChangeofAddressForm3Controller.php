...
class SubFormNoticeofChangeofAddressForm3Controller extends Controller {
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofChangeofAddressForm3/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
...
//End Entity Code              
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofChangeofAddressForm3/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizardtwo/subFormNoticeofChangeofAddressForm3/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
   ...
   static function alignInSequence($serviceID = null, $formCodeID = null) {
    ...
    public function actionGetSocietyNameByregno(){
        ...
        $user_id = @$_SESSION['RESPONSE']['user_id'];
         if($user_id){
            $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE user_id = $user_id AND company_type = 'S' AND is_active=1 AND reg_no='".$reg_no."'")->queryRow();
                 if($c_detail){
                        ...
                        if($check_already_exist){
                            ...
                            echo CJavaScript::jsonEncode(
                                array('status'=>true,
                                        ...
                                        'address1'=>@$field_value['UK-FCL-00308_0'],
                                        'address2'=>@$field_value['UK-FCL-00309_0'],
                                        'parish'=>strtoupper($parish),
                                        'postal_code'=>@$field_value['UK-FCL-00094_0'],                 
                                        'msg'=>'success'
                                )
                              );
    ...
    public function actionDownloadNewApp() {
      ...
      if (!empty($_GET['service_id']) && ((isset($_SESSION['RESPONSE']['user_id']) && $_SESSION['RESPONSE']['user_id']==$fieldValues['user_id']) || isset($_SESSION['role_id']) || isset($_POST['is_api_user']))) {
        ...
        //echo $content; die;
        Utility11_0::generatePdfApp($content, $name, $app_log,$fieldValues2 );
         exit;
        }else{
