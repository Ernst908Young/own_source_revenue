...
class SubFormArticlesofAmalgamationSocietiesForm6BController extends Controller {
...
$fetchsrnRecords = Yii::app()->db->createCommand("SELECT  service_id,submission_id,user_id,field_value FROM bo_new_application_submission where submission_id=$app_Sub_id")->queryRow();
                ...
                $c_type = 'AS6B'; //ARTICLES OF AMALGAMATION (Form 6B)
...
if($farr['UK-FCL-00346_0']){
  ...
  $fulladdress =     @$farr['UK-FCL-00340_0'].' '.@$farr['UK-FCL-00341_0'].' '.@$farr['UK-FCL-00344_0'].' '. @$pc1.' '.@$parish1['lr_name'].' '.@$farr['UK-FCL-00347_0'] ; */
        ...
        $companyDetail->company_type = 'AS6B';
...
/*Yii::app()->db->createCommand("INSERT INTO bo_company_details (srn_no, name_related_srn, service_id, company_type, reg_no,company_name,user_id,approved_by,address)
                ...
                if ($_POST['service_id'] == '38.0') {
                    ...
                    $download_certificate_call_back_url1 = CURL_URL."/backoffice/infowizardtwo/subFormPdf/SaveNewApprovalCertificate20_0/service_id/" . base64_encode($_POST['service_id']) . "/subID/" . base64_encode($_POST['app_Sub_id']) . "/dept_id/" . base64_encode($dept_id)."/utility/Utility38_0c";
...
// End Code of service provider 
            ...
            {               
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormArticlesofAmalgamationSocietiesForm6B/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
                $print_app_call_back_url ="/backoffice/infowizardtwo/subFormArticlesofAmalgamationSocietiesForm6B/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
    ...
    public function actionDownloadNewApp() {
      ...
      //  $content = $this->renderPartial('company_name_pdf_view', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
       ...
       // echo "<pre>";print_r($fieldValues2);die;
        ...
        // echo $contentform6; die;
        Utility38_0::generatePdfApp($content,$contentform3,$contentform6, $name, $app_log,$signatory_details);
        exit;
        }else{
    ...
    public function actionGetCompanyNameBySrnNo(){
            ...
            if($user_id){
                ...
                if($chk_srn_is_used){
                    ...
                    $name_res = Yii::app()->db->createCommand("SELECT * 
                  ...
                  //  echo "<pre>";print_r($name_res);die;
                    if($name_res){
                        $checkformtype = (array) json_decode($name_res['field_value']);
                        if($name_res['application_status']=='A' && $checkformtype['UK-FCL-00044_0']==1 && $checkformtype['UK-FCL-00053_0']== '2'){
                        ...
                        } else if($name_res['application_status']!='A' && $checkformtype['UK-FCL-00044_0']==1 && $checkformtype['UK-FCL-00053_0']== '2'){
                         ...
                         echo CJavaScript::jsonEncode(array('status'=>false,'user'=>$user_id,'msg'=>'Please enter a valid SRN, it must relate to Form 15, filed for Name change of existing Society'));
                        }
                    }
                    else{
                        echo CJavaScript::jsonEncode(array('status'=>false,'user'=>$user_id,'msg'=>'Please enter a valid SRN, it must relate to Form 15, filed for Name change of existing Society'));
