...
class SubFormANNUALRETURNForm35Controller extends Controller {
...
*/
        ...
        if (isset($allRes) && !empty($allRes)) {
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormANNUALRETURNForm35/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
            ...
            if ($_POST['app_status'] == 'A') {
                ...
                $updateNewApplication = Yii::app()->db->createCommand("update bo_new_application_submission set application_status='$app_status' where submission_id=$app_Sub_id")->execute();
                $c_type = 'AR35'; // Annual Return 35
                $currentDate = date('Y-m-d H:i:s');
                $d_url = "";
                // if ($_POST['service_id'] == '15.0') {
                //     $data = '';
                //     $path = '';
                //     $name = "CERTIFICATE_" . $app_Sub_id . ".pdf";

                //     $download_certificate_call_back_url1 = CURL_URL . "/backoffice/infowizardtwo/subFormPdf/SaveNewApprovalCertificate/service_id/" . base64_encode($_POST['service_id']) . "/subID/" . base64_encode($_POST['app_Sub_id']) . "/dept_id/" . base64_encode($dept_id);
           ...
           $nocPath = "";
			...
			if($model->application_status=='A'){
				...
				$c_detail = Yii::app()->db->createCommand("SELECT A.*,B.* from bo_company_details A
					...
					WHERE A.company_type IN ('IC','NPC') AND A.user_id = $model->user_id AND A.reg_no='".$reg_no."'")->queryRow(); 
				// print_r($c_detail);die;
				if($c_detail){
					// echo"false";die;
					Updatecompanymasterdata_for_company::parentfunction($model);
...
// End Code of service provider    
            //Entity Code By Aamir
                        $model->entity_name = $_POST['UK-FCL-00631_0'];
//Entity Code By Aamir
            // $model->entity_name = DefaultUtility::sanatizeParams($_POST['service_id']);
//End Entity Code     
            ...
            if ($model->save()) {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormANNUALRETURNForm35/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $application_id . "/formCodeID/1";
                $print_app_call_back_url = "/backoffice/infowizardtwo/subFormANNUALRETURNForm35/downloadNewApp/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $application_id . "/formCodeID/1";
   ...
   public function actionSaveUpdateSubForm() {
    ...
    public function actionDownloadNewApp() {
      ...
      if (!empty($_GET['service_id']) && ((isset($_SESSION['RESPONSE']['user_id']) && $_SESSION['RESPONSE']['user_id']==$fieldValues['user_id']) || isset($_SESSION['role_id']) || isset($_POST['is_api_user']))) {
        ...
        // echo $content; die;
        Utility29_0::generatePdfApp($content,$name,$app_log,$fieldValues2);
        exit;
        }else{
    ...
    public function actionGetCompanyNameBySrnNo() {
		...
		$comp_detal = Yii::app()->db->createCommand("SELECT sub.*,com.* FROM bo_new_application_submission sub INNER JOIN 
                        bo_company_details com
                        ON com.srn_no=sub.submission_id
                        WHERE sub.user_id = $user_id AND is_active=1 AND company_type IN ('IC','NPC','S')  AND reg_no='" . $reg_no . "' AND sub.service_id IN('4.0','5.0','9.0')")->queryRow();
        ...
        if($user_id) {
            ...
            if($comp_detal){
				...
				$check_already_exist =  Yii::app()->db->createCommand("SELECT * FROM entity_application_latest_data where entity_no='" . $reg_no  . "' AND service_id='".$comp_detal['service_id']."'")->queryRow();
                ...
                if($check_already_exist){
                    ...
                    if($check_already_exist['service_id']=='4.0'){
						
                        $name =  @$fieldValue['UK-FCL-00089_0']; 
						$regaddress1 =  @$fieldValue['UK-FCL-00340_0'];
						$regaddress2 =  @$fieldValue['UK-FCL-00341_0'];
						$regcity =  @$fieldValue['UK-FCL-00344_0'];
						$regparish =  @$fieldValue['UK-FCL-00345_0'];
						$regportal =  @$fieldValue['UK-FCL-00346_0'];
						$regcountry =  @$fieldValue['UK-FCL-00347_0'];
						$date_of_incorporation =  $check_already_exist['created_on'];
						$no_of_share_holder =  (!empty($fieldValue['UK-FCL-00262_0']) ? $fieldValue['UK-FCL-00262_0'] : (!empty($fieldValue['UK-FCL-00365_0']) ? $fieldValue['UK-FCL-00365_0'] : '') );
						$classes_of_shares =  trim($this->renderPartial('autoPopulateShareHolder',["fieldValue"=>$fieldValue],true));
						$director_detail =  $this->renderPartial('autoPopulateDirectordetail',["fieldValue"=>$fieldValue],true);
                    }
					if($check_already_exist['service_id']=='5.0'){
						
						$name =  $fieldValue['UK-FCL-00090_0'];	
						// print_r($name);die;
						$regaddress1 =  $fieldValue['UK-FCL-00093_0'];  
						$regaddress2 =  $fieldValue['UK-FCL-00309_0'];
						$regcity =  $fieldValue['UK-FCL-00310_0'];
						$regparish =  $fieldValue['UK-FCL-00405_0'];
						$regportal =  $fieldValue['UK-FCL-00242_0'];
						$regcountry =  $fieldValue['UK-FCL-00096_0'];
						$date_of_incorporation =  $check_already_exist['created_on'];
						$no_of_share_holder =  (!empty($fieldValue['UK-FCL-00262_0']) ? $fieldValue['UK-FCL-00262_0'] : (!empty($fieldValue['UK-FCL-00365_0']) ? $fieldValue['UK-FCL-00365_0'] : '') );
						$classes_of_shares =  trim($this->renderPartial('autoPopulateShareHolder',["fieldValue"=>$fieldValue],true));
						$director_detail =  $this->renderPartial('autoPopulateDirectordetail',["fieldValue"=>$fieldValue],true);
                        ...
                        $name =  @$fieldValue['UK-FCL-000197_0'];
						$regaddress1 =  $fieldValue['UK-FCL-00308_0'];
						$regaddress2 =  $fieldValue['UK-FCL-00309_0'];
						$regcity =  $fieldValue['UK-FCL-00310_0'];
						$regparish =  $fieldValue['UK-FCL-00405_0'];
						$regportal =  $fieldValue['UK-FCL-00094_0'];
						$regcountry =  $fieldValue['UK-FCL-00096_0'];
						$date_of_incorporation =  $check_already_exist['created_on'];
						$no_of_share_holder =  (!empty($fieldValue['UK-FCL-00262_0']) ? $fieldValue['UK-FCL-00262_0'] : (!empty($fieldValue['UK-FCL-00365_0']) ? $fieldValue['UK-FCL-00365_0'] : '') );
						$classes_of_shares =  trim($this->renderPartial('autoPopulateShareHolder',["fieldValue"=>$fieldValue],true));
						$director_detail =  $this->renderPartial('autoPopulateDirectordetail',["fieldValue"=>$fieldValue],true);
						// print_r($director_detail);die;
							...
							$regcountry ='NA';
							$regcountry ='NA';
							$date_of_incorporation ='NA';
							$no_of_share_holder ='NA';
							$classes_of_shares ='NA';
							$director_detail ='NA';
                           
                        }
                    }
                    $fieldValue1=json_decode($comp_detal['field_value'],true);
					// print_r($fieldValue_old);die;
                    echo CJavaScript::jsonEncode(	
                        array('status' => true, 'app_status' => 'valid', 

							'name' => (!empty($fieldValue['UK-FCL-00090_0']) ? $fieldValue['UK-FCL-00090_0'] : (!empty($fieldValue[	'UK-FCL-00197_0']) ? $fieldValue['UK-FCL-00197_0'] : (!empty($fieldValue['UK-FCL-00089_0']) ? $fieldValue['UK-FCL-00089_0']   : '' ) )),
							
							'regaddress1' => (!empty($fieldValue['UK-FCL-00093_0']) ? $fieldValue['UK-FCL-00093_0'] : (!empty($fieldValue[	'UK-FCL-00340_0']) ? $fieldValue['UK-FCL-00340_0'] : (!empty($fieldValue['UK-FCL-00308_0']) ? $fieldValue['UK-FCL-00308_0']   : '' ) )),

							'regaddress2' => (!empty($fieldValue['UK-FCL-00341_0']) ? $fieldValue['UK-FCL-00341_0'] : (!empty($fieldValue[	'UK-FCL-00309_0']) ? $fieldValue['UK-FCL-00309_0'] : (!empty($fieldValue['UK-FCL-00309_0']) ? $fieldValue['UK-FCL-00309_0']   : '' ) )),

							'regcity' => (!empty($fieldValue['UK-FCL-00344_0']) ? $fieldValue['UK-FCL-00344_0'] : (!empty($fieldValue[	'UK-FCL-00310_0']) ? $fieldValue['UK-FCL-00310_0'] : (!empty($fieldValue['UK-FCL-00310_0']) ? $fieldValue['UK-FCL-00310_0']   : '' ) )),

							'regparish' => (!empty($fieldValue['UK-FCL-00345_0']) ? $fieldValue['UK-FCL-00345_0'] : (!empty($fieldValue[	'UK-FCL-00405_0']) ? $fieldValue['UK-FCL-00405_0'] : (!empty($fieldValue['UK-FCL-00405_0']) ? $fieldValue['UK-FCL-00405_0']   : '' ) )),

							'regportal' => (!empty($fieldValue['UK-FCL-00346_0']) ? $fieldValue['UK-FCL-00346_0'] : (!empty($fieldValue[	'UK-FCL-00242_0']) ? $fieldValue['UK-FCL-00242_0'] : (!empty($fieldValue['UK-FCL-00094_0']) ? $fieldValue['UK-FCL-00094_0']   : '' ) )),

							'regcountry' => (!empty($fieldValue['UK-FCL-00096_0']) ? $fieldValue['UK-FCL-00096_0'] : (!empty($fieldValue[	'UK-FCL-00096_0']) ? $fieldValue['UK-FCL-00096_0'] : (!empty($fieldValue['UK-FCL-00096_0']) ? $fieldValue['UK-FCL-00096_0']   : '' ) )),
						...
						$fieldValue=json_decode($comp_detal['field_value'],true);
						echo CJavaScript::jsonEncode(
                            array('status' => true, 'app_status' => 'valid', 
							'name' => $comp_detal['company_name'], 
							'regaddress1'=>$comp_detal['address_line1'],
							'regaddress2'=>$comp_detal['address_line2'],
							'regcity'=>$comp_detal['city'],
							'regparish'=>$comp_detal['state_parish'],
							'regportal'=>$comp_detal['postal_code'],
							'regcountry'=>$comp_detal['country'],
							'date_of_incorporation'=>@$comp_detal['created_on'],
							'no_of_share_holder'=>(!empty($fieldValue['UK-FCL-00262_0']) ? $fieldValue['UK-FCL-00262_0'] : (!empty($fieldValue['UK-FCL-00365_0']) ? $fieldValue['UK-FCL-00365_0'] : '') ),
							'classes_of_shares'=>trim($this->renderPartial('autoPopulateShareHolder',["fieldValue"=>$fieldValue],true)),
							'director_detail'=>$this->renderPartial('autoPopulateDirectordetail',["fieldValue"=>$fieldValue],true),
                ...
                echo CJavaScript::jsonEncode(array('status' => false, 'user' => true, 'msg' => 'Please enter a correct and valid Company Number/Society Number'));
			}
        }else {
