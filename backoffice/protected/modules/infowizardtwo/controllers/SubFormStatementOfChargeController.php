...
class SubFormStatementOfChargeController extends Controller {
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormStatementOfCharge/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
            ...
            if ($_POST['app_status'] == 'A') {
                ...
                $c_name = @$farr['UK-FCL-00502_0']=='Yes' ? $farr['UK-FCL-00507_0'] : $farr['UK-FCL-00651_0'];
...
$maxid = $cdmaxid;
        ...
        $companyDetail->company_type = 'SC';
        $companyDetail->reg_no = $farr['UK-FCL-00650_0'];
...
/*Yii::app()->db->createCommand("INSERT INTO bo_company_details (srn_no, name_related_srn, service_id, company_type, reg_no,company_name,user_id,approved_by,address)
   ...
   if(@$farr['UK-FCL-00502_0']=='Yes'){
        $sql = "SELECT * FROM bo_company_details WHERE reg_no='".$farr['UK-FCL-00650_0']."'";
		...
		// print_r($fetchsrnRecords);die;
                ...
                $d_url = "";
                    ...
                    $download_certificate_call_back_url1 = CURL_URL."/backoffice/infowizardtwo/subFormPdf/SaveNewApprovalCertificate36_0/service_id/" . base64_encode($_POST['service_id']) . "/subID/" . base64_encode($_POST['app_Sub_id']) . "/dept_id/" . base64_encode($dept_id). "/utility/Utility36_0c";
            ...
            if ($_POST['app_status'] == 'FA') {
             ...
             $nocPath = "";
             	 ...
             	 if(isset($_SESSION['RESPONSE']['agent_user_id'])){
		         	Alertsandnotification::sendnotification('Services', $model->submission_id,$model->submission_id,$_SESSION['RESPONSE']['agent_user_id'],'FO',$notification_msg_fo);
		         }

		          if(isset($_SESSION['RESPONSE']['subuser_user_id'])){
		          	Alertsandnotification::sendnotification('Services', $model->submission_id,$model->submission_id,$_SESSION['RESPONSE']['subuser_user_id'],'FO',$notification_msg_fo);
		         }
...
// End Code of service provider 
            //Entity Code By Aamir
                        $model->entity_name = $_POST['UK-FCL-00650_0'];
            //End Entity Code
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormStatementOfCharge/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizardtwo/subFormStatementOfCharge/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
               ...
               // Yii::app()->user->setFlash('success', "Your application for $service_Name has been submitted successfully . Your application id  is : $application_id");
                 ...
                 if(isset($_SESSION['RESPONSE']['agent_user_id'])){
		         	Alertsandnotification::sendnotification('Services', $model->submission_id,$model->submission_id,$_SESSION['RESPONSE']['agent_user_id'],'FO','Application details saved successfully');
		         }

		          if(isset($_SESSION['RESPONSE']['subuser_user_id'])){
		          	Alertsandnotification::sendnotification('Services', $model->submission_id,$model->submission_id,$_SESSION['RESPONSE']['subuser_user_id'],'FO','Application details saved successfully');
		         }
...
// jitendra singh
    ...
    public function actionDownloadNewApp() {
      ...
      if (!empty($_GET['service_id']) && ((isset($_SESSION['RESPONSE']['user_id']) && $_SESSION['RESPONSE']['user_id']==$fieldValues['user_id']) || isset($_SESSION['role_id']) || isset($_POST['is_api_user']))) {
        ...
        // print_r($fieldValues2); die;
        Utility36_0::generatePdfApp($content, $name, $app_log,$fieldValues2,$submission_id=null,$dept_id=null);
        exit;
        }else{
    ...
    public static function SavePDF($url, $path) {
     ...
     public function actionGetcompanyNameByregno(){
        ...
        if($typeOfEntity == 'Company other than Unregistered External Company'){
            $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE company_type IN ('IC','NPC','EC') AND user_id = $user_id  AND reg_no='".$reg_no."' AND service_id IN('4.0','5.0','8.0') ")->queryRow();
        }
        // $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE company_type IN ('IC','NPC','EC','S') AND user_id = $user_id  AND reg_no='".$reg_no."' AND service_id IN('4.0','5.0','8.0','9.0') ")->queryRow();
        ...
        if($c_detail){         
            ...
            echo CJavaScript::jsonEncode(array('status'=>false,'msg'=>'Please enter a correct and valid Company/Society Number'));
        }
