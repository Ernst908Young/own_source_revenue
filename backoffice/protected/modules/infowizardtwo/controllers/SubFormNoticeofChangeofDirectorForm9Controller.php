...
class SubFormNoticeofChangeofDirectorForm9Controller extends Controller {
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofChangeofDirectorForm9/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
...
//End Entity Code             
			...
			{   			
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormNoticeofChangeofDirectorForm9/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
				$print_app_call_back_url ="/backoffice/infowizardtwo/subFormNoticeofChangeofDirectorForm9/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
   ...
   static function alignInSequence($serviceID = null, $formCodeID = null) {
    ...
    public function actionDownloadNewApp() {
      ...
      if (!empty($_GET['service_id']) && ((isset($_SESSION['RESPONSE']['user_id']) && $_SESSION['RESPONSE']['user_id']==$fieldValues['user_id']) || isset($_SESSION['role_id']) || isset($_POST['is_api_user']))) {
        ...
        //echo $content; die;
        Utility13_0::generatePdfApp($content, $name, $app_log,$fieldValues2);
         exit;
        }else{
...
public function actionGetCompanyNameBySrnNo(){
        ...
        $reg_no = DefaultUtility::dataSenetize($_GET['srn_no']);
        $user_id=@$_SESSION['RESPONSE']['user_id'];       
        $comp_detal = Yii::app()->db->createCommand("SELECT * FROM bo_company_details WHERE user_id = $user_id AND is_active=1 AND company_type IN ('IC','NPC') AND reg_no='".$reg_no."'")->queryRow();
