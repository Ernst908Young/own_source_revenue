...
class SubFormArticlesofReOrganisationArrangementofSocietyForm20Controller extends Controller {
        ...
        if (isset($allRes) && !empty($allRes)) {
          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'H') {
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormArticlesofReOrganisationArrangementofSocietyForm20/updateSubForm/service_id/" . $_POST['service_id'] . "/pageID/1/subID/" . $_POST['app_Sub_id'] . "/formCodeID/1";
            ...
            if ($_POST['app_status'] == 'A') {
                ...
                $c_type = 'ARSF20'; // Amendment Form 5 type
...
if($farr['UK-FCL-00346_0']){
  ...
  $fulladdress =     @$farr['UK-FCL-00340_0'].' '.@$farr['UK-FCL-00341_0'].' '.@$farr['UK-FCL-00344_0'].' '. @$pc1.' '.@$parish1['lr_name'].' '.@$farr['UK-FCL-00347_0'] ; */
        ...
        $companyDetail->company_type = 'ARSF20';
        $companyDetail->reg_no =  @$farr['UK-FCL-00290_0'];
...
/*Yii::app()->db->createCommand("INSERT INTO bo_company_details (srn_no, name_related_srn, service_id, company_type, reg_no,company_name,user_id,approved_by,address)
                ...
                if ($_POST['service_id'] == '45.0') {
                    ...
                    $download_certificate_call_back_url1 = CURL_URL."/backoffice/infowizardtwo/subFormPdf/SaveNewApprovalCertificate45_0/service_id/" . base64_encode($_POST['service_id']) . "/subID/" . base64_encode($_POST['app_Sub_id']) . "/dept_id/" . base64_encode($dept_id)."/utility/Utility45_0c";
...
// End Code of service provider 
            ...
            {               
                ...
                $reverted_call_back_url = "/backoffice/infowizardtwo/subFormArticlesofReOrganisationArrangementofSocietyForm20/updateSubForm/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
                $print_app_call_back_url ="/backoffice/infowizardtwo/subFormArticlesofReOrganisationArrangementofSocietyForm20/downloadNewApp/service_id/".$_POST['service_id']."/pageID/1/subID/".$application_id."/formCodeID/1";
...
// jitendra singh
     ...
     //  $content = $this->renderPartial('company_name_pdf_view', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
      ...
      // echo "<pre>";print_r($fieldValues2);die;
       ...
       if(isset($fieldValues2['UK-FCL-00525_0']) && $fieldValues2['UK-FCL-00525_0']=='Yes')
           $contentform3 = $this->renderPartial('form3_pdf', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
       $contentform6="";
       if(isset($fieldValues2['UK-FCL-00526_0']) && $fieldValues2['UK-FCL-00526_0']=='Yes')
        $contentform6 = $this->renderPartial('form6_pdf', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
       ...
       //echo $content; die;
       Utility45_0::generatePdfApp($content,$contentform3,$contentform6, $name, $app_log,$signatory_details,$fieldValues2);
       exit;
        }else{
   ...
   public function actionGetcompanyNameByregno(){
        ...
        $user_id = $_SESSION['RESPONSE']['user_id'];
        $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE company_type IN ('S') AND user_id = $user_id  AND reg_no='".$reg_no."'")->queryRow();
        if($c_detail){         
        ...
        $c_detail = Yii::app()
            ...
            ->createCommand(
                       "SELECT sub.*,com.* FROM bo_new_application_submission sub INNER JOIN 
                        ...
                        WHERE sub.user_id = $user_id AND is_active=1 AND company_type IN ('S')  AND reg_no='" . $reg_no . "'")->queryRow();
                ...
                // print_r($fieldValue);die;
                 ...
                 echo CJavaScript::jsonEncode(
                     array('status'=>true,
                             ...
                             'durationofsociety'=>@$fieldValue['UK-FCL-00361_0'],  
                             'noclassquota'=>@$fieldValue['UK-FCL-00365_0'], 

                            'add1' => @$fieldValue['UK-FCL-00308_0'],
                            'add2' => @$fieldValue['UK-FCL-00309_0'],
                            'parish' => @$fieldValue['UK-FCL-00405_0'],
                            'postal' => @$fieldValue['UK-FCL-00094_0'],
            ...
            else
            {
                ...
                if ($name_res)
                {
                    ...
                    if ($company_detail)
                    {
                     ...
                     echo CJavaScript::jsonEncode(array('status'=>false,'user'=>$user_id,'msg'=>'Please enter a valid SRN, it must relate to Form 15, filed for Name reservation of same Society'));
                }
