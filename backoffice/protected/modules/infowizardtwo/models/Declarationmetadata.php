 ...
 */
class Declarationmetadata extends CActiveRecord  
{
	/**
	...
	{
		return 'bo_declaration_metadata';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('service_id,application_id,created_on', 'safe'),
			
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, service_id, application_id, created_on', 'safe', 'on'=>'search'),
		);
	}
