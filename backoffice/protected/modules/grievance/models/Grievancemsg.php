...
*/
class Grievancemsg extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, user_type, grievance_id, message, msgdatetime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('user_id, user_type, grievance_id, message, msgdatetime', 'safe', 'on'=>'search'),
		);
	}
