 ...
 * @property integer $querymain_id
  * @property string $user_id
 * @property integer $user_type
 * @property string $msgdatetime
*/
class Querymessage extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('message, querymain_id, user_id, user_type, msgdatetime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, message, querymain_id, user_id, user_type, msgdatetime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('querymain_id',$this->querymain_id,true);
