...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->access_id), array('newview', 'id'=>$data->access_id)); ?>
	<br />
	...
	<b><?php echo "Dept Application Number"; ?>:</b>
	<?php $new=(array)(json_decode($data->post_info));echo @$new['dept_application_number']; ?>
	<br />
