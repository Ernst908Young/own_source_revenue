		    ...
		    <div class="col-lg-12">
		        <section class="panel">
		            ...
		            <div class="panel-body">
		            	<?php
		            		if(!$ssoDeptApp)
		            			echo '<form action="'.Yii::app()->createAbsoluteUrl('/admin/uploadDocuments/uploadFiles').'" method="post" enctype="multipart/form-data" name="upload_investor_form" class="tasi-form">';
		            		else
		            			echo '<form action="'.Yii::app()->createAbsoluteUrl('/admin/uploadDocuments/uploadSSODeptFiles').'" method="post" enctype="multipart/form-data" name="upload_investor_form" class="tasi-form">';
		            	?>
		                        <div class="form-inline">
		                            ...
		                            <div class="controls">
		                                ...
		                                <?php 
		                                	if(is_object($model)){
		                                		if(!$ssoDeptApp)
		                                			echo "<input type='hidden' name='submission_id' value='".$model->submission_id."'>";
		                                		else
