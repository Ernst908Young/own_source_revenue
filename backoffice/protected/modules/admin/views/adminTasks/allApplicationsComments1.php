			...
			<table class="table table-bordered" id="sample_2">
				...
				foreach ($applications as $apps) {
					if($apps->application_id == 1){
						...
						?>
						<tr>
							<td><?php echo $apps->submission_id;?></td>
							<td><?php echo $investorinfo['iuid'];?></td>
							<td><?php echo $cafindname;?></td>
							<td><?php echo $investorinfo['email'];?></td>
							<td><?php echo $investorinfo['mobile_number'];?></td>
							<td><?php echo $revertcomment;?></td>
