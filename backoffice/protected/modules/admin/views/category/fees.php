		...
		<div class="reservation-form"> 
			...
			<form id="m_form" method="post"  enctype="multipart/form-data">
				<div class="form-part bussiness-det">
					<h4 class="form-heading">Register Service(Fees)</h4>
					<div class="form-row row">
						...
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Sub Category <span style="color: red;">*</span></label>
								<select name="subcategory_id" placeholder="Select service category" id="servicecategory" class="select2-me" onchange="getservices($(this).val())">
							<option value="">Select Service Category </option> <?php 
