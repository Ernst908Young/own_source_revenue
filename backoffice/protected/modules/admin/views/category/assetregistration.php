		...
		<div class="reservation-form"> 
			...
			<form id="m_form" method="post"  enctype="multipart/form-data">
				<div class="form-part bussiness-det">
					<h4 class="form-heading">Register Asset</h4>
					<div class="form-row row">
						...
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Date of Acquisition/Construction & Bill</label>
							<input type="text" name="acquisition_date" class="form-control" placeholder="Date of Acquisition/Construction & Bill">
						</div>	
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Nature of Acquisition</label>
							<select name="acquisition" placeholder="Nature of Acquisition"  class="select2-me">
						...
						<div class="col-lg-6 form-group text-start mb-6">
							...
							<input type="text" name="venodor" class="form-control" placeholder="Vendor/Donor">
						</div>
						<div class="col-lg-6 form-group text-start mb-6">
						...
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Geocordinates (Longitude)</label>
							<input type="text" name="longitude" class="form-control" placeholder="Longitude">
						</div>
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Geocordinates (Latitude)</label>
						...
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Relevant Unit of Measurement</label>
							<input type="text" name="measurement" class="form-control" placeholder="Relevant Unit of Measurement">
						</div>		
						<div class="col-lg-6 form-group text-start mb-6">
							<label> Useful Life of Asset</label>
							<input type="text" name="asset_life" class="form-control" placeholder="Category">
						</div>	
						<div class="col-lg-6 form-group text-start mb-6">
						...
						<div class="col-lg-6 form-group text-start mb-6">
							<label>Amounts include as CWIP </label>
							<input type="text" name="cwip_amount" class="form-control" placeholder="Amounts include as CWIP" required maxlength="300">
						</div>
						<div class="col-lg-6 form-group text-start mb-6">
                ...
                <table width="100%" id='sample_1'>
                    ...
                    <tbody class="ticket-item">
                        ...
                        <tr>
                            ...
                            <td class="text-center">Guest House</td>
