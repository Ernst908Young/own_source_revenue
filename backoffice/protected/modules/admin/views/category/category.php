...
<div class="dashboard-home">
	...
	<div class="m-wizard m-wizard--3 m-wizard--success" id="m_wizard">
		<div class="reservation-form"> 
			<form id="m_form" method="post" action="<?php echo Yii::app()->createAbsoluteUrl("/admin/default/category"); ?>" enctype="multipart/form-data">
				<div class="form-part bussiness-det">
					<h4 class="form-heading">Add New Asset Category</h4>
					<div class="form-row row">
						<div class="col-lg-6 form-group text-start mb-3">
							<label> Category <span style="color: red;">*</span></label>
							<input type="text" name="category_name" class="form-control" placeholder="Category" required maxlength="300">
            ...
            <div id="sample_1_wrapper" class="dataTables_wrappers dataTables_wrapper">
                <table width="100%" id='sample_1'>
                    ...
                    <tbody class="ticket-item">
                        <?php $n=1;foreach ($service_category as $key => $val) { ?>    
                        <tr>
