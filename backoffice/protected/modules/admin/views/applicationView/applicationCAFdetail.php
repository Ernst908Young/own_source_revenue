   ...
   <div class="panel-body">
         ...
         <div class="row">
            ...
            <div class="col-xs-8 col-sm-6">
               <div class="form-group">
                  ...
                  <input type="text"  id="auth_fax" class="form-control txt  txt "  value="<?=@$fields->auth_fax?>" readonly name="auth_fax" placeholder="Fax Number">
                  <i class="error"></i>
               </div>
            </div>
         </div>
        ...
        <div class="col-md-12">
         <div class="col-md-6">
            <frameset>
               ...
               <div class="form-group">
                  <input type="text" readonly id="other" class="form-control txt " value="<?=@$fields->type_of_industry?>" name="type_of_industry">
                  <i class="error"></i>
               </div>
            </frameset>
         </div>
      ...
      <fieldset title="Step 3" class="step" id="default-step-2" >
         ...
         <div class="row">
            <div class="col-xs-8 col-sm-6">
               <div class="form-group">
                  <label class='control-label'>Have you identified land ?</label>
               ...
               <?php 
                  if(isset($fields->requried_approval_department)){
                                foreach ($fields->requried_approval_department as $key => $value) {
                                    ...
                                    <input readonly name = "required_approval_name['.$key.']" class="custom_text_product_req" type="text" value = "' . $fields->required_approval_name[$key] . '" />';
                                }
               ...
               <div class='form-group'>
                  <?php 
                     ...
                     if(!empty($rolesAccess)){
                         if(isset($data['application_status']) && ($data['application_status'] == 'AB')){
                        ...
                        if(isset($rolesAccess['access_id']) && $rolesAccess['access_id']==3)
                           echo "&nbsp;<a data-toggle='modal' class='fields_properties_modal btn btn-shadow btn-info' href='#forward_to_multi_dept'> <i class='fa fa-mail-forward (alias)'></i> Forward To Dept</a>";
                        if(isset($rolesAccess['access_id']) && $rolesAccess['access_id']==4)
                        ...
                        if(isset($revert) && $revert){
                           echo "&nbsp;<a class='btn btn-default' id='revert_back_to_dept' href='#'>Revert Back to Dept</a>";
                        }
                        }
                     }}
            ...
            <div class="row">
               <?php $Departments=DefaultUtility::getAllDeptFiltered($data['submission_id'],$role_id);
                  ...
                  echo "<div class='row'>&nbsp;</div><div class='row'>&nbsp;</div>
                     <div class='col-md-12'><textarea class='form-control txt  custom_message' name='comments' placeholder='Enter Some Message'></textarea>";
                     ...
                     if(!empty($preMsg)){
                        echo "<div class='row'><div class='col-md-12'>
                           <select name='preComments' class='form-control txt  preComments'>
...
<script type="text/javascript">
   $('#revert_back_to_dept').click(function(e){
       e.preventDefault();
       if(!confirm("Are you sure to revert back the application to Department?"))
         return false;
      ...
      if(sub_id!=''){
         ...
         if(comments.length==0){
            ...
            return false;
                  ...
                  var url="<?php echo Yii::app()->createAbsoluteUrl('/admin/ApplicationView/revertBacktoDept');?>";
                  console.log(url);
   ...
   $("#verify_app").click(function(e){
         ...
         if(sub_id!=''){
            ...
            var url="<?php echo Yii::app()->createUrl('/frontuser/ajax/forwardApplicationStatus');?>";
            var app_id="<?php echo $data['application_id'];?>";
