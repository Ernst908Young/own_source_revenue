...
<?php
   ...
   echo "<section class='panel'><div style='color:#FFFFFF;font-size:1.8em' class='panel-heading'> <b>Application Name:- ". $app_name['application_name'];
  ...
  <div class="row">
   ...
   <div class='col-md-6'>
	...
	/* 	echo "<pre>";
		...
		$app_sub_id = $data['application_id'];
		//die(5);
		$sqlCreateDate ="select bo_app_verlevel.created_on from bo_application_verification_level bo_app_verlevel left join bo_application_submission as bo_appsub on bo_appsub.submission_id=bo_app_verlevel.app_Sub_id where next_role_id IN ('7','4') and app_Sub_id=$app_sub_id and approv_status='P' and bo_appsub.application_status in ('I','B','H','A','Z','R')";
		...
		if(isset($resArr) && !empty($resArr))
		{
			...
			$after24Hours = date('Y-m-d H:i:s', strtotime($date. ' + 1 days'));
			$currentDate = date('Y-m-d H:i:s');
			if(strtotime($currentDate) > strtotime($after24Hours))
			{
			?>
				<div class='col-md-6'>
					<div class='form-group'>
   ...
   $('#revert_back_prev_level').click(function(e){
      ...
      if(sub_id!=''){
		...
		?>
		  ...
		  var data={"sub_id":sub_id,"comments":comments,"reason_for_delay":reason};
		  jQuery.ajax({
			 url: url,
			 type: 'POST',
			 dataType: 'json',
