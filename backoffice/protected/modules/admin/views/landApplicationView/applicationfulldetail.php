			...
			<div class='form-group'>
				...
				if(!empty($rolesAccess)){
					...
					foreach ($rolesAccess as $rolesAccess) {
						...
						if($data['application_id']==8){   
														echo "&nbsp;<a class='btn btn-warning' target='_blank' href='".Yii::app()->createAbsoluteUrl('admin/ApplicationView/evaluateMarksForm/app_sub_id/'.base64_encode($data['submission_id']))."'> Evaluate Criteria </a>";
													  }
					}
