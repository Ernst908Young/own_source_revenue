...
$userData = UserExt::getUserDistDept($_SESSION['uid']);
$district_id = $userData['disctrict_id'];
//echo '<pre>'; print_r($_SESSION); print_r($userData);
...
where bac.landrigion_id	 = $district_id
...
$sql="SELECT * FROM bo_district WHERE district_id='$district_id'";
$connection=Yii::app()->db;
$command=$connection->createCommand($sql);
...
ds.district_id='".$district_id."' and g.grievance_status IN ('O','C')
...
LEFT JOIN bo_application_submission as bac ON bac.submission_id=bo_application_forward_level.app_Sub_id
LEFT JOIN bo_district as bd ON bd.district_id=bac.landrigion_id
where bac.landrigion_id = $district_id  AND bac.application_status in('F') 
   ...
   <div class="page-bar">
      <ul class="page-breadcrumb">
         <li>
                     ...
                     <?php if(DefaultUtility::isHODNodal()){ echo "Welcome to Department Monitoring Panel"." - ".$dept['department_name']; } if(DefaultUtility::isSECRETARY()){ echo "Welcome to Secretariat Monitoring Panel"." - ".$dept['department_name']; } ?> </b>
         </li>
      </ul>
   ...
   <?php for($i=$pp;$i<$yyy;$i++){ $j=$i+1; $k=$i.'-'.$j; ?>
    ...
    <?php } ?>
      ...
      <div class="page-bar alert-info">
         ...
         <li>
         <h3><b>TOTAL CAF FORWARDED TO DISTRICT : <?php echo $allprocessed+$allpending+$stateProcessedCAF+$statePendingCAF+$districtProcessedWithoutResponseCAF+$stateProcessedWithoutResponseCAF; ?></b></h3>
         </li>
      </ul>
          </div>
    ...
    <div class="row">
                                    ...
                                    <div class="portlet-title" style="display:none;">
                                        <div class="caption" style="width:100%;text-align: center;">
                                            <span class="caption-subject font-dark bold uppercase text-center">
                                                <a href="/backoffice/mis/hodreport/districtwisenodalcafreport/fID/<?=$financial_year?>">
                                         Total District Level CAF </b>: <?php echo $allprocessed+$allpending+$districtProcessedWithoutResponseCAF; ?></b>
                                            </a> 
                                            </span>
                                        </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
           <a class="dashboard-stat dashboard-stat-v2 blue" href="/backoffice/mis/hodreport/disposeddistrict?financial_year=<?=$financial_year?>">
                <div class="visual">
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="/backoffice/mis/CsReport/districtdisposedwithoutcomment/fID/<?=$financial_year?>">
                <div class="visual">
                    <i class="fa fa-shopping-cart"></i>
                </div>
                <div class="details">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
          <a class="dashboard-stat dashboard-stat-v2 grey" href="/backoffice/mis/boApplicationSubmission/pendencyreporthodunderprocess/days/0/daysto/15/bw/<?=$financial_year?>">
                <div class="visual">
                ...
                <div class="details">
                    ...
                    <div class="desc">Under Process CAF  </div>
                </div>
            </a>
        </div>
		 <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
          <a class="dashboard-stat dashboard-stat-v2 red" href="/backoffice/mis/boApplicationSubmission/PendencyreportHod/days/16/daysto/10000/bw/<?=$financial_year?>">
                <div class="visual">
                    <i class="fa fa-bar-chart-o"></i>
                </div>
                <div class="details">
...
<!-------------------------------------------------------------Service Report---------------------------------------------------------------------------->
 <div class="page-bar alert-info" style="display:;">
  <style>
 a:hover {
color:#0000FF;
}
          ...
          <ul class="page-breadcrumb " style="text-align:center;width:100%;">
         <li>
         <h3><b><a href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/T/d1/<?=$startdate?>/d2/<?=$enddate?>">SERVICE REPORT : <?php echo $totalServ; ?></a> </b></h3>
         </li>
      </ul>
          </div>
 <div class="row" style="display:;">
        <style type="text/css">
    .col-lg-2{ width: 16.6% !important;}
    </style>
        <div class="portlet light bordered col-md-12">
                                    ...
                                    <div class="portlet-body">
											...
											<div class="col-lg-2 col-md-2">
                                               <a class="dashboard-stat dashboard-stat-v2 blue" href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/T/d1/<?=$startdate?>/d2/<?=$enddate?>">
                                                    <div class="visual">
                                                        <i class="fa fa-comments"></i>
                                                    </div>
                                                    <div class="details">
                                                        <div class="number"><b><?php echo $services_count; ?></b>
                                                        </div>
                                                        <div class="desc"><b>Integrated Services</b></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                               <a class="dashboard-stat dashboard-stat-v2 yellow" href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/P/d1/<?=$startdate?>/d2/<?=$enddate?>">
                                                    <div class="visual">
                                                        <i class="fa fa-comments"></i>
                                                    </div>
                                                    <div class="details">
                                                        <div class="number"> <?php echo $pendServ; ?>
                                                            <!--<span data-counter="counterup" data-value=""></span>-->
                                                        </div>
											...
											<div class="col-lg-2 col-md-2">
                                               <a class="dashboard-stat dashboard-stat-v2 grey" href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/F/d1/<?=$startdate?>/d2/<?=$enddate?>">
                                                    <div class="visual">
                                                        <i class="fa fa-comments"></i>
                                                    </div>
                                                    <div class="details">
                                                        <div class="number"> <?php echo $fordServ; ?>
                                                            <!--<span data-counter="counterup" data-value=""></span>-->
                                                        </div>
                                                        <div class="desc">Forwarded</div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                               <a class="dashboard-stat dashboard-stat-v2 green" href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/RBI/d1/<?=$startdate?>/d2/<?=$enddate?>">
                                                    <div class="visual">
                                                        <i class="fa fa-comments"></i>
                                                    </div>
                                                    <div class="details">
                                                        <div class="number"> <?php echo $reveServ; ?>
                                                            <!--<span data-counter="counterup" data-value=""></span>-->
                                                        </div>
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                               <a class="dashboard-stat dashboard-stat-v2 red" href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/R/d1/<?=$startdate?>/d2/<?=$enddate?>">
                                                    <div class="visual">
                                                        <i class="fa fa-comments"></i>
                                                    </div>
                                                    <div class="details">
                                                        <div class="number"> <?php echo $rejServ; ?>
                                                            <!--<span data-counter="counterup" data-value=""></span>-->
                                                        </div>
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                               <a class="dashboard-stat dashboard-stat-v2 purple" href="/backoffice/mis/ServiceReport/index/d/<?=$_SESSION['dept_id']?>/s/A/d1/<?=$startdate?>/d2/<?=$enddate?>">
                                                    <div class="visual">
                                                        <i class="fa fa-comments"></i>
                                                    </div>
                                                    <div class="details">
                                                        <div class="number"> <?php echo $appServ; ?>
                                                            <!--<span data-counter="counterup" data-value=""></span>-->
                                                        </div>
...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------->
  <div class="page-bar alert-info">
          <ul class="page-breadcrumb " style="text-align:center;width:100%;">
         <li>
         <h3><b><a href="/backoffice/mis/GrievanceReport/hodindex/d/<?=$_SESSION['dept_id']?>/s/T/d1/<?=$startdate?>/d2/<?=$enddate?>">TOTAL GRIEVANCE : <?php echo @$grandtotal; ?></a> </b></h3> 
         </li>
      </ul>
          </div>
    ...
    <div class="row">
       ...
       <div class="portlet light bordered col-md-6">
           ...
           <a class="dashboard-stat dashboard-stat-v2 blue" href="/backoffice/mis/GrievanceReport/hodindex/d/<?=$_SESSION['dept_id']?>/s/C/d1/<?=$startdate?>/d2/<?=$enddate?>">
                <div class="visual">
                    <i class="fa fa-comments"></i>
                </div>
			 ...
			 <div class="portlet light bordered col-md-6"> 
             <div class="col-lg-12 col-md-12 col-sm-16 col-xs-32" >
           <a class="dashboard-stat dashboard-stat-v2 red" href="/backoffice/mis/GrievanceReport/hodindex/d/<?=$_SESSION['dept_id']?>/s/O/d1/<?=$startdate?>/d2/<?=$enddate?>">
                <div class="visual">
                    <i class="fa fa-comments"></i>
                </div>
                <div class="details" style="right: 0px;width: 100%;">
