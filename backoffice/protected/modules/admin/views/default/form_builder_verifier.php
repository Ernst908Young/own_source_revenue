...
<table class='table table-striped table-bordered' id='sample_2'>
	...
	?>      <tr>
				...
				<td  class="a_cent" title="<?php echo $val['serviceID']?>"> <?php echo $val['submission_id']?></td>
				<td class="l_cent"><?php echo $val['core_service_name'].' '.$formName?> <br>
				<b>SLA : 90 Days </b>
				</td>
...
//$district_id = $_SESSION['district_id'];
 $sql="SELECT 
	...
	";
	/*bo_district.distric_name as District, INNER JOIN bo_district ON bo_district.district_id=bo_new_application_submission.landrigion_id
	bo_infowiz_formbuilder_application_forward_level.approv_status='V' 
	AND INNER JOIN bo_infowiz_form_builder_configuration ON bo_infowiz_form_builder_configuration.service_id=bo_new_application_submission.service_id */
	/*AND bo_infowiz_formbuilder_application_forward_level.next_role_id = $role_id AND bo_infowiz_form_builder_configuration.current_role_id=$role_id*/
	//AND bo_new_application_submission.landrigion_id=$disctrict_id
	$connection=Yii::app()->db; 
	$command=$connection->createCommand($sql);
...
<div class='portlet box green'>
	<div class='portlet-title'>
		<div class='caption'>
			<i style=" font-size:20px;" class='fa fa-users'></i>Forwarded Applications (<?php echo count($res2);?>)</div>
		<div class='tools'> 
...
<table class='table table-striped table-bordered' id='sample_1'>
	...
	?>      <tr>
				<td class="a_cent"><?php echo $key+1;?></td>
				<td  class="a_cent" title="<?php echo $val['serviceID']?>"> 
