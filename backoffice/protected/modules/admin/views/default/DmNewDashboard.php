...
and gd.district_id='$district_id' AND g.grievence_created_on >='".$startdate."' and g.grievence_created_on <'".$enddate."' ";     
		$connection=Yii::app()->db; 
...
<!-- BEGIN CONTENT BODY -->
   <div class="fixed-condition-elements">
	...
	<div class="fixed-condition-element1 dashboard-welcome">
		<h2>Welcome to DM Panel - Uttarakhand</h2>
			...
			<div class="page-bar">
				<form name="form" action="" method="POST" >
					<table>
						<tr>
							<td>	
								<b>Currently you are viewing data for "<?php echo $financial_year; ?>" ,If you want to change then select Financial Year : </b>
							&nbsp;&nbsp;</td>
							<td>
	...
	<div class="panel-body">
		<div class="table">
			<div class="" style="margin:0px">
				<ul class="page-breadcrumb " style="text-align:center;width:100%;">
					<li>
					<h3 style="font-size:18px; color:#343434; margin-bottom:20px;"><b>OVERALL CAF (<?php echo $allprocessed+$allpending+$districtProcessedWithoutResponseCAF; ?>)</b></h3> 
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="portlet light bordered col-md-12">
			<div class="col-xs-12 col-sm-6 col-md-3 text-center">
				<a href="/backoffice/mis/psCsReport/disposedCafDistrictLevel?financial_year=<?=$financial_year?>&did=<?php echo $district_id; ?>">				
					<div class="round-stats blue">
						<h3 class="number"> <?=$allprocessed?></h3>
					</div>
					<div><p class="circle_desc">CAF Disposed with Response</p></div>
				</a>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-3 text-center">
				<a href="/backoffice/mis/psCsReport/disposedCafWithoutCommentDistrictLevel/fID/<?=$financial_year?>?did=<?php echo $district_id; ?>">				
					<div class="round-stats blue">
			...
			<div class="col-xs-12 col-sm-6 col-md-3 text-center">				
				<a href="/backoffice/mis/psCsReport/pendingDistrictLevel/days/0/daysto/15/bw/<?=$financial_year?>?did=<?php echo $district_id; ?>">				
					<div class="round-stats blue">
						<h3 class="number">
			...
			<div class="col-xs-12 col-sm-6 col-md-3 text-center">				
				<a href="/backoffice/mis/psCsReport/pendingDistrictLevel/days/16/daysto/10000/bw/<?=$financial_year?>?did=<?php echo $district_id; ?>">				
					<div class="round-stats blue">
					<h3 class="number">
					<?=$districtpendingCAF?>
					<!-- <span data-counter="counterup" data-value=""></span>-->
	...
	<section class="panel">	
		...
		<div class="table">
			<div class="" style="margin:0px">
				<ul class="page-breadcrumb " style="text-align:center;width:100%;">
					<li>
					<h3 style="font-size:18px; color:#343434; margin-bottom:20px;"><a href="/backoffice/mis/GrievanceReport/psindex/s/T/d1/<?=$startdate?>/d2/<?=$enddate?>?did=<?php echo $district_id; ?>"><b>TOTAL GRIEVANCE : <?php echo @$grandtotal; ?> </b></a></h3>
					</li>
				</ul>
			</div>
		</div>
    ...
    <div>      
		<div class="col-xs-12 col-sm-6 text-center">
			<div class="portlet light bordered">
				<a href="/backoffice/mis/GrievanceReport/psindex/s/C/d1/<?=$startdate?>/d2/<?=$enddate?>?did=<?php echo $district_id; ?>">				
				<div class="round-stats blue">
		...
		<div class="col-xs-12 col-sm-6 text-center">
            <div class="portlet light bordered">
			   <a href="/backoffice/mis/GrievanceReport/psindex/s/O/d1/<?=$startdate?>/d2/<?=$enddate?>?did=<?php echo $district_id; ?>">					
					<div class="round-stats blue">
						<h3 class="number" style="text-align:center;"> <?php echo $grandopen;?>
							<!--<span data-counter="counterup" data-value=""></span>-->
						</h3>						
					</div>
			...
			<div class="portlet  light bordered">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold uppercase font-dark">Overall CAF: <?php echo $totalcafall; ?> </span>
...
<script>
 var chart = AmCharts.makeChart("chartdiv", {
  ...
  "theme":"light",
  "dataProvider": [ 
  <?php foreach($pending as $grArr){ ?>
  {
    "title": "Pending - <?=@$grArr['pending']?>",
    "value": <?=@$grArr['pending']?>
  },{
    "title": "Disposed - <?=@$grArr['processed']?>",
    "value": <?=@$grArr['processed']?>
  } <?php } ?>],
  "titleField": "title",
  "valueField": "value",
  "labelRadius": 5,
 ...
 var chart = AmCharts.makeChart("chartdivGrivance", {
  ...
  "theme":"light",
  "dataProvider": [ 
  <?php foreach($resultarr as $grArr){ ?>
  {
    "title": "Open - <?=@$grArr['open']?>",
    "value": <?=@$grArr['open']?>
  },{
    "title": "Close - <?=@$grArr['close']?>",
    "value": <?=@$grArr['close']?>
  } <?php } ?>],
  "titleField": "title",
  "valueField": "value",
