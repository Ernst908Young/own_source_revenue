        ...
        $(document).ready(function() {
			/* jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
				if ( this.context.length ) {
					var jsonResult = $.ajax({
						url: '/backoffice/admin/adminTasks1/getInvestors',
						type:"post",
						data: {"from_date":"<?php echo @$from_date;?>","to_date":"<?php echo @$to_date; ?>","fy_date":"<?php echo @$fy_date;?>"},
					...
					//return {body: jsonResult.responseJSON.data, header: $("#sample_1 thead tr th").map(function() { return this.innerHTML; }).get()};
				}
			} ); */
            var dataTable = $('#sample_1').DataTable( {
                ...
                "ajax":{
                    ...
                    error: function(){
                        $(".sample_1-error").html("");
                        $("#sample_1").append('<tbody class="sample_1-error"><tr><th colspan="9">No data found in the server</th></tr></tbody>');
			...
			$("#dpu").on('click',function(){		
				...
				var dataTable = $('#sample_2').DataTable( {
					...
					"ajax":{
						...
						type: "post",						
						data:{"groupdata":'applicant_email',"from_date":"<?php echo @$from_date;?>","to_date":"<?php echo @$to_date; ?>","fy_date":"<?php echo @$fy_date;?>"},
						error: function(){
							$(".sample_2-error").html("");
			...
			$("#groupdata").on('change',function(){
				...
				var dataTable = $('#sample_2').DataTable( {
					...
					"ajax":{
						url :"/backoffice/admin/adminTasks1/getDeptInvestors2",
						type: "post",
						data:{"groupdata":grouData,"from_date":"<?php echo @$from_date;?>","to_date":"<?php echo @$to_date; ?>","fy_date":"<?php echo @$fy_date;?>"},
						error: function(){
							$(".sample_2-error").html("");
							$("#sample_2").append('<tbody class="sample_2-error"><tr><th colspan="6">No data found in the server</th></tr></tbody>');
							$("#sample_2_processing").css("display","none");
