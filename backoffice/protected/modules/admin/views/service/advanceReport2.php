            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <span id="dept">
                            ...
                            <div class="input-daterange input-group demo-3" id="datepicker">
                                <input type="text" class="input-lg form-control" name="start" autocomplete="off"/>
                                <span class="input-group-addon input-lg">to</span>
                                <input type="text" class="input-lg form-control" name="end" autocomplete="off"/>
                            </div>
                        </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="incidence[]" class="select2-me"  multiple="multiple"  id="incidence">
                ...
                <div class="col-md-12" style="margin-top:15px;">
                    <div class="col-md-6">
                        ...
                        <select class="select2-me" multiple="multiple" name="department[]" id="department">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="select2-me" multiple="multiple" name="service[]" id="service">
                            ...
                            <?php
                            //$allList=InfowizardQuestionMasterExt::getMasterList('bo_information_wizard_additional_sub_service_master','id','sub_service_name'); 
...
// Show hide Date Range / FY
        ...
        $("#department").on('change', function () {
			...
			alert(incedenceValues);
			
            $.ajax({
                type: 'POST',
                url: '/backoffice/admin/service2/GetServicesByDepartment',
        ...
        $("#incidence").on('change', function () {
            ...
            if (incedence != '')
            {
                $.ajax({
                    type: 'POST',
                    url: '/backoffice/admin/service2/GetDepartmentByIncedence',
