...
require_once(Yii::app()->basePath . '/extensions/mpdf-5.7-php7-master/mpdf.php');
...
class Utility {
    ...
    public static function generateHindiPdfApp($content, $name, $dept_id = null) {
        ...
        $fontname = $pdf->addTTFfont(Yii::app()->basePath . '/extensions/tcpdf/tcpdf/fonts/ind_hi_1_001.ttf', 'TrueTypeUnicode', '', 32);


        $pdf->AddFont('ind_hi_1_001', '', 'ind_hi_1_001.php');
        $pdf->SetFont('ind_hi_1_001');

        //$pdf->SetFont('hindi', "", 12,false);
        $params = $pdf->serializeTCPDFtagParameters(array('CODE 39', 'C39', '', '', 80, 30, 0.4, array('position' => 'S', 'border' => true, 'padding' => 4, 'fgcolor' => array(0, 0, 0), 'bgcolor' => array(255, 255, 255), 'text' => true, 'font' => 'helvetica', 'fontsize' => 8, 'stretchtext' => 4), 'N'));
