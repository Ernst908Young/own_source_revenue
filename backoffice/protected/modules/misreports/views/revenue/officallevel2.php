        ...
        <ul class="breadcrumb">
          <li><a href="/backoffice/admin">Home</a></li>
           <li>Reports</li>
            ...
            <li>Official Wise Revenue Report Level 2</li>
          </ul>
...
<div class="form-part bussiness-det">                          
            <h4 class="form-heading">
                 Official Wise Revenue Report Level 2
            </h4>
        <div class="form-row">
         <?php $officerde = Yii::app()->db->createCommand("SELECT * from bo_user where uid = $officer_id")->queryRow(); ?>
        From Date: <strong><?= $from_date ?></strong> | To Date: <strong><?= $to_date ?></strong> | Official: <strong><?= $officerde['full_name'].' '.$officerde['middle_name'].' '.$officerde['last_name'].'-'.$officerde['email']  ?></strong><br>
        <?php 
         $status_count = [];
          $entity_array = [];
                $srn_no_arr=[];
       ...
       foreach ($status_count as $key => $value) {
        ...
        <?php 
            $pdfurl = "/backoffice/misreports/revenue/officiallevel2pdf?from_date=$from_date&to_date=$to_date&officer_id=".$officer_id;
