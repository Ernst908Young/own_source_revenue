...
<div class="form-part bussiness-det">                          
    ...
    <?php 
    $pdfurl = "/backoffice/misreports/timeline/level1pdf?from_date=$from_date&to_date=$to_date";
            ...
            ?>    
              <tr class="ticket-row tableinside text-left" id="<?php echo $key; ?>">
                <td class="text-center">
                 ...
                 <td>
                    <?php $_SESSION['tll1previousurl'] = $_SERVER['REQUEST_URI']; ?>
                     <p><a href="/backoffice/misreports/timeline/level2/otd/reports?service_id=<?php echo $value['service_id'];?>&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date; ?>" style='color:blue;'> <?= $value['core_service_name'] ?></a></p>
