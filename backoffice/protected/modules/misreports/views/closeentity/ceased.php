<title>Ceased business names Report</title>
...
<div class="dashboard-home">
    <div class="applied-status" >
        <ul class="breadcrumb">
          ...
          <li>Reports</li>
          <li>Ceased Business Names Report</li>
          </ul>
...
<div class="form-part bussiness-det">                          
    ...
    <?php 
    $pdfurl = "/backoffice/misreports/closeentity/ceasedpdf?from_date=$from_date&to_date=$to_date";
