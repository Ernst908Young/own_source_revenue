<title>Dissolved business names Report</title>
...
<div class="dashboard-home">
    <div class="applied-status" >
        <ul class="breadcrumb">
          ...
          <li>Reports</li>
          <li>Dissolved Business Names Report</li>
          </ul>
...
<div class="form-part bussiness-det">                          
           ...
           Dissolved Business Names Report
            </h4>
        ...
        <div class="form-row row">
          ...
          <div class="col-lg-3 form-group">
           ...
           <div class="col-lg-6 form-group">
              ...
              <select name="entity[]"  multiple='multiple' placeholder="All Entity Type" class="select2-me" id="entities" labelname="entities">
                    
            <?php
            $entityt_array = ['4.0'=>'Incorporation Of Company','5.0'=>'Non Profit Company','8.0'=>'External Company','9.0'=>'Society'];
              foreach($entityt_array as $k=>$v){ 
               $selects = !empty($entity)  ? (in_array($k, $entity) ? 'selected' : '') : '' ;
                    ?>
    ...
    <?php 
    $pdfurl = "/backoffice/misreports/closeentity/dissolvedpdf?from_date=$from_date&to_date=$to_date";
