...
<div class="dashboard-home">
    <div class="applied-status" >
        <ul class="breadcrumb">
          ...
          <li>Director’s Cross Reference Report</li>
          </ul>
...
<div class="form-part bussiness-det">                          
          ...
          Director’s Cross Reference Report
            </h4>
    ...
    <?php 
    $pdfurl = "/backoffice/misreports/users/directorlevel1pdf?from_date=$from_date&to_date=$to_date";
            ...
            <label>Director Full Name</label>
              <select name="dfn[]"  multiple='multiple' placeholder="All Directors" class="select2-me" id="dfn" labelname="dfn">
                   ...
                   foreach($records_main as $k=>$v){ 
                    $selects = !empty($dfn)  ? (in_array($k, $dfn) ? 'selected' : '') : '' ;
                    ?>
...
<table  id="sample_1" width="100%">
   ...
   <tbody class="ticket-item">
    <?php
     $_SESSION['drpreviousurl'] = $_SERVER['REQUEST_URI']; 
    $n=1;
        foreach ($records_main as $k => $val) { 
if($dfn==NULL || in_array($k, $dfn)){
          ?>
          <tr class="ticket-row tableinside" id="<?php echo $k; ?>">
            ...
            <td  width="30%">
              ...
              <?php
                ...
                $l2 = "/backoffice/misreports/users/directorl2/otd/reports?&from_date=".$from_date."&to_date=".$to_date."&directors='".base64_encode($k)."'";
                foreach ($val as $key=>$value) {
                       $l2.='&entityno[]='.$key;
               }?>

               <p><a href="<?= $l2 ?>" style='color:blue;'>
                 <?= $k ?>
               </a>
