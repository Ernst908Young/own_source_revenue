...
<table id="sample_31" class="table table-striped table-bordered" width="100%">
                            <thead>
                              <tr>
                                ...
                                <th style="width:5%">Date of Issuance</th>
							...
							<tr class="<?php echo $delete_class; ?>">
                                ...
                                <td>
									<?php echo $documents_array['chklist_id']; ?>
									<?php if(!empty($documents_array['prescribed_form_format'])){ ?>
									<br />
										<a href="<?php echo $documents_array['prescribed_form_format']; ?>" target="blank" title="Prescribed form/ format">
                                ...
                                <td><?php echo $documents_array['document_version_type'].$documents_array['document_version']; ?></td>
								 <td><?php echo ($documents_array['doc_date_of_issuance']!='0000-00-00') ? $documents_array['doc_date_of_issuance']: " "; ?></td>
                                <td>
