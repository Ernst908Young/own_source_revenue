...
/**
 * This is the model class for table "bo_new_application_submission".
 *
 * The followings are the available columns in table 'bo_new_application_submission':
...
class NewApplicationSubmission extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, dept_id,name_related_srn,agent_entry,agent_user_id', 'numerical', 'integerOnly'=>true),
			array('service_id', 'length', 'max'=>20),
			array('application_status', 'length', 'max'=>4),
			array('ip_address, user_agent,entity_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('submission_id,service_id, user_id, dept_id, field_value, application_status, application_created_date, application_updated_date_time, ip_address, user_agent,kml_path,landrigion_id', 'safe', 'on'=>'search'),
		);
	}
