 ...
 */
class InfowizSubformCategory extends CActiveRecord
{
	/**
	...
	{
		return 'bo_infowiz_subform_category';
	}
	...
	public function rules()
	{
		...
		return array(
			array('category_name, category_code,created', 'required'),
			array('category_name', 'length', 'max'=>500),
			array('is_active', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('category_name, created, is_active', 'safe', 'on'=>'search'),
		);
	}
