...
$(document).ready(function(){
	...
	$('#UK-FCL-00189_0,#UK-FCL-00308_0,#UK-FCL-00309_0,#UK-FCL-00310_0').keyup(function(){
        $(this).val($(this).val().toUpperCase());
    });

    $('#UK-FCL-00301_0,#UK-FCL-00105_0,#UK-FCL-00324_0').keyup(function(){
        $(this).val($(this).val().toUpperCase());
    });
...
$("#div_UK-FCL-00187_0").append("<div class='col-md-12 form-group'>Hereby apply to be incorporated as a Board under the provisions of the Charities Act Cap. 243.</div>");
...
$("#UK-FCL-00307_0").on("blur",function(){
		var reg_no = $(this).val();
				...
				$.ajax({
		            type: "POST",
		            dataType:'json',
		            url: "/backoffice/infowizardtwo/subFormRegistrationCharityBoard/getCharityNameByregno/reg_no/" + reg_no,
		            beforeSend:function(){
	...
	$("#UK-FCL-00313_0").on("blur",function(){
		var sreg_no = $(this).val();
				...
				$.ajax({
		            type: "POST",
		            dataType:'json',
		            url: "/backoffice/infowizardtwo/subFormRegistrationCharityBoard/getSocityNameByregno/reg_no/" + sreg_no,
		            beforeSend:function(){
		            ...
		            success: function(result) {		            	
		            	if(result.status==true){		            		
								...
								$("#UK-FCL-00193_0").attr('readonly',true);
								$("#UK-FCL-00194_0").attr('readonly',true);
		            			            			            	
		            	}else{
		            		$("#UK-FCL-00313_0-error").text(result.msg);
		            		// $("#UK-FCL-00193_0").attr('readonly',false);
		            		// $("#UK-FCL-00194_0").attr('readonly',false);
							// $("#UK-FCL-00313_0-error").text("");
							$("#UK-FCL-00193_0").val("");	
		            		$("#UK-FCL-00194_0").val("");
