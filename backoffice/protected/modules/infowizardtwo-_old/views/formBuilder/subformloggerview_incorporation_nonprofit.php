                    ...
                    <div class="form-group col-md-12">
                        <table class="table table-striped table-bordered table-hover responsive-table addmore_tbl  <?php echo $tblID = "tbl_" . $fd['id']; ?>" id="forest_table" style="">
                            <tr>
                                ...
                                ?>
                                <th>Occupation</th>
                                <th>Prominent public office</th>
                                <th>Details of office</th>
                            </tr>
                            <?php
                            $arrofIn = array();
                            if (isset($get_selected_field) && !empty($get_selected_field)) {
                                    ...
                                    if ($fd['id'] == $valued['button_id']) {
                                        ...
                                        if (is_array($arrofIn) && !in_array($valued['button_id'], $arrofIn)) {
                                            ...
                                            if (isset($allData23[$fcode]) && !empty($allData23[$fcode])) {
                                                $faltu = count($allData23[$fcode])/2;

                 $Occupation = array_slice($fieldValues['UK-FCL-00117_0'], -$faltu);
    
                $ppo = array_slice($fieldValues['UK-FCL-00217_0'], -$faltu); 
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (isset($allDataMappedWithButton[$btnID]) && !empty($allDataMappedWithButton[$btnID])) {
                                                            ...
                                                            foreach ($allDataMappedWithButton[$btnID] as $key1 => $datag) {
                                                             ...
                                                             <td>
                                                                <input class="form-control" value=" <?= $Occupation[$k] ?>" title="<?= $Occupation[$k] ?>" readonly>
                                                           
                                                                        
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" value=" <?= $ppo[$k] ?>" title="<?= $ppo[$k] ?>" readonly>
                                                                   
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" value=" <?= $ddo[$k] ?>" title="<?= $ddo[$k] ?>" readonly>
                               ...
                               // if (!in_array($val_arr['chklist_id'], $checkDuplicate)) {
                                 //   $checkDuplicate[] = $val_arr['chklist_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_center"><?php echo $val_arr['name']; ?></td>
                                        <td class="td_center"><?php echo $val_arr['created_on']; ?></td>
                                        <td class="td_center"><span class="label label-<?php echo $status_array_lb[$val_arr['status']]; ?>">  <?php echo $status_array[$val_arr['status']]; ?> </span>                                  </td>
                                        <td class="td_center">
                                            <!-- <a target="_blank" href="<1?php echo FRONT_BASEURL . "themes/backend/mydoc/" . $val_arr['iuid'] . "/" . $val_arr['document_file_name']; ?>" style="color:blue;">View</a> -->
                                        ...
                                        <td class="td_center"><?php echo @$val_arr['usercomment'] ?></td>
                                        <td class="td_center">
                                ...
                                <?php $checkv_or_r++;   ?>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <b>Action By :</b> <?php echo $val_arr['verifier_name']; ?>, <br>
                                                <b>Action Date :</b> <?php echo $val_arr['verified_date_time']; ?>, <br>
            ...
            success: function (data) {
                if (data.status) {
                  /*  window.location = window.location.href
                    ...
                    $("#vri_rej_btn"+divid).html(data.contenttext);
