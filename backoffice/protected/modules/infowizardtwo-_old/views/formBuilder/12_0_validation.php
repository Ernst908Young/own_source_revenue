...
<script type="text/javascript">
 ...
 $(document).ready(function(){
  ...
  // APPOINTMENT DETAILS
    ...
    $("#div_UK-FCL-00105_0").append("<div class='col-md-12' style='margin-top:10px; font-size:12px;'><input type='checkbox' id='middlenamecheckbox' name='middlenamecheckbox' class='group1'> Please confirm that this person does not have a middle name</div>");
    ...
    $("#div_UK-FCL-00316_0").append("<div class='col-md-12' style='margin-top:10px; font-size:12px;'><input type='checkbox' id='middlenamecheckbox_2' name='middlenamecheckbox_2' class='group1'> Please confirm that this person does not have a middle name</div>");
    ...
    $("#div_UK-FCL-00133_0").append("<div class='col-md-12' style='margin-top:10px; font-size:12px;'><input type='checkbox' id='middlenamecheckbox_3' name='middlenamecheckbox_3' class='group1'> Please confirm that this person does not have a middle name</div>");
