                               ...
                               // if (!in_array($val_arr['chklist_id'], $checkDuplicate)) {
                                 //   $checkDuplicate[] = $val_arr['chklist_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_center"><a target="_blank" href="/backoffice/doc/mydoc?view=<?php echo DefaultUtility::getDockey($val_arr['document_file_name']); ?>"style="color:blue;">View</a>
                                        </td>
