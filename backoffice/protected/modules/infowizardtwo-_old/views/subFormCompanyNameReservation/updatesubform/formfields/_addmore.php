...
<div class="col-md-12" id="div_<?php echo $tablefieldname;?>">
		...
		(Please click on the button "+Save Detail(s)" to capture details provided above in tabular form)</span>
	</div>
			...
			{	
				...
				<?php if($btnCoin==1){ ?>
					...
					<tr class="add_more_<?php echo $id;?>">
						...
						<td style="text-align:center;"><a class="btn btn-danger del_1" pi="add_more_<?php echo $id;?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
					</tr>
				<?php 
					} 
				}
