...
$this->renderPartial('updatesubform/formfields/_text_number_password_email_url',['fd'=>$fd,'inputType'=>$inputType,'maxLength'=>$maxLength,'minLength'=>$minLength,'val_cls'=>$val_cls,'id'=>$id,'button_id'=>$button_id,'addMoreLineCheck'=>$addMoreLineCheck,'classEditOrNot'=>$classEditOrNot,'fieldValues'=>$fieldValues,'pattern'=>$pattern]); 
