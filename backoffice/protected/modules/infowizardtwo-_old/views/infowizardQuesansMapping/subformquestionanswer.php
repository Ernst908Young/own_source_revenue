...
<form name="" action="" method="POST">
           <?php
            if(empty($apps)){
             ...
             <tr><td colspan="8">Q<?php echo $apps['question_id']; ?>&nbsp;&nbsp;&nbsp;<?php $question=InfowizardQuesansMappingController::getListofQuestion($apps['question_id']); 
			 echo $question['name'];?> 
			 </td></tr>                        
                    </thead>
					<tr><th></th></tr>
      ...
      <?php $rrr=InfowizardQuesansMappingController::getDetailOfQuesAns($apps['question_id']); 
	   $countno=1;
              ...
              <tr>  
              <td align="left" ><input type="checkbox" name="chkboxservice[]" value="<?php echo $apps['question_id'].','.$ans['queans_mapp_id']; ?>" />&nbsp;&nbsp;&nbsp;
			  <?php echo $ans['priority']; ?>
