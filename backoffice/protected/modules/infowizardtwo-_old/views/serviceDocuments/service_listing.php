...
<div class="row" style="margin:10px 0 10px 0;">
	...
	<div class="col-lg-4">	
	<select name="issuerby_id" class="form-control" onchange="window.location='/backoffice/infowizard/serviceDocuments/listing/id/'+this.value">
  ...
  <div class="panel-body">
	...
	<table class="table table-striped table-bordered table-hover" width="100%">
							...
							<td>-- <a onclick="openDMSPopup('<?php echo $service_id;?>','<?php echo $sub_service_id;?>')">Docs</a><?php //echo '<pre>'; print_r($mapped_docs); ?></td>
                                                        <td><?php if(!empty($data_arr['document_checklist_upload'])){ ?><a target="_blank" href="<?php echo $data_arr['document_checklist_upload']; ?>">Yes</a><?php }else{ echo "No";} ?></td>
							<td>
							<?php
							if($online_flag == 1){
							...
							<input type="file" name="file" > <br>
                                                        <input type="submit" name="submit" class="btn btn-danger" value="Upload New" >    <?php if(!empty($data_arr['document_checklist_upload'])){ ?><a class="btn btn-primary" target="_blank" href="<?php echo $data_arr['document_checklist_upload']; ?>"><i class="fa fa-file"></i></a><?php } ?>
                                                        
							</form>
							</td>
							<td>
                                                             <?php if(!empty($data_arr['statutory_form_upload'])){ ?><a href="<?php echo $data_arr['statutory_form_upload']; ?>" target="_blank" >Yes</a><?php }else{ echo "No";} ?>
                                                            </td>
							<td>
							...
							<input type="file" name="file" > <br>
							  <input type="submit" name="submit" class="btn btn-danger" value="Upload New" >    <?php if(!empty($data_arr['statutory_form_upload'])){ ?><a class="btn btn-primary" href="<?php echo $data_arr['statutory_form_upload']; ?>" target="_blank"><i class="fa fa-file"></i></a><?php } ?>
							...
							<td><?php 
                                                            ...
                                                            <?php if(!empty($res_f[0])){ if(!empty($res_f[0]['upload_fee_structure'])){ ?><a target="_blank" href="<?php echo $res_f[0]['upload_fee_structure']; ?>" target="_blank">Yes</a><?php }else{echo "No";} }else{echo "No";} ?></td>
							<td>
							...
							<input type="file" name="file" > <br>
                                                          <input type="submit" name="submit" class="btn btn-danger" value="Upload New" >    <?php if(!empty($res_f[0])){ if(!empty($res_f[0]['upload_fee_structure'])){ ?><a target="_blank" class="btn btn-primary" href="<?php echo $res_f[0]['upload_fee_structure']; ?>"><i class="fa fa-file"></i></a><?php } } ?>
                                                       
							</form>
							</td>
							
                                                        <td><?php if(!empty($data_arr['sop'])){ ?><a href="<?php echo $data_arr['sop']; ?>" target="_blank">Yes</a><?php }else{echo "No";} ?></td>
							<td>
							...
							<input type="file" name="file" > <br>
							  <input type="submit" name="submit" class="btn btn-danger" value="Upload New" >    <?php if(!empty($data_arr['sop'])){ ?><a target="_blank" class="btn btn-primary" href="<?php echo $data_arr['sop']; ?>"><i class="fa fa-file"></i></a><?php } ?>
                                                       
							</form>
							</td>
							 <td><?php if(!empty($data_arr['statutory_timeline_upload'])){ ?><a href="<?php echo $data_arr['statutory_timeline_upload']; ?>">Yes</a><?php }else{echo "No";} ?></td>
							<td>
							 <form action='<?=$this->createUrl("/infowizard/serviceParameters/uploadDocs/serivceID/$service_id/subServiceID/$sub_service_id/uploadFor/statutory_timeline_upload/docName/timeline/location/services");?>' method="post" enctype="multipart/form-data">
							<input type="file" name="file" > <br>
							  <input type="submit" name="submit" class="btn btn-danger" value="Upload New" >    <?php if(!empty($data_arr['statutory_timeline_upload'])){ ?><a class="btn btn-primary" href="<?php echo $data_arr['statutory_timeline_upload']; ?>"><i class="fa fa-file"></i></a><?php } ?>
