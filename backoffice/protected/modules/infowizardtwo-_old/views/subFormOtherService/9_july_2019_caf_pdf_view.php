	...
	<table  cellspacing="0" width="100%" cellpadding="2" style="padding-top:10px;" class="gridtable">
		...
		<?php	}
				...
				if(!in_array($fd['id'], $btnArray)){
					...
					$keyy = $keyy + 1; 
					$allTypes=array("text","number","password","email");
					...
					?>
						<td>
							<strong><?php echo $formName = InfowizardQuestionMasterExt::getMasterName('bo_infowizard_formvariable_master', $fd['form_field_id'], 'name', 'formvar_id');?> (<?php echo $tablefieldname;?>):</strong>
							<br/>
							<?php 
											...
											?>
												<tr>
													...
													?> 
														...
														<?php if(isset($datag)){ if(is_array($allData23[$datag])){ echo @$allData23[$datag][$k]; }else{echo $allData23[$datag];}} ?>
														</td>
												<?php 
													} 
												?>
