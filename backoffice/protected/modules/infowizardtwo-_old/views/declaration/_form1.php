...
<!--<div class="row">
	<div class="dt-buttons" style="margin-bottom: 10px; float:right; margin-right:15px" >
	   <a class="btn btn-success" tabindex="0" href="<1?=$this->createUrl('/infowizard/formCategory/index/')?>"><span>Form Category List</span></a>
	</div>  -->
</div>
<div class='portlet box green'>
<div class='portlet-title'>
    <div class='caption'>
        <i style=" font-size:20px;" class='fa fa-list'></i>Update Declaration </div>
    <div class='tools'>
