...
$ListOfProfessionalBody=ProfessionalMasterController::getAllBodyOfIssuer(7);
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group col-md-6">
			<label class="col-lg-4 col-sm-4 control-label" for="professional_name"><?php echo $form->labelEx($model,'professional_name'); ?></label>
			<div class="col-md-8">
		
		<?php echo $form->textField($model,'professional_name',array('size'=>60,'maxlength'=>255,'class'=>'form-control')); ?>
		<?php echo $form->error($model,'professional_name'); ?>
	</div>
	</div>
	</div>
<div class="row">
...
<div class="row">
	<div class="form-group col-md-6">
   	...
   	<?php echo $form->dropDownList($model,'is_active',array('Y','N'),array('size'=>1,'maxlength'=>1,'class'=>'form_control')); ?>
