        ...
        <table id="sample_2" width="100%">
            <thead>
                <tr>
                    ...
                    <th  class="text-center">Time taken<br>by Applicant</th>
                    <th  class="text-center">Time taken<br>by Department</th>
                </tr>
            </thead>
              ...
              echo "No Status";
                                ...
                                switch ($appsgf) {
                                    case "A":
                                        ...
                                        break;
                                    case "B":
                                        echo "<td class='text-center'> <span  class='label label'> Payment</span></td>";
                                        break;
                                    case "P":
                                        echo "<td class='text-center'> <span class='label label-primary'> Pending</span></td>";
                                        break;
                                    case "F":
                                        echo "<td class='text-center'> <span style='background-color:#F7CA18' class='label label-share'> Forward</span></td>";
                                        break;
                                    case "V":
                                        echo "<td class='text-center'> <span class='label label-warning'> Verified</span></td>";
                                        break;
                                    case "RBI":
                                        echo "<td class='text-center'> <span class='label label-info'> Reverted</span></td>";
                                        break;
                                    case "H":
                                        echo "<td class='text-center'> <span class='label label-info'>  Reverted</span></td>";
                                        break;  
                                    case "R":
                                        echo "<td class='text-center'> <span class='label label-danger'>  Rejected</span></td>";
                                        break;
                                    case "PD":
                                        echo "<td class='text-center'> <span class='label label-danger'>  Payment Pending</span></td>";
                                        break;  
                                     case "FA":
                                        echo "<td class='text-center'> <span style='background-color:#F7CA18' class='label label-share'>  Forward</span></td>";
                                        break;      
                                    case "DP":
                                        echo "<td class='text-center'> <span class='label label-danger'> Document Pending</span></td>";
                                        break;  
                                    case "PA":
                                        echo "<td class='text-center'> <span class='label label-info'>Provisionally Approved</span></td>";
                                        break;  
                                    case "W":
                                        echo "<td class='text-center'> <span class='label label-info'> Withdrawn</span></td>";
                                        break;  
                                    default:
                                        echo "<td class='text-center'> <span class='label label-default'>No Status</span></td>";
                                }
                                ?-->                                
                                <td class='text-center'>
