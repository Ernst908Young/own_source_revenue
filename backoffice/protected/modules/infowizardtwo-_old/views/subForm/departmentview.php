...
?>
<style>
.a_cent{ text-align:center !important; vertical-align:middle !important;}
	...
	<div class="portlet box green">
		<div class="portlet-title">
			<div class="caption"><?php echo $get_form_name['form_name'];  ?></div>
                        <div class="tools"> <a href="<?php echo BASE_URL ?>/backoffice/infowizard/subForm/downloadNewApp/service_id/616.0/pageID/1/subID/<?php echo $submittion_id;?>/formCodeID/1" target="blank" class="btn btn-primary" style="height: 33px;">Print Application</a></div>
		</div>
		<div class="portlet-body">
			<table class="table table-striped table-bordered table-hover">						
				<tr>
					<td class="a_cent"><strong style="color: #333;">Investor Name:</strong> <?php echo $invData['first_name']." ".$invData['last_name']; ?></td>
					<td class="a_cent"><strong style="color: #333;">IUID:</strong> <?php echo $invData['iuid']; ?></td>	
				</tr>
				<tr>
  ...
  print_r($dept_pend1); die; */
			...
			foreach($array_check as $key=>$vall)
			{
				...
				if($flg==0)
				{
					...
					<tr>
						...
						<td class="a_cent"><?php if(!empty($vall['investor_log_id'])) echo @$timetaken; ?></td>
						<td class="a_cent"><?php if(empty($vall['investor_log_id']))echo @$ntimetaken; ?></td>
		...
		<?php $i++;$tcount++;
	 	...
	 	<?php } ?>
			...
			{
			?>
			<form class="form form-horizontal" id="abeyance_form" method="POST" enctype= "multipart/form-data" action="<?php echo Yii::app()->createAbsoluteUrl("/infowizard/subForm/processData"); ?>">
				<table class="table table-striped table-bordered table-hover">					
					...
					<tr>
						<td class="a_cent"><span style="text-align:center;vertical-align:middle;">Comment: </span></td>
						<td class="a_cent"><textarea name="UK-FCL-00181_2" id="UK-FCL-00181_2" class="form-control comment" row="2"></textarea></td>
					</tr>
    ...
    $(document).ready(function () {
		...
		$('.btn_view').on('click',function(){
			...
			$.ajax({
				...
				url: "<?php echo Yii::app()->request->baseUrl; ?>/infowizard/formFieldMaster/getFormHtml",
