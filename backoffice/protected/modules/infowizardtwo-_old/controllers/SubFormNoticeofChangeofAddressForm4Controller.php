...
//END CODE  BY:- Aamir Date :- 19-08-2021  
    ...
    public function actionGetCompanyNameByregno(){
        ...
        $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE company_type IN('NPC','IC') AND reg_no='".$reg_no."'")->queryRow();
        ...
        if($c_detail){         
                  echo CJavaScript::jsonEncode(
                    array('status'=>true,
							...
							// 'parish'=>$c_detail['state_parish_id'],
							// 'postal_code'=>$c_detail['postal_code_id'],
...
// jitendra singh
   ...
   static function alignInSequence($serviceID = null, $formCodeID = null) {
    ...
    public function actionDownloadNewApp() {
        ...
        //echo $content; die;
        Utility14_0::generatePdfApp($content, $name);
        exit;
    }
