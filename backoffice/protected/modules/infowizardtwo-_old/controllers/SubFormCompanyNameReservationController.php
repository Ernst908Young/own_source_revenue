          ...
          /*  echo "<pre>";
            ...
            if ($_POST['app_status'] == 'A') {
                ...
                if($_POST['service_id'] == '2.0' && $newAppSubArr['UK-FCL-00044_0']==3) {
					...
					$download_certificate_call_back_url1 = CURL_URL."/backoffice/infowizardtwo/subFormPdf/SaveNewApprovalCertificate2_0/service_id/" . base64_encode($_POST['service_id']) . "/subID/" . base64_encode($_POST['app_Sub_id']) . "/dept_id/" . base64_encode($dept_id).'/reg_no/'.base64_encode($reg_no).'/uname/'.base64_encode($username);
				...
				if($_POST['service_id'] == '2.0' && isset($newAppSubArr['UK-FCL-00044_0']) && $newAppSubArr['UK-FCL-00044_0']==2 && isset($newAppSubArr['UK-FCL-00492_0']) && $newAppSubArr['UK-FCL-00492_0']==1) 
				{
					$data = '';
					$path = '';
					$name = "CERTIFICATE_" . $app_Sub_id . ".pdf";
				...
				if($_POST['service_id'] == '2.0' && $newAppSubArr['UK-FCL-00032_0']=='3' && $newAppSubArr['UK-FCL-00044_0']=='2') 
				{
					...
					$username = 'TAMIESHA ROCHESTER';
						...
						echo "<br/>";
						echo $_POST['app_Sub_id'];
						echo "<br/>";
						echo $recomend[0];
						echo "<br/>";
						echo $_POST['UK-FCL-00019_0'];
						echo "<br/>";
						echo $username;
						echo "<br/>";
						 */
...
// jitendra singh
    ...
    public function actionDownloadNewApp() {
        ...
        $content = $this->renderPartial('app_pdf_view', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date'], 'getApprovedName'=>$getApprovedName), true);
