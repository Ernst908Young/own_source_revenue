...
//End Entity Code           
			...
			{   			
                ...
                Yii::app()->user->setFlash('success', "Application details saved");
    ...
    public function actionGetCompanyNameByregno(){
        ...
        $c_detail = Yii::app()->db->createCommand("SELECT * from bo_company_details WHERE company_type = 'S' AND reg_no='".$reg_no."'")->queryRow();
        if($c_detail){         
...
// jitendra singh
    ...
    public function actionDownloadNewApp() {
        ...
        //echo $content; die;
        Utility12_0::generatePdfApp($content, $name);
        exit;
    }
