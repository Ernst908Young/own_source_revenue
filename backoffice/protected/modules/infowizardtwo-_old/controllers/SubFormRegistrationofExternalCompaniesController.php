...
// jitendra singh
    ...
    public function actionDownloadNewApp() {
        ...
        $content = $this->renderPartial('company_name_pdf_view', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
         $contentform_30pdf = $this->renderPartial('form_30pdf', array('aap' => $allActivePages, 'formData' => $formData, 'fieldValues' => $fieldValues2, 'app_id' => $fieldValues['submission_id'], 'app_status' => $fieldValues['application_status'], 'application_created_date' => $fieldValues['application_created_date']), true);
        
        $name = "CAIPO-Application_Form_" . time() . ".pdf";

        //echo $content; die;
        Utility8_0::generatePdfApp($content,$contentform_30pdf , $name);
        exit;
    }
