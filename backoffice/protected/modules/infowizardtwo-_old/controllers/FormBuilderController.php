...
class FormBuilderController extends Controller {
   ...
   /* public function actionSubform() {
	...
	public function actionSubform() {
			...
			if(isset($user_id) && !empty($user_id))
			{
				...
				$resultData = $command->queryRow();
					...
					if(!empty($resultData) && (($resultData['application_status']=='I') || ($resultData['application_status']=='DP'))){
						...
						$this->redirect("/backoffice/infowizardtwo/$ser_controller_action_path/updateSubForm/service_id/$_GET[service_id]/pageID/$_GET[pageID]/subID/$resultData[submission_id]/formCodeID/$_GET[formCodeID]");
					}			
		...
		/* echo "<pre>";
		print_r($formData_new);die(); */
        $this->render('subform', array('aap' => $allActivePages, 'formData' => $formData_new,'serviceID'=>$_GET['service_id'],'issuer_id'=>@$_POST['issuer_id'],'field_value'=>$field_value,'postedData'=>@$_POST));
    }
