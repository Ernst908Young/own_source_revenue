...
$sub_id = isset($_GET['srn_no']) ? base64_decode($_GET['srn_no']) : NULL; ?> <form id="m_form" method="post" action="<?php echo Yii::app()->createAbsoluteUrl("/ticketing/default/index"); ?>" enctype="multipart/form-data">
