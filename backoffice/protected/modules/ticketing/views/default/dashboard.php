...
<div class="site-min-height">
        <div class="dashboard-welcome">
            <h2 class="full-width">
                ...
                <div class="dashboard-inner-hd-right"><a href="/backoffice/ticketing/default/index" class="btn btn-primary" > Create New Ticket</a></div>
...
<div class='portlet box green'>
    <div class='portlet-title'>
        <div class='caption'>
            <i style=" font-size:20px;" class='fa fa-list'></i> Manage Your Tickets
        </div>
        <div class='tools'> </div>
    </div>
    <div class="portlet-body">
        <div class="panel-body">
						...
						if($tickets){
							foreach ($tickets as $key => $val) { ?>                                        
										...
										<tr id="<?php echo $key; ?>">
											...
											<td style="width:10%;text-align:center;"> 
                                                <?php  $status_arr = ['O'=>'Open','RV'=>'Reverted','RS'=>'Resolved','RO'=>'Reopened','C'=>'Closed'];
               echo $status_arr[$val['status']]; ?>
                                            ...
                                            <td style="width:10%;text-align:center;"> 
                                                <?php if($val['filepath']){?>
                                                <a target="_blank" href="<?php echo $val['filepath']  ?>">Document</a>
                                               <?php } ?>
                                            </td>											
											<td style="width:10%;text-align:center;">
