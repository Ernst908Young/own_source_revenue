    ...
    <div class="applied-status">
    	<ul class="breadcrumb">
          <li><a href="/panchayatiraj/backoffice/investor/home/investorWalkthrough">Home</a></li>
           <li><a href="/panchayatiraj/backoffice/profile/default/myaccount">My Account Detail</a></li>
         </li>
        ...
        <h4 class="form-heading">Edit Your Account Details</h4>
        	<form id="editprofile" method="post">
		        <div class="form-row row"> 
		        	...
		        	<input type="hidden" name="user_id" value="<?php echo $profiledetail['user_id'] ?>">
					...
					<div class="col-md-6 form-group mb-3">
		        		...
		        		<input type="number" onblur="checklength($(this).val())" id="mobile" maxlength="10" minlength="10" name="mobile" value="<?= $profiledetail['mobile_number'] ?>" />
		        ...
		        <!-- 	<div class="col-md-6 form-group mb-3">
					...
					<div class="col-md-6 form-group mb-3">
		        		  <label>City</label>
		        		<input type="text" name="city_name" value="<?= $profiledetail['city_name'] ?>" required />
		        	</div>
		        	<div class="col-md-6 form-group mb-3">
		        		  <label>Postal Code</label>
		        		<input type="text" name="pin_code" value="<?= $profiledetail['pin_code'] ?>" required />
		        	</div>
