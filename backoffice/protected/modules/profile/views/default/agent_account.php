...
<div class="reservation-form">
	<div class="form-part bussiness-det">   
        ...
        <div class="form-row row"> 
        	<?php $userdetails = Yii::app()->db->createCommand("SELECT * FROM sso_users WHERE user_id=".$_SESSION['RESPONSE']['agent_user_id'])->queryRow();
...
if(isset($profiledetail['state_name'])){
	$state = Yii::app()->db->createCommand("SELECT lr_id,lr_name from bo_landregion where lr_id='".$profiledetail['state_name']."'")->queryRow(); 
        ...
        <div class="form-row" style="text-align: center;">
        	<div class="col-lg-12">
        		<a href="/backoffice/profile/default/agenteditdetails" title="change password" class="btn-primary">Edit Profile</a>
 			<a href="/backoffice/profile/default/agentchangepassword" title="change password" class="btn-primary">Change Password</a>
