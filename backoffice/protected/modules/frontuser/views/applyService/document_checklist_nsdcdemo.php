		...
		<form action="/backoffice/frontuser/ApplyService/<?php echo $actionUrl; ?>" method="POST" id="skipDms">
			...
			<div class="row buttons" align="center">
				...
				<?php 
					...
					$sqlsp = "Select bo_sp_applications.sno,bo_sp_applications.sp_tag,bo_new_application_submission.dept_id,bo_new_application_submission.user_id,
...
<div id="DocumentManagementNew" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Document Management
</h4>
      </div>
...
<!--<div style="width:50%">
	<div id="continue-and-apply" class="modal" role="dialog">
		<div class="modal-dialog modal-lg">
		  ...
		  <div class="modal-body dms-body">	  
				...
				Do you want to apply for department services?
				</div>
					<br/>
					<br/>
				<div style="text-align:center;">
				<button  id="yes-continue" type="button" class="btn btn-default add-more-record" style="background:#e6e6e6;border-radius: 3px !important;" >Yes</button>		
				<button  id="no-continue" type="button" class="btn btn-default update-more-record" style="margin-left:20px;background:#e6e6e6;border-radius: 3px !important;" >No</button>
				</div>
		  </div>
