...
<?php $_GET['type']='CAF';$cls="CAF";include('/var/www/html/backoffice/themes/swcsNewTheme/views/layouts/pageBarService.php'); ?>
<div class="row">
    <div class="col-md-12">
...
STEP3 3: After adding one row, you are requested to repeat the STEP 1 for adding multiple rows and so on"></i> &nbsp;&nbsp;<span id="empError" style="color:red;font-size:13px;"></span>
												<?php $totalmp = (@$incmplt_fields->no_of_emp_ftotal[0]) + (@$incmplt_fields->no_of_emp_mtotal[0]); ?>
												Total Employee: <input type="text" id="emp_fmtotal" readonly="readonly" style="border:none !important" name="emp_fmtotals" value="<?php  if($totalmp>0){echo @$totalmp;} ?>" />
                                                </h3>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <select class="form-control empfilter" id="domicile">
                                                ...
                                                <div class="row addEmployment"  style="padding-top:10px;">
                                                    <div class="col-md-2" style="text-align:center;"> Skilled <br><input id="empSkilled"  type="text" class=" form-control indemp0"></div> 
                                                    <div class="col-md-2" style="text-align:center;">Unskilled<br><input id="empUnskilled" type="text" class="form-control indemp1"> </div>
                                                    <div class="col-md-2" style="text-align:center;">Supervisory <br><input id="empSupervisory" type="text" class=" form-control indemp2"> </div> 
                                                    <div class="col-md-2" style="text-align:center;">Engineer<input id="empEngineer" type="text" class=" form-control indemp3"> </div>
                                                    <div class="col-md-2" style="text-align:center;">IT Professional<input id="empProfessional" type="text" class=" form-control indemp4"> </div>
                                                    <div class="col-md-2" style="text-align:center;">Management<input id="empManagement" type="text" class="form-control indemp5"> </div>

                                                    <div class="col-md-12 addEmploymentButton" style="margin-top: 10px;margin-right: 10px;"><span class="pull-right"><a href="javascript:void(0)" class="btn btn-success"><i class="fa fa-plus"></i> Add</a></span></div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="table-responsive">
                                                        <table id="<?php echo $domicile = 'diu'; ?>" class="diu categorisedemplyment table table-bordered table-responsive">
                                                            <tr class="diu ">
                                                                <th width="17%" style="text-align:center;vertical-align: middle;">Employment
                                                                </th>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;"> Skilled 
                                                                </td>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;">	Unskilled 
                                                                </td>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;">	Supervisory 
                                                                </td>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;">Engineer 
                                                                </td>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;">IT/ ITES Professional
                                                                </td>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;">Management 
                                                                </td>
                                                                <td width="10%" style="text-align:center;vertical-align: middle;"> Total Employees 
                                                                </td>
                                                                <td width="8%" style="text-align:center;vertical-align: middle;"> Action 
                                                                </td>
                                                            </tr>
                                                            <tr class="diu_m_gen emporg">
                                                                <td>Domiciled In Uttarakhand 
                                                            ...
                                                            <tr style="display:none;">
                                                                ...
                                                                <td>
                                                                    <input type="text"  id="msprvsr0" value="<?= @$incmplt_fields->no_of_emp_msupervisory[0] ?>" name="no_of_emp_msupervisory[]" readonly="readonly">
                                                                    <span class="help-block">
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                    <input type="text"  id="mengg0" value="<?= @$incmplt_fields->no_of_emp_mengineer[0] ?>" name="no_of_emp_mengineer[]" readonly="readonly">
                                                                    <span class="help-block">
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                    <input type="text"  id="mit0" value="<?= @$incmplt_fields->no_of_emp_it_mprofessional[0] ?>" name="no_of_emp_it_mprofessional[]" readonly="readonly">
                                                                    <span class="help-block">
                                                                    </span>
                                                                </td>
                                                                <td>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <form action="<?=Yii::app()->createAbsoluteUrl('frontuser/home/submitCafApplication')?>" style="display: inline" id="finalCAFSubmit" method="post">
                                        <input type="hidden" class="csrftoken" name="YII_CSRF_TOKEN_SUBMIT" value="<?=Yii::app()->getRequest()->getCsrfToken()?>" />

                                 <?php if($flg1>2){ ?>    <button type="submit" class="btn green button-submit btn_submit"> Submit
...
function putValue(from,to){		
	...
	if(totalEmployeeMaleFemale>0){
		$('#emp_fmtotal').val(totalEmployeeMaleFemale);
	}else{
		$('#emp_fmtotal').val("");
	}
}
...
$(document).on('click',"#skill-add-more",function(){
	...
	}else if(skilltotal_popup=='' || skilltotal_popup ==undefined)
	{
		...
		+ "<td style='text-align:center;'><input type='number' id='skilled_total' name='skill_data["+trlen+"]["+parentSkillKey+"][skilled_total]' value="+skilltotal_popup+" class='"+parentSkillKey+" skilltotal form-control' readonly rel='"+parentSkillKey+"'/></td>"
		+"</tr>";
