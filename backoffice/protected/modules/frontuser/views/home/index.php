...
.dashboard-stat.yellow{
 ...
 <div class="portlet-body">
			...
			if(!empty($apps) || !empty($cafApp) || !empty($SpApps) || !empty($offlineApps)){
				...
				if(!empty($apps)){
					foreach ($apps as $app) {
                                           //   if(!empty($apps['application_id']) && $apps['application_id']!=11){		
						$download="NA";
						...
						// echo "<pre>";print_r($app);
							echo "<tr><td><a class='href_link' href='".Yii::app()->createAbsoluteUrl('/mis/boApplicationSubmission/CafTrackingTimeline/application/'.base64_encode($app['submission_id']).'')."'>".$app['submission_id']."</a></td><td>".$app_name['application_name']."</td><td></td><td></td><td>".$dept_name['department_name']."</td>";
