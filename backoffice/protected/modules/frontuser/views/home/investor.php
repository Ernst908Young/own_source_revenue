...
<ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
    ...
    <li class="nav-item start  <?php if($url_now=='/backoffice/frontuser/home/investorWalkthrough') echo 'active';?> open">
        <?php          
    ...
    <li class="nav-item start open <?php if((strpos($url_now, 'service') !== false) || (strpos($url_now, 'Service') !== false)) echo 'active';?>">
        ...
        <ul class="sub-menu">
            <li class="nav-item start open"  <?php if($url_now=='/backoffice/frontuser/home/serviceNew/type/CAF/financial_year/ALL/is/service/') echo 'active';?>>
            ...
            <li class="nav-item start open <?php if($url_now=='/backoffice/frontuser/home/serviceExisting/type/EU/financial_year/ALL/is/service/') echo 'active';?>">
            ...
            <li class="nav-item start open <?php if($url_now=='/backoffice/frontuser/applyServiceCP/ServiceListing') echo 'active';?>">
    ...
    <li class="nav-item start open">
        ...
        <ul class="sub-menu">
            ...
            <li class="nav-item start open">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start open">
                        <a  href="<?php echo FRONT_BASEURL . "query/open.php"; ?>"  class="nav-link nav-toggle">
                    ...
                    <li class="nav-item start open">
                        <a href="/backoffice/frontuser/home/investorWalkthroughLevel2/type/QUERIES/dboard/no" class="nav-link nav-toggle">
                            <i class="fa fa-file"></i>
