...
/**
     ...
     * @author Rahul Kumar 
     */
     public static function GetServiceWiseCount($service_type=null,$status=null,$userID=null){
              $val=1;
        $statusCond ="";   
		if($status=='I'){			
			$statusCond = " AND bo_new_application_submission.application_status IN ('I','DP','PD') ";
		}else{
        ...
        where $service_type=$val 
        AND bosp.is_active='Y' 
        $statusCond
    ...
    public function actionRedirectToServiceProviders() {
		...
		echo $_GET['application_status'];die;
		if(in_array($service_idArr['service_id'],array('49.0')) && in_array($_GET['application_status'],array('I','DP','RBI')))
		{	//LM Services
			$rervetedArray['reverted_call_back_url'] = "/panchayatiraj/backoffice/infowizardtwo/subForm/updateSubForm/service_id/$service_idArr[service_id]/pageID/1/subID/$application_id/formCodeID/1/stype/old";
		}
		
		if(in_array($service_idArr['service_id'],array('2.0')) && in_array($_GET['application_status'],array('PD')))
		{	//LM Services
			$rervetedArray['reverted_call_back_url'] = "/panchayatiraj/backoffice/infowizard/otherServicePayment/UnifiedPayment/service_id/$service_idArr[service_id]/app_id/$application_id"; 	
		}
        ...
        if ($this->isInvestorLoggedIn()) {
            ...
            if ($post['selected_doc_type'] == 'image/jpeg') {
                ...
                if (!in_array($_FILES['caf_applications_uploads']['type'], $jpgArray)) {
                    ...
                    $this->redirect(Yii::app()->createAbsoluteUrl('frontuser/home/cafForm/documentUpload/1'));
                }
    ...
    public function actionIndex() {
        ...
        $this->redirect('/backoffice/frontuser/home/investorWalkthroughLevel2/type/CAF/financial_year/ALL');
        $error = '';
     ...
     * @author: Rahul Kumar
     * @date: 05062018
     * @description: Investor Dashboard  Level 1
     */
    public function actionInvestorWalkthrough() {
		...
		/* echo "<pre>";
	 	print_r($_POST);die;  */
		if((isset($_POST['logintype']) && $_POST['logintype']=='service') || (isset($_GET['logintype']) && $_GET['logintype']=='service'))
		{
			 //echo "<pre>";print_r($_POST);die('ddsf');
			$this->render('service_provider_dashboard', array('show' => 'sp'));
		}else{
			// echo "<pre>";print_r($_POST);die('a');
			
			$this->render('walkthrough', array(
				'error' => $error
			));
		}
     ...
     * @author: Rahul Kumar
     * @date: 05062018
     * @description: Investor Dashboard  Level 2
     */
    ...
    public function getUserView($userId) { //echo $userId; die;
        ...
        $sql = "SELECT sso_profiles.first_name,sso_profiles.last_name,sso_profiles.mobile_number,sso_users.email FROM sso_profiles
			 LEFT JOIN sso_users ON sso_users.user_id = sso_profiles.user_id where sso_profiles.user_id=:userId";
    ...
    public function actionDashboard(){
        //$this->layout = '//layouts/applicant_main';
