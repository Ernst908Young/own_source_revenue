          ...
          ?>
            <label>Complaint Type</label>
              <select name="Complainttype" prompt="Select Complaint Type" class="select2-me" id="Complainttype">  
                    <option>Please Select </option>
                <1?php foreach ($type_arr as $key => $val) { ?>
                <option value="<1?php echo $key; ?>" <1?= $type==$key ? 'selected' : '' ?> >
                  <1?php echo $val; ?>
                </option>
              <1?php } ?>
            </select>         
                    ...
                    <table  id="sample_1" width="100%">
                       <thead> 
                           <tr>
                               ...
                               <th class="text-left">
                                <h5>Total Grievance</h5>
                               </th>                              
                               <th class="text-left">
                                <h5>Pending Grievance</h5>
                               </th>
                                <th class="text-left">
                                <h5>Resolved Grievance</h5>
                               </th>
					  ...
					  ?>    
                            <tr class="ticket-row tableinside text-left" id="<?php echo $key; ?>">
                               ...
                               <td>
                                <p><a href="/backoffice/investor/reports/querylevel2?services_id=<?php echo $value['service_id'];?>&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date; ?>" target="_blank" style="color:blue"><?php echo $value['service_name'] ?></a>  </p>
                               </td>
                              <!--  <td class="text-center">
                            
                               </td> -->
                                 <td class="text-left">
                                  <?php echo isset($value['total_query']) ? $value['total_query'] : 0; ?>
                               </td>
                               <td class="text-left">
                                <?php echo isset($value['pending_query']) ? $value['pending_query'] : 0; ?>
                               </td>
                              <td class="text-left">
                                  <?php echo isset($value['resolved_query']) ? $value['resolved_query'] : 0; ?>
                               </td>
