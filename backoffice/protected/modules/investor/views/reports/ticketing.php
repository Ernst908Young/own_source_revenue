                       ...
                       <thead> 
                        ...
                        ?>    
                            <tr class="ticket-row tableinside" id="<?php echo $key; ?>">
                               ...
                               <td class="text-center">
                                  <p><a href="/backoffice/investor/reports/ticketinglavel2?services_id=<?php echo $value['service_id'];?>&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date; ?>" target="blank"><?php echo $value['service_name'] ?></a></p>
                               </td>
                              <td class="text-center">
                                  <?php echo $value['total_ticket'] ?>
                               </td>

                               <td class="text-center">
                                  <?php echo $value['pending_ticket'] ?>
                               </td>

                               <td class="text-center">
                                  <?php echo $value['resolved_ticket'] ?>
                               </td>
