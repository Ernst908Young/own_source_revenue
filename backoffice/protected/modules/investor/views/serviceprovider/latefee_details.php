...
<form id="lf_form" method="post">
	  <div class="form-part bussiness-det">   
        <h4 class="form-heading">Submit Late Fee Payment</h4>
        <input type="hidden" name="asp_id" value="<?= $model->id ?>">
        <div class="form-row row"> 
        	 <div class="col-md-6 form-group text-start mb-3">
	   		
	   		<label>Late Fee</label>
	   		<input type="text" class="form-control" name="late_fee" value ="$ <?= $model->late_fee ?>" readonly>
        ...
        <div class="col-md-6 form-group text-start mb-3">
	   		...
	   		<input type="text" class="form-control" name="chalan_no" value ="<?= $details['recipet_no'] ?>" readonly>
           ...
           <div class="col-md-6 form-group text-start mb-3">
	   		...
	   		<input type="text" class="form-control" value="<?= $app_details['app_name'] ?>"  readonly>
	   		
	   	</div>
           <div class="col-md-6 form-group text-start mb-3">
	   		
	   		<label>Applicant Contact No</label>
	   		<input type="text" class="form-control" value="<?= $app_details['mobile_no'] ?>"  readonly>
	   		
	   	</div>
           <div class="col-md-6 form-group text-start mb-3">
	   		
	   		<label>Applicant Email</label>
	   		<input type="text" class="form-control" value="<?= $app_details['email'] ?>"  readonly>
