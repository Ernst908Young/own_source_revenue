				...
				?>
								...
								<tr>
									...
									<?php 
										...
										$approvedNameSql = "SELECT  * FROM bo_recomended_name where submission_id='$applicationID' AND role_id IN(84, 83) AND withdrawal_status='0' order by role_id DESC";
										...
										{			
											...
											if($approvedData['assign_new_name']!=''){
												...
												echo "<br><b>Approved Name: </b>".$approvedData['recomended_value'];
											}
										}
									?>
									</b>
								 ...
								 $printappurl = str_replace("infowizardtwo", "infowizard", $apps['print_app_call_back_url']); 
																	?>
                                    ...
                                    &nbsp;
                                     <a href="<?php echo Yii::app()->createAbsoluteUrl('infowizardtwo/subForm/applicationTimeline/subID/'. base64_encode($apps['submission_id']));?>" target="_blank" title="View Timeline">
                                        <img src="<?php echo $basePath; ?>/assets/applicant/images/time-icon.png">
                                    
                                     </a>
 										&nbsp;
                                      <a href="<?php echo Yii::app()->createAbsoluteUrl('ticketing/default/index/srn_no/'. base64_encode($apps['submission_id']));?>" target="_blank" title="Raise Ticket">
