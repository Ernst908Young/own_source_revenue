...
<div class="row">
    <div class="col-md-12">
        ...
        <h2 class="heading">Welcome to Digital Corporate Registry System - Ticket</h2>
...
<div class="row">
        ...
        <div class="card position-relative">
            <div class="d-flex justify-content-start dashboard_desc">
                ...
                <div>
                    ...
                    <h4><?php echo $tickets_count['total_t']; ?></h4>
                </div>
            </div>
        ...
        <div class="card position-relative">
            <div class="d-flex justify-content-start dashboard_desc">
                ...
                <div>
                    ...
                    <h4><?php echo $tickets_count['close_t']; ?></h4>
                </div>
            </div>
        ...
        <div class="card position-relative">
            <div class="d-flex justify-content-start dashboard_desc">
                ...
                <div>
                    ...
                    <p class="mb-0">Open</p>
                    <h4><?php echo $tickets_count['open_t']; ?></h4>
                </div>
            </div>
    ...
    <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="card position-relative">
            <div class="d-flex justify-content-start dashboard_desc">
                <img src="<?php echo $basePath; ?>/assets/applicant2/assets/img/Icon feather-check-circle.png" class="dashboard_cardicon bg-4">
                <div>
                    <p class="mb-0">Reverted</p>
                    <h4><?php 
                        echo$tickets_count['rv_t']   
                   ?></h4>
                </div>
            </div>
            <img src="<?php echo $basePath; ?>/assets/applicant2/assets/img/Mask Group 5.png" class="dashboard_cardimg">
        </div>
    </div>
    <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="card position-relative">
            <div class="d-flex justify-content-start dashboard_desc">
                <img src="<?php echo $basePath; ?>/assets/applicant2/assets/img/Icon ionic-ios-refresh.png" class="dashboard_cardicon bg-5">
                <div>

                    <p class="mb-0">Resolved</p>
                    <h4><?php echo $tickets_count['rs_t']; ?></h4>
                </div>
            </div>
            <img src="<?php echo $basePath; ?>/assets/applicant2/assets/img/Mask Group 7.png" class="dashboard_cardimg">
        </div>
    </div>
    <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="card position-relative">
            <div class="d-flex justify-content-start dashboard_desc">
                <img src="<?php echo $basePath; ?>/assets/applicant2/assets/img/Icon ionic-ios-return-left.png" class="dashboard_cardicon bg-6">
                <div>

                    <p class="mb-0">Reopened</p>
                    <h4><?php echo $tickets_count['ro_t']; ?></h4>
                </div>
            </div>
            <img src="<?php echo $basePath; ?>/assets/applicant2/assets/img/Mask Group 8.png" class="dashboard_cardimg">
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="pull-right">
                      <a href="/backoffice/ticketing/default/index/tq" class="btn btn-primary">Create new Ticket</a>
                    </div>
                </div>
            </div>
              ...
              <div class="table-responsive datatablediv">
                <table  id="sample_1" width="100%" class="table">
                     <thead> 
                        ...
                        if($tickets_records){
              $status_arr = array('O'=>'Open','RV'=>'Reverted','RS'=>'Resolved','RO'=>'Reopened','C'=>'Closed');
