 ...
 <div class="m-wizard__form" style="padding: 17px 33px 0px;">
    ...
    <div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
       <div class="form-part bussiness-det">
          <form id="s_form" method="post" action="/backoffice/investor/services/saveSignature">
	                     ...
	                     if (nosig <= totalRowCount) {
	                        ...
	                        if (confirm('Before adding, please check whether the details entered is correct.')) {
	                           ...
	                           $.ajax({
	                              ...
	                              beforeSend: function () {
	                                 $("#rr_error").text("The signatory details entered are not matching with the details on Directors/Secretary on file as per CAIPO's record. Please correct the same.");
	                              },
	                              success: function (result) {
	                                 if (result.status == false) {
	                                    $("#rr_error").text(result.response);
	                                 } else {
