      ...
      <div class="status-title d-flex flex-wrap align-items-center justify-content-between">
        ...
        <div class="row">
            <div id="tickettab" class="my-5">
                <ul>
                    <li><a href="#ticketsummary">Grievance Summary</a></li>
                    ...
                    <div class="my-3 p-4 tabcontentbox">
                        <div class="d-flex justify-content-center ticketinnerbox">
                            <div class="summmarybox">
                                <h2 class="color_total"><?php echo $grievance_count['total_t']; ?>
                                    <span>Total Grievance</span>
                                </h2>
                            </div>
                           
                            <div class="summmarybox">
                                <h2 class="color_closed"><?php echo $grievance_count['withdrawn_t']; ?>
                                    <span>Withdrawn</span>
                                </h2>
                            </div>
                             <div class="summmarybox">
                                <h2 class="color_active"><?php echo $grievance_count['open_t']; ?>
                                    <span>Open</span>
                                </h2>
                            </div>
                            <div class="summmarybox">
                                <h2 class="color_pending">
                                  <?php echo $grievance_count['rv_t']; ?>
                                  <span>Reverted</span>
                                </h2>
                            </div>
                         ...
                         <div class="d-flex justify-content-center ticketinnerbox">
                            <div class="summmarybox">
                                <h2 class="color_closed"><?php echo $grievance_count['rs_t']; ?>
                                    <span>Resolved</span>
                                </h2>
                            </div>
                             <div class="summmarybox">
                                <h2 class="color_active"><?php echo $grievance_count['ro_t']; ?>
                                    <span>Reopened</span>
                                </h2>
                            </div> 
                            
                            <div class="summmarybox">
                                <h2 class="color_active"><?php echo $grievance_count['esc_t']; ?>
                                    <span>Escalated</span>
                                </h2>
                            </div> 
                         </div>
                        <div class="d-flex justify-content-center align-items-center pt-4">
                            <a href="/backoffice/grievance/default/index" class="btn-secondary">Create New Grievance</a>
                        </div>
                   </div>
                       ...
                       <thead> 
                        ...
                        if($grievance_records){
                            ...
                            <tr class="ticket-row tableinside" id="<?php echo $key; ?>">
                               ...
                               <td class="text-center">
                                <p><?php echo ($val['category']=="Ticket" || $val['category']=="Query") ? 'Existing '.$val['category'] : $val['category']; ?> </p>
                               </td>
                               <td class="text-center">
                                <p><?php echo $val['priority'] ?> </p>
                               </td>
                               <!-- <td class="text-center">
                                <p><1?php echo $val['category_name'] ?> </p>
                               </td>
                               <td class="text-center">
                                <p><1?php echo $val['service_name'] ?></p>
                               </td> -->
                               <td class="text-center">
                                <p>
                                    <?php                                           
                               ...
                               <td class="text-center">
                                <?php $link = Yii::app()->urlManager->createUrl('/grievance/default/grievancedetail/sm_id/'.$val['id']); ?>
                                    <a href="<?php echo $link  ?>/grv"><i class="fa fa-eye"></i></a>
