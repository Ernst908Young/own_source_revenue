...
/**
 * This is the model class for table "bo_landowner_contact".
 *
 * The followings are the available columns in table 'bo_landowner_contact':
 * @property integer $id
 ...
 */
class BoLandownerContact extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('owner_name, owner_email, agent_name, agent_email', 'length', 'max'=>255),
	 ...
	 * @return BoLandownerContact the static model class
	 */
