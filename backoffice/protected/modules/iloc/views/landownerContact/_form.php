...
<?php echo $form->error($model, 'agent_email'); ?>
                      ...
                      <?php /*   <div class="row buttons" align="center">
                        <?php echo CHtml::submitButton($model->isNewRecord ? 'Save and Proceed' : 'Update and Proceed', array('class' => 'btn btn-primary')); ?>
                        </div>
                      <?php $this->endWidget(); ?>
					  
                      <div class="row buttons" align="center">
                          <form action="<?php echo Yii::app()->createUrl("/iloc/landownerConnect/update/id/$_GET[landID]"); ?>" method="POST">
                                <input type="submit" class="btn btn-success pull-left" value="BACK">
                           </form>
                      </div>  
					  ...
					  <div class="row buttons">
                             <div class="col-md-6  buttons" align="right">
                                 <a href="<?php echo Yii::app()->createUrl("/iloc/landownerConnect/update/id/$_GET[landID]"); ?>" class="btn btn-primary step2_btn"> <i class="m-icon-swapleft"></i> Back </a>
