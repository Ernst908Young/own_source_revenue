...
<?php echo $landProperty['land_title']; ?>  </span>
                            ...
                            <div class="col-md-12" style="margin:10px;">
                                ...
                                <div class="col-md-6 fn13"> <i class="fa fa-map-pin" aria-hidden="true"></i> <span class="cption_content"> District</span> <?php echo $landProperty['distric_name'];    ?> </div>
                            </div>
                            <!-- Railway  -->
                            <div class="col-md-12" style="margin:10px;">
...
<!--  Download  -->
        ...
        <?php   
           if($pdfInfo=$this->getLandDocument(base64_decode($_GET['landID']),'pdf')){
               if(!empty($pdfInfo) && isset($pdfInfo)){ ?>
        ...
        if($videoInfo=$this->getLandDocument(base64_decode($_GET['landID']),'mp4')){ 
                                 if(!empty($videoInfo)  && isset($videoInfo)){ ?>
                               <span class="btn default blue-stripe">
                        ...
                        <!-- Download end  -->
                            ...
                            <div class="col-md-12" style="margin:20px;">
                                ...
                                <?php if ($landProperty['share_contact'] == "Y") { ?>
                                        ...
                                        <button type="button" relatedMessage="Please Verify your mobile number to view contact details of the owner" class="btn btn-success pull-10 guestloginpopup"  data-toggle="modal" data-target="#guestLogin"> <i class="fa fa-info"></i> View Contact Detail</button>
                                        <?php } else { ?>
                                ...
                                <?php } ?>
                                          <?php if (empty($_SESSION['RESPONSE']['user_id']) && empty($_SESSION['land_user_id'])) { ?>
                                        <button type="button" relatedMessage="Please Verify your mobile number to express interest in this property" class="btn btn-success pull-10 guestloginpopup"  data-toggle="modal" data-target="#guestLogin"> <i class="fa fa-heart"></i> Express Interest</button>
                                        <?php } else { ?>
										...
										<?php if (empty($_SESSION['RESPONSE']['user_id']) && empty($_SESSION['land_user_id'])) { ?>
                                              <button type="button" relatedMessage="Please Verify your mobile number to express interest in this property" class="btn btn-success pull-10 guestloginpopup"  data-toggle="modal" data-target="#guestLogin"> <i class="fa fa-comment-o" aria-hidden="true"></i>Login To Message </button>
                                        <?php } else { ?>
                                              <button type="button" class="btn btn-success pull-10" data-toggle="modal" data-target="#myChatModal"> <i class="fa fa-comment-o" aria-hidden="true"></i> Start Conversation </button>
                                         <?php } ?>
										 ...
										 <!--------------------------------------->
                                          ...
                                          <?php if (empty($_SESSION['RESPONSE']['user_id']) && empty($_SESSION['land_user_id'])) { ?>
                                        <button type="button" relatedMessage="Please Verify your mobile number to report this property as spam" class="btn btn-danger pull-right guestloginpopup"  data-toggle="modal" data-target="#guestLogin"><i class="fa fa-list-alt"></i> Report as Spam</button>
                                        <?php } else { ?>
...
<div id="myChatModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <!-- Modal content-->
        <div class="modal-content">
            <form action="<?php echo Yii::app()->createUrl("iloc/landownerMessage/create"); ?>"  method='POST'>

			  <input type="hidden" name="land_id"  value="<?php echo  $_GET["landID"];    ?>"    >
                ...
                <div class="modal-body">
                    <textarea class="form-control" name="message" required placeholder="Type your message here..."></textarea>
                </div>
                <div class="modal-footer">
