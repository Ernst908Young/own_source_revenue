...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">	
		<div class="form-group col-md-6">
			...
			<div class="col-md-8">
			<?php echo $form->DropDownList($model_role,'role_id',CHtml::listData(UserExt::sGetRoles('state',$dept_id),'role_id','role_name'),
                        array('class'=>'form-control','prompt'=>'Select Role','required'=>'required')); ?>
	...
	<div class="row">	
		<div class="form-group col-md-6">
			...
			<div class="col-md-8">
			Dehradun
			<?php echo $form->hiddenField($model,'disctrict_id',array('class'=>'form-control','value'=>'6')); ?>
			<?php //echo $form->dropDownList($model,'disctrict_id',CHtml::listData($datas,'district_id','distric_name'),array('class'=>'form-control')); ?>
...
<script type="text/javascript">
	$( document ).ready(function() {
		$('#User_disctrict_id').on('change',function(){
			//alert(); return;
			var url ="<?php echo Yii::app()->createUrl('ajax/UserDetails');?>";
			getUserDetails(url,'<?php echo $dept_id; ?>',this.value);
