...
<div class="dt-buttons" style="margin-bottom: 10px; float: right; "><a class="btn blue btn-outline" tabindex="0" href="javascript:void(0)" style="cursor: not-allowed"><span>Add New </span></a><?php //echo $this->createUrl('/user/createState/')?>
</div>
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold uppercase">State User</span>
                </div>
             ...
             <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                       <?php if(count($datas)){ $sn = 1;//print_r($datas);
                       ...
                       ?>
                        		 <tr>
                                    ...
                                    <td> <?php ?></td>
                                    <td> <?php if ($data['role_name'] == "Comment_Level_state") {
                                            echo "Department State Nodal Officer";
                                        } ?></td>
                                    <td> </td>
                                   ...
                                   <!-- <td><?php //echo $data['is_active']=='1'?'Y':'N';  ?></td>
                                    <td><?php //echo $data['created_datetime'];  ?></td>-->
                                         ...
                                         <td>
                                         	...
                                         	<a class="view" title="Edit" href="<?=$this->createUrl('/user/editState/id/'.base64_encode($data['uid'])); ?>">
