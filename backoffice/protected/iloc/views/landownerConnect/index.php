...
<div class="row">
<div class="dt-buttons" style="margin-bottom: 10px; float:right; margin-right:15px" ><a class="btn btn-success" tabindex="0" href="<?=$this->createUrl('/iloc/landownerConnect/create')?>"><span>Add New Land Record for Sale/Lease </span></a>
</div></div>
<div class='portlet box green'>
<div class='portlet-title'>
    <div class='caption'>
        <i style=" font-size:20px;" class='fa fa-list'></i>List Land Record for Sale/Lease</div>
    <div class='tools'> </div>
</div>
              ...
              if(empty($dataProvider)){
                ...
                foreach ($dataProvider as $key => $act) {
                 ...
                 <tr>
					...
					<td><?php echo $act['village'];?></td>
					<td><?php echo $act['type_of_land'];?></td>
					<td>
							<!--<a href="<?php //echo Yii::app()->createAbsoluteUrl('/iloc/landownerConnect/view/id/'.$act['id'].'')?>" >View </a>-->
							<a href="<?php echo Yii::app()->createAbsoluteUrl('/iloc/landownerConnect/update/id/'.base64_encode($act['id']).'')?>" >Edit </a>
					</td>
                   </tr>
                 <?php
               }
