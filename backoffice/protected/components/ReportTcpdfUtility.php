	...
	class MYPDF extends TCPDF {
	    ...
	    public function Header() {
            ...
            <td colspan="8" style="font-weight:900;font-size:1.5em" align="center">'.$title_heading.'</td>
             ...
             <tr>
            <td colspan="8" style="font-weight:600;font-size:1.3em" align="center">'.$sub_heading1.'</td>
            </tr>
	       ...
	       // $image_file2 = $_SERVER['DOCUMENT_ROOT'].Yii::app()->theme->baseUrl.'/img/doi.png';
			...
			$this->Image($image_file2, 26, 0.2,2, '', '', '', 'T', false, 300, '', false, false, 0, false, false, false);
	         $data='<hr>';
	        $this->Ln();
	    }
...
class ReportTcpdfUtility{
	...
	public static function generateHindiPdfApp($content,$name){ 
	    ...
	    $pdf->SetTitle($name."SWCS Uttarakhand");
	    $pdf->SetSubject($name);
	    $pdf->SetKeywords("SWCS Uttarakhand");
